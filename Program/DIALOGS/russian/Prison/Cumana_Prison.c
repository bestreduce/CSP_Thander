...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "zpq_prs3":
			dialog.text = "Нам нужно 50000 картузов орудийного пороха. За всю партию я заплачу 300000 пиастров... Это очень хорошая цена, сами понимаете. Наше положение вынуждает идти на подобные издержки, хотя мне стоило немалых усилий убедить в этом губернаторского казначея... Сезон штормов не даёт возможности воспользоваться штатными каналами снабжения, да и афишировать такой казус нам не с руки...";
		...
		break;
		case "zpq_ex2":
			dialog.text = "Да-да, конечно. Вам сейчас же выплатят 150000 пиастров, согласно нашему уговору.";
			link.l1 = "Вы, верно, шутите, сеньор?! Договор был на 300000, и я не намерен"+ GetSexPhrase("","а") +" уступать ни пиастра!";
			link.l1.go = "zpq_ex3";
			link.l2 = "Я начинаю думать, что вы хотите меня обмануть, поэтому без своих 450000 пиастров я отсюда не уйду!";
			link.l2.go = "zpq_ex4";
		...
		case "zpq_ex3":
			...
			{
				dialog.text = "Ах да-а... точно! 300000 пиастров. Запамятовал, прошу меня простить. Возраст, знаете ли, уже не тот, склероз... Конечно, вот ваши деньги. Приятно было иметь с вами дело. А теперь прошу меня простить, дела ждут...";
		...
		break;
		case "zpq_ex4":
				dialog.text = "Какая дерзость! Я ещё из ума не выжил и совершенно точно помню, что наш уговор был на 300000 пи\n... Ах чёрт! тебе не удастся меня надуть!";
		...
		case "zpq_ex6":
			...
			{
				dialog.text = "Гм-гм... веский аргумент. 450000 пиастров, говорите? Вот, держите ваши деньги... А теперь прошу меня простить, дела ждут...";
