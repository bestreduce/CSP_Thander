		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "TakeRockBras_RockSink":
                    ...
                    link.l1 = "Я атаковал"+ GetSexPhrase("","а") +" его корвет в прибрежных водах Маракайбо, где он охотился на наши галеоны. Сожалею, дон Франсиско, но взять его живым мне не удалось, он утонул вместе со своим кораблем...";
                    link.l1.go = "Step_3_6";
                break;
