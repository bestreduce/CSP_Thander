...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_4_20":
			...
			//слухи
			AddSimpleRumour("Вы знаете, наш генерал-губернатор поручил капитану " + GetMainCharacterNameDat() + " расследование убийства коменданта де Лейва. Капитан наш"+ GetSexPhrase("ел","ла") +" убийцу, им оказался какой-то француз, и отправил"+ GetSexPhrase("","а") +" его на тот свет.", SPAIN, 5, 1);
        break;
        //********************** Квест №5, Нападение на Ла Вегу. ************************
        case "Step_5_1":
            dialog.text = "Все узнаете у Хименеса. На ближайшее время вы поступаете полностью в его распоряжение. Единственное, что я могу вам сказать - скучно не будет, предстоит серьёзная боевая операция.";
            link.l1 = "Подробности...";
            link.l1.go = "Step_5_2";
        break;
        case "Step_5_2":
