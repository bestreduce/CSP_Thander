...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    ...
                    else
                    {
                        ...
                        {
                            case "2":
                                dialog.text = "А-а-а, вот и вы, " + pchar.name + "! Рассказывают, что вы проявили редкое мужество и находчивость! Рад сообщить, что спасённые вами люди уже находятся на пути в Кастилию. Их благодарность буквально не знает границ. Наши друзья в Порт-Рояле сообщают прямо-таки фантастические вещи, говорят, будто вы изрубили английских тюремщиков в куски!";
                                link.l1 = "У страха глаза велики, дон Франсиско...";
                                link.l1.go = "Step_2_1";
                            break;
                            case "3":
                                dialog.text = "Рад видеть вас вновь, "+ GetSexPhrase("друг мой","сеньорита") +". Хочу предложить вам одно дело, и полагаю, что оно будет вам по вкусу.";
                                link.l1 = "Я "+ GetSexPhrase("весь","вся") +" внимание.";
                                link.l1.go = "Step_3_1";
                            break;
                            case "4":
                            ...
                            case "5":
                                ...
                                link.l1 = "Что я долж"+ GetSexPhrase("ен","на") +" буду делать?";
                                link.l1.go = "Step_5_1";
                            break;
                            case "6":
                            ...
                            case "7":
                                ...
                                link.l1 = "Я понял"+ GetSexPhrase("","а") +", дон Франсиско. Приступаю немедленно.";
                                link.l1.go = "exit";
                            ...
                            break;
                            case "11":
                                dialog.text = "Вы готовы к серьёзной операции по штурму укреплённых городов?";
                                link.l1 = "Всегда готов"+ GetSexPhrase("","а") +", сеньор генерал-губернатор";
                ...
                case "":           // Квест №1, Спасти горожан от Моргана.
                    ...
                    link.l1 = "Для меня это большая честь, дон Франсиско. Никак не ожидал"+ GetSexPhrase("","а") +", что моя скромная персона удостоится внимания столь высокопоставленного сеньора.";
                    link.l1.go = "Step_1_1";
                break;
                ...
                case "TakeRockBras_RockSink":
                    ...
                    link.l1 = "Я атаковал"+ GetSexPhrase("","а") +" его корвет в прибрежных водах Маракайбо, где он охотился на наши галеоны. Сожалею, дон Франсиско, но взять его живым мне не удалось, он утонул вместе со своим кораблём...";
                    link.l1.go = "Step_3_6";
                break;
                case "TakeRockBras_DieHardRock":
                    dialog.text = "Так, ну что вы мне скажете по поводу Рока Бразильца?";
                    link.l1 = "Я намерева"+ GetSexPhrase("лся","лась") +" атаковать его корвет в прибрежных водах Маракайбо, где он охотился на наши галеоны. К сожалению, по причинам, от меня не зависящим, мне пришлось покинуть воды, где находился Рок Бразилец. Он ушёл от меня...";
                    link.l1.go = "Step_3_6";
                break;
                ...
                case "TakeRockBras_RockGiven":
                    ...
                    link.l1 = "Спасибо, дон Франсиско. Чем я ещё могу быть вам полез"+ GetSexPhrase("ен","на") +"?";
                    link.l1.go = "Step_3_8";
                break;
                case "TakeRockBras_WaitTwoDays":
                if (GetQuestPastDayParam("questTemp") > 2)
                    {
                        dialog.text = "Итак, как я и предполагал, хвалёный корсар не смог долго выносить методы допроса с пристрастием, принятые в Святой Инквизиции.";
                ...
                case "TakeRockBras_SeekRocksMoney":
                    ...
                    {
                        link.l2 = "Дон Франсиско, я готов"+ GetSexPhrase("","а") +" отчитаться, поиски завершены.";
                ...
                case "Sp4Detection_toDEstre":
                    ...
                    link.l1 = "Дон Франсиско, на Тортуге я узнал"+ GetSexPhrase("","а") +" о том, что некая донна Анна находится у Бертрана д'Ожерона на содержании. Можно предположить, что это и есть донна Анна Рамирес де Лейва, но заявлять это с уверенностью я не могу.";
                    link.l1.go = "Step_4_9";
                break;
                ...
                case "Sp4Detection_DEstreIsDead":
                    ...
                    link.l1 = "Я все узнал"+ GetSexPhrase("","а") +". Дело в том, что жена дона Хосе Рамиреса де Лейва по собственному желанию сбежала к генерал-губернатору Тортуги д'Ожерону.";
                ...
                case "Sp6TakeMess_waitMessanger":
                    dialog.text = "Та-а-ак, рад видеть "+ GetSexPhrase("доблестного капитана","вас, сеньорита") +".";
                    link.l1 = "И я вас также рад"+ GetSexPhrase("","а") +" видеть, дон Франсиско.";
                    link.l1.go = "Step_6_4";
                break;
                ...
                case "Sp7SavePardal_PardalIsSink":
                    ...
                    link.l1 = "Сеньор, я не смог"+ GetSexPhrase("","ла") +" спасти Пардаля, его галеоны потоплены многократно превосходящими силами. Сам Маноэль погиб...";
                    link.l1.go = "Step_7_1";
                break;
                case "Sp7SavePardal_GoodWork":
                    dialog.text = "Докладывайте о результатах миссии.";
                    link.l1 = "Сеньор, информация, полученная вами, оказалась достоверной. Я "+ GetSexPhrase("шёл","шла") +" к Антигуа на всех парусах и подоспел"+ GetSexPhrase("","а") +" к Пардалю как нельзя вовремя - он и два галеона его эскадры уже вели бой с превосходящими силами французских пиратов. Совместными усилиями нам удалось одолеть сильного врага, корабли флибустьеров пошли ко дну!";
                    link.l1.go = "Step_7_3";
                break;
                case "Sp7SavePardal_2GoodWork":
                    dialog.text = "Докладывайте о результатах миссии.";
                    link.l1 = "Сеньор, информация, полученная вами, оказалась достоверной. Я "+ GetSexPhrase("шёл","шла") +" к Антигуа на всех парусах и подоспел"+ GetSexPhrase("","а") +" к Пардалю как нельзя вовремя - два его галеона уже вели бой с превосходящими силами французских пиратов. Совместными усилиями нам удалось одолеть сильного врага, корабли флибустьеров пошли ко дну!";
                    link.l1.go = "Step_7_3";
                break;
                case "Sp7SavePardal_DieHard":
                    dialog.text = "Докладывайте о результатах миссии.";
                    link.l1 = "Сеньор генерал-губернатор, к сожалению, это задача оказалась мне не по зубам. Я не смог"+ GetSexPhrase("","ла") +" помочь Пардалю.";
                    link.l1.go = "Step_7_6";
                break;
                case "Sp8SaveCumana_YouLate":
                    dialog.text = "Часть беженцев из Куманы уже прибыла сюда. Вы не сумели спасти город и его жителей.";
                    link.l1 = "Я мчал"+ GetSexPhrase("ся","ась") +" к Кумане на всех парусах, нигде не задерживаясь даже на минуту. Но всё равно не успел"+ GetSexPhrase("","а") +" вовремя, сделать это было просто невозможно.";
                    link.l1.go = "Step_8_5";
					pchar.questTemp.Waiting_time = "20";
                break;
                case "Sp8SaveCumana_DieHard":
                    dialog.text = "Часть беженцев из Куманы уже прибыла сюда. Вы не сумели спасти город и его жителей.";
                    link.l1 = "Собранная эскадра ладронов была сильна настолько, что справиться с ней мы не смогли. С теми силами, которыми я располагал"+ GetSexPhrase("","а") +", сделать это было просто невозможно.";
                    link.l1.go = "Step_8_5";
					pchar.questTemp.Waiting_time = "40";
                break;
                case "Sp8SaveCumana_GoodWork":
                    dialog.text = "Мне уже доложили, что Кумана спасена. Великолепно!";
                    link.l1 = "Мы сумели потопить флот ладронов. Никто не ушёл живым...";
                    link.l1.go = "Step_8_6";
                break;
                case "Sp9SaveCumana_BackHavana":
                    dialog.text = "Докладывайте, что у вас произошло?";
                    link.l1 = "Дон Франсиско, я получил"+ GetSexPhrase("","а") +" от генерал-губернатора Порто Белло задание сопроводить четыре золотых галеона до необитаемого острова Кайман...";
                    link.l1.go = "Step_9_2";
                break;
                ...
                case "DestrHolland_GoOn":
                    ...
                    link.l1 = "Сеньор генерал-губернатор, я этим занимаюсь. Задача непроста, требует серьёзной подготовки.";
                    link.l1.go = "exit";
                    ...
                    {
                        dialog.text = "Превосходно, Мариго разорён! Но я жду от вас так же захвата и разорения Виллемстада.";
                    ...
                    {
                        dialog.text = "Мариго и Виллемстад взяты штурмом и разорены! Прекрасная работа, "+ GetSexPhrase("друг мой","" + pchar.name + "") +"!";
                ...
                break;
                case "EndOfQuestLine":
                    dialog.text = ""+ GetSexPhrase("Дон","Донна") +" " + pchar.name + ", Эскориал предоставляет вам полную свободу действий в интересах Испании. Действуйте самостоятельно.";
        ...
        case "Step_1_1":
            dialog.text = "Моё внимание можно заслужить делами на благо великой Кастилии, коих у вас, капитан, пока нет.\n"+
            ...
            link.l1 = "Неужели положение Испании настолько серьёзно?";
            link.l1.go = "Step_1_2";
        break;
        case "Step_1_2":
            dialog.text = "Да, хотя на первый взгляд всё в порядке. Богатство и могущество Испании всегда внушали зависть европейским монархиям. Сейчас же, когда наши враги не гнушаются привлекать бандитов всех мастей, положение стало удручающе тяжёлым.\n"+
                          ...
                          "Эскориал в бешенстве, её величество королева-мать требует незамедлительных и решительных действий по пресечению незаконной деятельности ладронов всех мастей. Для достижения сей цели принято решение бороться с врагом его же методами, то есть нанимать каперов на службу короне.";
            link.l1 = "Похоже, что я вовремя...";
            link.l1.go = "Step_1_3";
        break;
        case "Step_1_3":
            dialog.text = "Похоже, что так оно и есть. Ещё вчера "+ GetSexPhrase("такой субъект","такая особа") +", как вы, мог"+ GetSexPhrase("","ла") +" рассчитывать только на костёр Святой Инквизиции или пеньковую верёвку. Но времена изменились. Докажите свою преданность Господу нашему и Кастилии, и будете иметь всё - богатство, славу, почести и награды.";
            link.l1 = "Звучит неплохо. Я готов"+ GetSexPhrase("","а") +" приступать непосредственно к выполнению работы.";
            link.l1.go = "Step_1_4";
        break;
        case "Step_1_4":
        ...
        break;
        case "Step_1_7":
            dialog.text = "Ну что же, вами сделан первый успешный шаг на тернистом пути карьеры для её Величества Королевы-матери Марии-Анны Австрийской. Получите честно заработанные 50 тысяч. Рад, что не ошибся в вас.";
            link.l1 = "Благодарю, господин генерал-губернатор. Кстати, вы прекрасный математик.";
            link.l1.go = "Step_1_8";
        break;
        case "Step_1_8":
            dialog.text = "О чём вы?";
        ...
        case "Step_2_1":
            dialog.text = "Ваша скромность делает вам честь... Ну что же, пришло время для новой работы. К нам прибыл высокопоставленный иезуит Антониу де Соуза, он попросил предоставить в его распоряжение хладнокровного, мужественного и честного офицера.\n"+
                          "Я порекомендовал вас. Отправляйтесь в Сантьяго, там находится управление Инквизиции по Карибскому морю, и найдите де Соуза. Делайте всё, что он прикажет, не задумываясь ни о чём. У вас есть вопросы?";
        ...
        break;
        case "Step_2_3":
            dialog.text = "Ну вот и славно. Вы отдохните пару недель от трудов праведных на благо Церкви, а потом прошу ко мне на приём. Полагаю, что найду вам новое дело.";
			...
			LAi_group_MoveCharacter(sld, "SPAIN_CITIZENS");
			ChangeCharacterAddressGroup(sld,"Havana_town","goto","goto8");
        ...
        case "Step_3_2":
            dialog.text = "Да, это так. Настоящая головная боль для нас.\n"+
                          "Так вот, я намерен избавится от этой мигрени сам и избавить от неё наших колонистов. Я хочу, чтобы вы захватили этого пресловутого Рока Бразильца. И что очень важно - доставили его живым.";
            link.l1 = "А это обязательно? Драка будет знатная, в этом можно быть уверенным.";
            link.l1.go = "Step_3_3";
        break;
        case "Step_3_3":
            dialog.text = "И что? Я не очень понимаю вас, "+ GetSexPhrase("сеньор","сеньорита") +" " + pchar.name + ". Вы испугались?!";
            link.l1 = "Дон Франсиско, я не боюсь ни чёрта, ни дьявола. Полагаю, что вы имели возможность в этом убедиться! Но я имею в виду то, что не могу контролировать абордаж полностью. В такой рубке может погибнуть кто угодно.";
            link.l1.go = "Step_3_4";
        break;
        case "Step_3_4":
        ...
        case "Step_3_6":
            dialog.text = "Хм, это плохо. Я разочарован в вас.\n"+
                          "Сейчас прошу оставить меня одного... Однако, вы можете бывать у меня на приёме время от времени, возможно, и для вас найдётся дело...";
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", сеньор генерал-губернатор. Спасибо...";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
            SaveCurrentQuestDateParam("questTemp");
            pchar.questTemp.CurQuestNumber = "4";
			...
			AddCharacterExpToSkill(pchar, "Sailing", -100);
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " провалил"+ GetSexPhrase("","а") +" задание генерал-губернатора - не смог"+ GetSexPhrase("","ла") +" захватить этого жуткого ладрона Рока Бразильца. Неудачни"+ GetSexPhrase("к","ца") +", одним словом...", SPAIN, 5, 1);
        break;
        case "Step_3_7":
        ...
        break;
        case "Step_3_15":
            dialog.text = "Бесспорно. Пятая часть найденных пиастров Бразильца - ваша. И не носите мне все это в отдельности, приходите сразу, когда наберёте требуемую сумму - 500 тысяч.";
        ...
        break;
        case "Step_3_10":
            dialog.text = "Великолепно! Теперь давайте подведём итог... Вы вносите в казну Эскориала 500 тысяч, следовательно, ваша доля составляет 100 тысяч пиастров.";
        ...
        case "Step_3_11":
			...
			//слухи
			AddSimpleRumour("Вы не слышали прекрасную новость? Нек"+ GetSexPhrase("ий","ая") +" капитан " + GetFullName(pchar) + " захватил"+ GetSexPhrase("","а") +" этого мерзкого ладрона Рока Бразильца. Хвала Господу Всемогущему!", SPAIN, 5, 1);
        break;
        ...
        case "Step_4_5":
            dialog.text = "Дон Хосе и был комендантом Гаваны. Послушайте, я не могу вас заставить заниматься расследованием преступлений, но именно сейчас я прошу сделать это.\n"+
                          "Город взволнован, сами понимаете. Да ещё это исчезновение... Мы обыскали все вокруг - безрезультатно. Мне нужны эффективные меры в расследовании немедленно, и вы - наилучшая кандидатура на данный момент.";
        ...
        case "Step_4_6":
            ...
            link.l1 = "Сложно предположить... Но вот что я наш"+ GetSexPhrase("ел","ла") +" на месте преступления - недописанное письмо...";
            link.l1.go = "Step_4_7";
        break;
        case "Step_4_7":
            dialog.text = "(читает) Хм, даже не знаю, что сказать... Вам нужно проникнуть на Тортугу и разобраться, что к чему.";
            link.l1 = "Хорошо, дон Франсиско, я всё сделаю.";
            link.l1.go = "Step_4_8";
        ...
        break;
        case "Step_4_9":
            dialog.text = "Одни предположения... Хм, этого мало, чтобы сделать твёрдые выводы.\n"+
                          "Я недоволен вами. Попрошу вас оставить меня одного, у меня нет дел для вас.\n"+
                          "Впрочем, вы можете заходить ко мне на приём переодически, возможно, что-нибудь незначительное и подвернется...";
            link.l1 = "Хорошо, сеньор генерал-губернатор...";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
            SaveCurrentQuestDateParam("questTemp");
			...
			//слухи
			AddSimpleRumour("Вы знаете, наш генерал-губернатор поручил капитану " + GetMainCharacterNameDat() + " расследование убийства коменданта де Лейва. Однако, сыщиком капитан оказал"+ GetSexPhrase("ся","ась") +" некудышным...", SPAIN, 5, 1);
        break;
        case "Step_4_10":
            dialog.text = "Продолжайте...";
            link.l1 = "Я настиг"+ GetSexPhrase("","ла") +" этого флибустьера, но убить его мне не удалось - он очень силён, мне пришлось ретироваться.";
            link.l1.go = "Step_4_11";
        break;
        case "Step_4_11":
            dialog.text = "Оно и понятно. Убить пятерых вооружённых до зубов человек, готовых к встрече с ним - это вам не в чучело на плацу шпагой потыкать...";
        ...
        break;
        case "Step_4_12":
            dialog.text = "Ну что же, если бы дон Хосе относился к донне Анне должным образом, то, полагаю, ничего бы этого не произошло. Нужно признать, что донна Анна здорово страдала от нравов своего супруга и порядков, которые он установил в своём доме. Тем не менее, он имел на это право...";
            link.l1 = "Сеньор генерал-губернатор, я могу считать расследование завершённым?";
        ...
        case "Step_4_13":
			...
			ChangeCharacterReputation(pchar, 2);
			//слухи
			AddSimpleRumour("Вы знаете, наш генерал-губернатор поручил капитану " + GetMainCharacterNameDat() + " расследование убийства коменданта де Лейва. Капитан наш"+ GetSexPhrase("ел","ла") +" убийцу, им оказался какой-то француз. Но отомстить не сумел"+ GetSexPhrase("","а") +".", SPAIN, 5, 1);
        break;
        case "Step_4_14":
        ...
        break;
        case "Step_4_15":
            dialog.text = "Ну что же, если бы дон Хосе относился к донне Анне подобающим образом, то, полагаю, ничего бы этого не произошло. Нужно признать, что донна Анна здорово страдала от нравов своего супруга и порядков, которые он установил в своём доме. Тем не менее, он имел на это право... Так кто же убил дона Хосе?";
        ...
        case "Step_4_16":
            ...
            link.l1 = "Оно уже свершилось - убийца дона Хосе мёртв. Я разыскал"+ GetSexPhrase("","а") +" его на Тортуге и убил"+ GetSexPhrase("","а") +".";
            link.l1.go = "Step_4_17";
        break;
        case "Step_4_17":
            dialog.text = "Чёрт возьми! Вы действительно отважный офицер и человек чести, к тому же. Я благодарен вам за проявленное мужество.";
        ...
        case "Step_4_19":
            ...
            link.l1 = "Понятно. Ну что же, это, собственно, уже не моё дело. Сеньор генерал-губернатор, я могу считать расследование завершённым?";
        ...
        case "Step_4_20":
			...
			//слухи
			AddSimpleRumour("Вы знаете, наш генерал-губернатор поручил капитану " + GetMainCharacterNameDat() + " расследование убийства коменданта де Лейва. Капитан наш"+ GetSexPhrase("ёл","ла") +" убийцу, им оказался какой-то француз, и отправил"+ GetSexPhrase("","а") +" его на тот свет.", SPAIN, 5, 1);
        break;
        //********************** Квест №5, Нападение на Ла Вегу. ************************
        case "Step_5_1":
            dialog.text = "Всё узнаете у Хименеса. На ближайшее время вы поступаете полностью в его распоряжение. Единственное, что я могу вам сказать - скучно не будет, предстоит серьёзная боевая операция.";
            link.l1 = "Подробности...";
            link.l1.go = "Step_5_2";
        break;
        case "Step_5_2":
            dialog.text = "Всё у Хименеса. Выдвигайтесь в Сантьяго немедленно.";
            link.l1 = "Хорошо, сеньор.";
            link.l1.go = "exit";
        ...
        case "Step_5_3":
            ...
            link.l1 = "Да, сеньор генерал-губернатор, в достаточной мере. Всё в порядке";
            link.l1.go = "Step_5_4";
        break;
        case "Step_5_4":
            dialog.text = "Ну что же, великолепно! Жду вас у себя через некоторое время, возможно у меня будет для вас ещё работа.";
        ...
        case "Step_6_1":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", сеньор. Я каким-то образом ограничен"+ GetSexPhrase("","а") +" в сроках выполнения?";
            link.l1.go = "Step_6_2";
        break;
        case "Step_6_2":
        ...
        break;
        case "Step_6_3":
            dialog.text = "И ещё один момент. Я вручаю вам лицензию Французской Вест-Индской компании сроком на 60 дней. Вы должны предъявить эту бумагу начальнику порта и вас никто ни в чём не заподозрит.\n"+
        ...
        case "Step_6_4":
			...
			{
				link.l1 = "Я не смог"+ GetSexPhrase("","ла") +" добыть бумаги до сих пор. Мне кажется, что все бесполезно и это задание мне уже не выполнить...";
				link.l1.go = "Step_6_5";
			}
        break;
        case "Step_6_5":
            dialog.text = "Я разочарован в вас, очень плохо... Ну что же, вы мне не нужны более. Можете появиться у меня позднее, возможно я найду непыльную работёнку для такого бестолкового офицера...";
            link.l1 = "Хорошо, сеньор генерал-губернатор...";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
            SaveCurrentQuestDateParam("questTemp");
			...
			//слухи
			AddSimpleRumour("Наш генерал-губернатор отправил капитана " + GetMainCharacterNameGen() + " на Тортугу с каким-то очень важным поручением. Капитан вернул"+ GetSexPhrase("ся","ась") +" ни с чем, одно слово - неудачни"+ GetSexPhrase("к","ца") +"...", SPAIN, 5, 1);
         break;
        case "Step_6_6":
        ...
        break;
        case "Step_6_7":
            dialog.text = "Теперь у нас в руках серьёзный аргумент в дипломатической войне... Вы проделали огромную работу.";
        ...
        case "Step_6_8":
			...
			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + ", удачно провернул"+ GetSexPhrase("","а") +" сверхопасное дело на Тортуге. М-да, мужеством "+ GetSexPhrase("этого человека","этой девушки") +" можно только восхищаться...", SPAIN, 5, 1);
		break;
        //********************** Квест №7, Спасти Пардаля. ************************
        case "Step_7_1":
            dialog.text = "Дьявол, это очень и очень плохо. Боевой дух поселенцев серьёзно упадёт с этим известием...";
            link.l1 = "Мне очень жаль, сеньор, я сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +".";
            link.l1.go = "Step_7_2";
        break;
        case "Step_7_2":
		...
		break;
        case "Step_7_3":
            dialog.text = "Великолепно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +", просто прекрасно!";
        ...
        case "Step_7_5":
			...
			AddCharacterExpToSkill(pchar, "FencingHeavy", 120);
			//слухи
			AddSimpleRumour("Говорят, что вы спасли нашего героя Пардаля! Позвольте выразить вам своё восхищение, вы настоящ"+ GetSexPhrase("ий воин","ая воительница") +"!", SPAIN, 5, 1);
        break;
        case "Step_7_6":
            dialog.text = "М-да, я разочарован, очень плохо... Ну что же, я вас больше не задерживаю. Через некоторое время можете прибыть ко мне на приём, возможно, я и найду дело для такого бестолкового капитана...";
			...
			AddCharacterExpToSkill(pchar, "Cannons", -250);
			//слухи
			AddSimpleRumour("Ходят слухи, что Пардаль погиб во многом по вашей вине. Печально это, "+ GetSexPhrase("сеньор трус","сеньорита трусиха") +"...", SPAIN, 5, 1);
        break;
//********************** Квест №8, Отбить нападение на Куману. ************************
        ...
        break;
        case "Step_8_2":
            dialog.text = "Эх, "+ GetSexPhrase("друг мой","дорогая сеньорита") +", нам довелось жить с вами в очень тяжёлое время... Испания, наша родина, терпит удары со всех сторон. В Старом Свете мы теряем северные провинции в деволюционной войне с Людовиком, здесь усиливается давление на нас со стороны конкурирующих держав...\n"+
				          "Что и говорить, похоже, что власть Папы в скором времени серьёзно поколеблется в мире...";
        ...
        case "Step_8_3":
            dialog.text = "Однако, нам с вами не пристало впадать в уныние. Мы находимся на острие клинка, карающего наших врагов во имя Испании и Господа Всемогущего! И раз нам опять бросают вызов, мы должны на него достойно ответить.\n"+
						  ...
						  "На этот раз мы должны обеспечить надёжную защиту Кумане, это и является вашей задачей. Немедленно отправляйтесь к Кумане и отразите нападение ладронов под командованием капитана Анселя.";
            link.l1 = "Я все понял"+ GetSexPhrase("","а") +", дон Франсиско. Будет исполнено.";
            link.l1.go = "Step_8_4";
        break;
		case "Step_8_4":
		...
		case "Step_8_5":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", дон Франсиско.";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
            SaveCurrentQuestDateParam("questTemp");
			...
			AddCharacterExpToSkill(pchar, "Fencing", -250);
 			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + " не сумел"+ GetSexPhrase("","а") +" спасти жителей Куманы! Печальная участь...", SPAIN, 5, 1);
        break;
		case "Step_8_6":
        ...
        break;
		case "Step_8_7":
            dialog.text = "Хорошо, "+ GetSexPhrase("друг мой","сеньорита") +". Прошу вас не пропадать надолго из города, очень может быть, что вы снова понадобитесь мне.";
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", дон Франсиско.";
            link.l1.go = "exit";
			...
			AddCharacterExpToSkill(pchar, "Fencing", 250);
 			//слухи
			AddSimpleRumour("Капитан, говорят, что это вы спасли Куману! Позвольте вам выразить своё восхищение, сеньор"+ GetSexPhrase("","ита") +"...", SPAIN, 5, 1);
        break;
//********************** Квест №9, Четыре золотых галеона. ************************
		case "Step_9_1":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", сеньор. Приступаю немедленно.";
            link.l1.go = "exit";
		...
		case "Step_9_3":
            ...
            link.l1 = "Испанская военная эскадра - нет, зато тёплую встречу мне подготовили пять кораблей ладронов. Они явно поджидали именно мои галеоны.";
            link.l1.go = "Step_9_4";
        break;
		case "Step_9_4":
        ...
        break;
		case "Step_9_5":
            dialog.text = "Чёрт возьми, похоже, что мы имеем дело либо с чудовищной ошибкой, либо с предательством. С этим я разберусь, а пока скажите мне, все ли галеоны целы?";
			iTemp = 0;
			iMoney = 0;
            ...
            else
            {
				if (iTemp == 0)
				{
					link.l1 = "Сеньор, нападение ладронов было внезапным и отличалось крайней яростью. Я потерял"+ GetSexPhrase("","а") +" все галеоны...";
					link.l1.go = "Step_9_8";
				}
				else
				{
        ...
        break;
		case "Step_9_6":
            dialog.text = "Это очень плохо. Я понимаю, что вы оказались в тяжелейшей ситуации, но вы могли бы быть более расторопн"+ GetSexPhrase("ым","ой") +". А сейчас мне нужно отчитываться в Мадриде за серьёзную недостачу в поставках золота... И это тогда, когда Испания ведёт изнурительную борьбу в Европе!\n"+
				          "М-да, очень и очень плохо. Я рассчитывал на вас, а вы не сумели оправдать моего доверия.";
            link.l1 = "Дон Франсиско, поверьте мне, я сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +". И даже более того... Однако силы были слишком неравны, а у меня был всего один корабль для защиты четырёх галеонов! Кстати, по настоянию губернатора Порто Белло. Может быть, спросить по всей строгости закона с него?";
            link.l1.go = "Step_9_7";
        break;
		case "Step_9_7":
		...
		case "Step_9_71":
			...
			{
				dialog.text = "Поэтому я прошу вас покинуть меня сейчас. В дальнейшем вы можете заходить ко мне в резиденцию, возможно и для вас найдётся подходящее задание...";
				link.l1 = "Спасибо, дон Франсиско.";
			...
			{
				dialog.text = "Э-э-э, да вы, сеньор"+ GetSexPhrase("","ита") +", никак жульничать вздумали?! На галеонах не хватает золота! Я не желаю более иметь с вами дела ни под каким соусом. Прощайте!";
        ...
        break;
		case "Step_9_8":
            dialog.text = "Чёрт возьми!!! Как же такое могло случиться?! Я понимаю, что вы оказались в тяжелейшей ситуации, но вы могли бы быть более расторопн"+ GetSexPhrase("ым","ой") +". А сейчас мне нужно отчитываться в Мадриде за серьёзную недостачу в поставках золота... И это тогда, когда Испания ведёт изнурительную борьбу в Европе!";
            link.l1 = "Дон Франсиско, поверьте мне, я сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +". К тому же я попал"+ GetSexPhrase("","а") +" в ловушку из-за губернатора Порто Белло!";
            link.l1.go = "Step_9_10";
        break;
		case "Step_9_10":
            dialog.text = "Я даже слушать ваших оправданий не желаю. Идите вон!\n"+
				          "Впрочем, вы можете заходить ко мне, возможно, будет кое-какая работёнка для "+ GetSexPhrase("такого бездаря","такой неумёхи") +"...";
            link.l1 = "Хорошо, дон Франсиско.";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
		...
		case "Step_9_11":
			...
			{
				link.l1 = "Да, дон Франсиско, всё в порядке.";
		...
		case "Step_9_12":
            ...
            link.l1 = "Я благодар"+ GetSexPhrase("ен","на") +" вам, сеньор, за оценку моих деяний. Если я вам более не нуж"+ GetSexPhrase("ен","на") +", то разрешите мне покинуть вас на некоторое время.";
		...
		case "Step_9_15":
			...
			AddCharacterExpToSkill(pchar, "Pistol", 150);
			//слухи
			AddSimpleRumour("Капитан, повсюду говорят, что, сопровождая галеоны с золотом, вы попали в засаду! Вы потеряли часть галеонов, но это ничего! Главное, что утёрли нос ладронам!", SPAIN, 5, 1);
		break;
		case "Step_9_16":
            ...
            link.l1 = "Сеньор генерал-губернатор, вы же знаете, в какую переделку я попал"+ GetSexPhrase("","а") +" и что нам довелось пережить. Паника на галеонах, творилось чёрт знает что...";
...
//********************** Квест №10, Защита Маракайбо ************************
		case "Step_10_1":
            ...
            link.l1 = "Сеньор, насколько вам известно, выполняя поручение губернатора Порто Белло, я попал"+ GetSexPhrase("","а") +" в серьёзную переделку...";
		...
		case "Step_10_4":
            ...
            link.l1 = "Отлично! Ну что же, я готов"+ GetSexPhrase("","а") +" приступать к выполнению задачи.";
		...
		case "Step_10_6":
            ...
            link.l1 = "Дон Франсиско, силы пиратов были несоизмеримо больше моих. Я не смог"+ GetSexPhrase("","ла") +" оказать им достойного сопротивления, мне пришлось покинуть поле боя, дабы остаться в живых...";
        ...
        break;
		case "Step_10_8":
            dialog.text = "Я более не желаю иметь с вами никакого дела. Таких трусов и разгильдяев не было ещё на службе Испании! Какой позор... Все, разговор с вами окончен раз и навсегда, прощайте.";
            link.l1 = "...";
            link.l1.go = "exit";
		...
		case "Step_10_11":
			...
			AddCharacterExpToSkill(pchar, "Grappling", 450);
			//слухи
			AddSimpleRumour("Капитан, говорят, что вы сумели отстоять Маракайбо! Без преувеличения, это - настоящий подвиг, сеньор"+ GetSexPhrase("","ита") +"!", SPAIN, 5, 1);
        break;
//********************** Квест №11, Нападение на Кюрасао и Сан Мартин ************************
		case "Step_11_1":
            ...
            link.l1 = "Да, дон Франсиско. Я каким-то образом ограничен"+ GetSexPhrase("","а") +" в сроках?";
		...
		case "Step_11_3":
            dialog.text = "И сделано отлично! Голландцы получили по рукам, надеюсь, это их заставит быть более прижимистыми в тратах, ха-ха.\n"+
				          "Захваченная на острове добыча по праву принадлежит вам! Я прошу вас явиться ко мне на приём через месяц. У меня опять назревает для вас дело.";
			...
			AddCharacterExpToSkill(pchar, "Fencing", 250);
			//слухи
			AddSimpleRumour("Отличная работа, капитан! Здорово вы всыпали этим голландским негодяям!", SPAIN, 5, 5);
        break;
//********************** Квест №12, Захват Порт-о-Принса ************************
		case "Step_12_1":
            dialog.text = "Вы нужны мне для захвата ещё одного города. Только на этот раз не с целью разорения, а с целью утверждения власти Испании.";
		...
		case "Step_12_2":
            ...
            link.l1 = "Понимаю... Я как-то ограничен"+ GetSexPhrase("","а") +" в сроках?";
            link.l1.go = "Step_12_3";
        break;
		case "Step_12_3":
            dialog.text = "Опять же - нет. Взятие городов - задача непростая, посему было бы безрассудно с моей стороны требовать каких бы то ни было сроков. Подготовьтесь как следует к взятию и приступайте.";
        ...
        break;
		case "Step_12_5":
            dialog.text = "Бесспорно, скромность украшает воина. Ну что же, я откровенно рад за вас, "+ GetSexPhrase("друг мой","" + pchar.name + "") +", вы стали самым значимым капитаном в Карибском море. Мои поздравления!";
            link.l1 = "Спасибо, дон Франсиско...";
...
//********************** //Квест "Охота на ведьму". Ведьма казнена ************************
		case "PDM_ONV_VedmaKaznena":
            ...
            link.l1 = "Спасибо, ваше Превосходительство. До свидания!";
