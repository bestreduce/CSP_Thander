...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
				case "DelivLettTortuga_toDOjeron": // Квест №7 голл. линейки. Письмо от Стэвезанта
					link.l1 = "Месье, я уполномочен"+ GetSexPhrase("","а") +" доставить вам дипломатическую депешу от генерал-губернатора Кюрасао Питера Стэвезанта. Извольте получить.";
					link.l1.go = "Step_H7_1";
				break;
				case "DelivLettTortuga_WaitTwoHours":
					if (GetQuestPastTimeParam("questTemp") > 1)
					{
						link.l1 = "Месье генерал-губернатор, я прибыл"+ GetSexPhrase("","а") +".";
						link.l1.go = "Step_H7_3";
					}
					else
					{
						dialog.text = "Вы пришли слишком рано, я же сказал вам - через два часа!";
						link.l1 = "Простите, месье, я поторопил"+ GetSexPhrase("ся","ась") +".";
						link.l1.go = "exit";
					}
				break;
		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            case "2":
								...
								link.l1 = "Хорошо, месье генерал-губернатор, я сделаю это. Давайте своё письмо.";
                                link.l1.go = "Step_2_1";
                            break;
                            case "3":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", у меня для вас поручение весьма деликатного свойства. Вы честны, умеете держать слово, что уже не раз доказывали... Я хочу вверить в ваши руки честь дорогого мне человека...";
								link.l1 = "Месье, давайте ближе к делу...";
                                link.l1.go = "Step_3_1";
                            break;
                            case "4":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", вы доказали свою преданность и честь, поэтому я доверяю вам важнейшее и совершенно секретное дело.";
								link.l1 = "Надеюсь, оно все же связано с морем?";
                                link.l1.go = "Step_4_1";
                            break;
                            case "5":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", для вас снова поручение деликатного свойства. У меня есть серьёзные опасения за жизнь донны де Лейва. Навестите её, пожалуйста, она сейчас у меня в резиденции в соседней комнате. Сеньора посвятит вас в подробности.";
                            ...
                            break;
                            case "6":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", срочно доставьте этот пакет господину Жану Давиду, который сейчас находится на Гваделупе. Только не пытайтесь отыскать там Жана Давида, ха-ха, он более известен как Франсуа Олоне.";
                            ...
                            break;
                            case "8":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", мне поступило распоряжение направить сметливого, исполнительного, верного и достаточно авторитетного флибустьера в распоряжение морского интенданта Франции маркиза Бонрепо, который сейчас находится на Гваделупе. Вашу кандидатуру я считаю достойной.";
								link.l1 = "Благодарю за доверие. Но в чём заключается моё задание?";
                                link.l1.go = "Step_8_1";
                            break;
                            case "9":
                                dialog.text = "Барон"+ GetSexPhrase("","есса") +", мне приказано назначить вас командиром специального карательного морского корпуса и придать в ваше распоряжение уже известный вам линейный корабль 'Солей Руаяль'. Ваши следующие задачи будут состоять в военных действиях против Испании в рамках деволюционной войны. Первая задача - отбить нападение испанской эскадры на Порт-о-Принс.";
								link.l1 = "Хм, видимо испанцы хотят владеть Эспаньолой единолично...";
                                link.l1.go = "Step_9_1";
                            break;
                            case "10":
                                dialog.text = "Так, барон"+ GetSexPhrase("","есса") +", я рад вас видеть. Вы как нельзя вовремя!";
								link.l1 = "Я слушаю вас, сударь.";
                                link.l1.go = "Step_10_1";
                            break;
                            case "11":
                                dialog.text = "Итак, барон"+ GetSexPhrase("","есса") +", Франция ждёт от вас новых свершений. На этот раз военная операция, весьма сходная с предыдущей.";
								link.l1 = "Захват города, месье?";
                                link.l1.go = "Step_11_1";
                            break;
                            case "12":
                                dialog.text = "Барон"+ GetSexPhrase("","есса") +", деволюционная война закончена великолепной победой нашего любимого Короля-Солнце Людовика XIV!!!";
                ...
                case "":           // Квест №1, Охрана пирата Леграна.
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", знаете ли вы Пьера Леграна? Он на днях, только представьте, на люггере захватил испанский военный галеон с прекрасной добычей. Корабль и груз продан, выкуп за испанцев получен, сумма в королевскую казну уплачена. Легран стал обеспеченным человеком и хочет вернуться во Францию. Что ж, я уважаю его решение.";
                    link.l1 = "И ему желательно уйти тихо?";
                    link.l1.go = "Step_1_1";
                break;
                case "Fr1Legran_backGovernor":
                    dialog.text = "Месье Легран сумел мне сообщить, что с ним всё в порядке. Кстати, он очень лестно о вас отозвался. Я рад, что не ошибся в выборе честного и надёжного человека.";
                    link.l1 = "Спасибо за похвалу, месье...";
                    link.l1.go = "Step_1_2";
                break;
                case "Fr1Legran_LegranKilled":
                    dialog.text = "А-а-а, это вы... Ну что скажете?";
                    link.l1 = "Я выполнил"+ GetSexPhrase("","а") +" ваше задание, всё в порядке. Более того, я помог"+ GetSexPhrase("","ла") +" Леграну разделаться с бандитами, которые пытались его ограбить.";
                    link.l1.go = "Step_1_3";
                break;
                ...
                case "Fr2Letter_NiceResult":
                    dialog.text = "Так, капитан, рассказывайте, что у вас?";
                    link.l1 = "Скажу я вам, месье д'Ожерон, что попал"+ GetSexPhrase("","а") +" я в изрядную переделку...";
                    link.l1.go = "Step_2_6";
                break;
                case "Fr3TakeAnna_BadResult":
                    dialog.text = "Я ждал вас. Что скажете, "+ GetSexPhrase("месье","мадемуазель") +"?";
                    link.l1 = "Я не смог"+ GetSexPhrase("","ла") +" привести донну Анну, я сожалею, что так вышло...";
                    link.l1.go = "Step_3_5";
                break;
                case "Fr3TakeAnna_NiceResult":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", я даже не знаю, как мне вас благодарить!";
                    link.l1 = "Это было не сложно, месье...";
                    link.l1.go = "Step_3_7";
                break;
                case "Fr4SoleiRoyal_DieHard":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", доложите о выполнении задания.";
                    link.l1 = "Месье генерал-губернатор, близ Доминики я не застал"+ GetSexPhrase("","а") +" французской эскадры, зато на меня напала испанская эскадра Хуана Галено. Я не смог"+ GetSexPhrase("","ла") +" противостоять ей, мне пришлось покинуть место сражения...";
                    link.l1.go = "Step_4_7";
                break;
                case "Fr4SoleiRoyal_SoleiRoyalSunk":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", доложите о выполнении задания.";
                    link.l1 = "Месье генерал-губернатор, близ Доминики я не застал"+ GetSexPhrase("","а") +" французской эскадры, зато на меня напала испанская эскадра Хуана Галено. Я отразил"+ GetSexPhrase("","а") +" нападение, но в результате боя 'Солей Руаяль' был потоплен. Мне очень жаль...";
                    link.l1.go = "Step_4_9";
                break;
                case "Fr4SoleiRoyal_backTortuga":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", доложите о выполнении задания.";
                    link.l1 = "Всё в порядке, месье, хоть и не без проблем. Я отразил"+ GetSexPhrase("","а") +" нападение испанской эскадры под командованием того самого Хуана Галено, французской эскадры близ Доминики я не наш"+ GetSexPhrase("ел","ла") +", поэтому пришлось доставить 'Солей Руаяль' в Бас-Тер.";
                    link.l1.go = "Step_4_11";
                break;
                case "Fr5AnnaHant_GoodWork":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", я начинаю думать, что нет такого поручения, которое вы не могли бы выполнить. Вот ваша награда, и донна де Лейва хочет лично поблагодарить вас.";
                ...
                case "Fr7RockBras_toSeekPlace":
                    ...
                    link.l1.go = "exit";
					link.l2 = "Сударь, я искал"+ GetSexPhrase("","а") +" его повсюду, но найти так и не сумел"+ GetSexPhrase("","а") +". Я долж"+ GetSexPhrase("ен","на") +" признаться, что все бесполезно...";
                    link.l2.go = "Step_7_6";
                break;
                ...
                case "Fr7RockBras_RockIsSaved":
                    dialog.text = "Вижу, капитан, всё в порядке. Рок уже рассказал, что ему довелось пережить в Инквизиции и как вы вытащили его оттуда. Я в восхищении!";
                ...
                case "Fr8ThreeCorsairs_backGovernor":
                    dialog.text = "Итак, госпо"+ GetSexPhrase("дин","жа") +" " + GetFullName(pchar) + ", я счастлив поздравить вас с титулом барон"+ GetSexPhrase("а","ессы") +"! Поверьте, редко кто удостаивается такой чести.";
                ...
                case "Fr9GuardPP_GoodWork":
					...
					{
						dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", вы потеряли 'Солей Руаяль'!";
                ...
                case "Fr9GuardPP_DieHard":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", вы не сумели защитить Порт-о-Принс! В чем дело?!";
                    link.l1 = "Месье губернатор, испанцы сумели собрать эскадру невиданной силы! Мне пришлось отступить...";
                    link.l1.go = "Step_9_6";
                break;
                case "Fr9GuardPP_Late":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", вы не сумели защитить Порт-о-Принс! В чем дело?!";
                    link.l1 = "Я не успел"+ GetSexPhrase("","а") +" вовремя, месье генерал-губернатор, когда я подош"+ GetSexPhrase("ел","ла") +" к городу, он уже был испанским...";
                    link.l1.go = "Step_9_7";
                break;
                ...
                case "Fr11OccupySC_toWeWon":
					dialog.text = "Барон"+ GetSexPhrase("","есса") +", я жду вашего доклада, насколько успешна операция по захвату Санта-Каталины?";
					if (LAi_IsDead(characterFromId("SoleiRoyalCaptain")))
					{
						link.l1 = "Санта-Каталина захвачена и приведена к присяге Людовику XIV. Это хорошие новости, а плохие - я потерял"+ GetSexPhrase("","а") +" 'Солей Руаяль'...";
                ...
                case "QuestLineBreake":
                    dialog.text = "Я не имею дело с людьми, нарушающими своё слово. Мне больше нечего вам сказать.";
                    link.l1 = "...";
                    link.l1.go = "exit";
				...
				{
					link.l1 = "Господин, Солей Руаяль прекрасный корабль, в интересах нашей державы, необходимо будет построить ещё один королевский мановар для усиления господства на море. Это даст нам большое преимущество в грядущих войнах.";
        ...
        case "Step_H7_2":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", буду у вас в резиденции через два часа, месье.";
            link.l1.go = "exit";
        ...
        break;
        case "Step_H7_4":
            dialog.text = "Да, конечно. Удачи вам на обратном пути. С началом деволюционной войны испанцы серьёзно активизировались. Так что будете очень осторожны. Если что-либо из нашей переписки попадёт к испанцам, то они смогут доказать наши согласованные действия против Испании. Молодой Республике Соединённых Провинций в этом случае не поздоровится.";
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", месье. Прощайте и удачи вам также.";
            link.l1.go = "exit";
        ...
        break;
        case "Step_H7_5":
            dialog.text = "Я вижу. А почему вы ещё здесь? Похоже, что и никуда не торопитесь!";
            link.l1 = "Месье, написанная вами депеша похищена. Меня ударили по голове, и я пролежал"+ GetSexPhrase("","а") +" без сознания все это время!";
        ...
        case "Step_H7_6":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", месье, спасибо за помощь!";
            link.l1.go = "exit";
            pchar.questTemp.State = "DelivLettTortuga_toPortMan";
        break;
        //********************** Квест №1 французской линейки, охрана Леграна ************************
        case "Step_1_1":
            dialog.text = "Вы верно уловили. Месье Леграну нужно тайно попасть на Мартинику, потом он сумеет отправиться оттуда рейсовым кораблём в Дьепп. Но он «сидит» на куче золота и это знают все, поэтому есть серьёзные опасения за благополучный исход возвращения в Старый Свет.\n"+
				          "Отправляйтесь в таверну - там вы найдёте Леграна. Ваша задача — доставить его в бухту Ле Марен, что на Мартинике. Пьер отблагодарит вас, судар"+ GetSexPhrase("ь","ыня") +".";
            link.l1 = "Хорошо, месье, я сделаю всё так, как вы сказали.";
            link.l1.go = "exit";
            SaveCurrentQuestDateParam("questTemp");
        ...
        break;
        case "Step_1_4":
            dialog.text = "Странно все это... Вот что, судар"+ GetSexPhrase("ь","ыня") +", я не желаю больше иметь с вами дело. Более того, если я когда-нибудь узнаю, что это вы убили Леграна - мне сложно описать словами, что с вами будет.\n"+
				          "Я вас не задерживаю!";
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", месье...";
            link.l1.go = "exit";
			...
			AddCharacterExpToSkill(pchar, "Sneak", -170);
			//слухи
			AddSimpleRumour("Вы слышали, капитана " + GetMainCharacterNameGen() + " наш генерал-губернатор выставил из резиденции за какую-то тёмную историю, связанную с Леграном... Теперь у не"+ GetSexPhrase("го","е") +" 'волчий билет.'", FRANCE, 5, 1);
        break;
        case "Step_1_5":
            ...
            link.l1 = "Я знал"+ GetSexPhrase("","а") +" его совсем чуть-чуть, но мне он показался хорошим малым.";
            link.l1.go = "Step_1_6";
        break;
		case "Step_1_6":
            dialog.text = "И это действительно так, "+ GetSexPhrase("месье","мадемуазель") +" " + pchar.lastname + ". Ну что же, печально, что так вышло, но, тем не менее, я благодарен вам за содействие. Поэтому прошу вас заглядывать ко мне время от времени - возможно, подвернётся работа для флибустьера.";
            link.l1 = "Хорошо, месье д'Ожерон, буду наведываться в ваше резиденцию.";
            link.l1.go = "Step_1_7";
        break;
        case "Step_1_7":
            dialog.text = "Одну минуту, судар"+ GetSexPhrase("ь","ыня") +"! Верните деньги, которые были у Леграна, они вам не принадлежат.";
            link.l1 = "Хм, месье...";
            link.l1.go = "Step_1_8";
        break;
        case "Step_1_8":
        ...
        break;
        case "Step_1_10":
            dialog.text = "Пока вы не вернёте мне деньги Леграна целиком и полностью, у меня в резиденции вам делать нечего.";
		...
		case "Step_1_11":
            dialog.text = "Ну что же, мы в расчёте. Вы можете теперь бывать у меня, я буду давать вам работу время от времени, судар"+ GetSexPhrase("ь","ыня") +".";
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), 1);
			//слухи
			AddSimpleRumour("Вы знаете, капитан " + GetFullName(pchar) + " "+ GetSexPhrase("был нанят","была наната") +" генерал-губернатором для сопровождения славного корсара Леграна. И он"+ GetSexPhrase("","а") +" с честью выполнил"+ GetSexPhrase("","а") +" это поручение!", FRANCE, 5, 1);
        break;
        //********************** Квест №2 доставка письма на Кюрасао ************************
        case "Step_2_1":
            dialog.text = "Петер Стэвезант, генерал-губернатор Кюрасао, мой личный друг и друг Республики Соединённых провинций. Поэтому не вздумайте учудить там что-нибудь эдакое, иначе, по прибытии на Тортугу, я спущу с вас шкуру.";
			link.l1 = "Месье Бертран, я флибустьер, но разве похож"+ GetSexPhrase("","а") +" на безответственн"+ GetSexPhrase("ого типа","ую тупицу") +"? Все будет сделано в лучшем виде, можете не беспокоиться.";
            link.l1.go = "Step_2_2";
        break;
        case "Step_2_2":
            dialog.text = "Ну что же, очень хорошо. Ступайте, судар"+ GetSexPhrase("ь","ыня") +".";
        ...
        case "Step_2_5":
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), -1);
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " исполнял"+ GetSexPhrase("","а") +" обязанности вестов"+ GetSexPhrase("ого","ой") +" нашего генерал-губернатора. И знаете, странная история приключилась с н"+ GetSexPhrase("им","ей") +" в Виллемстаде, очень странная...", FRANCE, 5, 1);
        break;
        case "Step_2_6":
            dialog.text = "Что случилось, судар"+ GetSexPhrase("ь","ыня") +"?";
			link.l1 = "Ох, месье, давайте по порядку. Сначала меня бросили в тюрьму и хотели повесить, но на утро следующего дня освободили.";
            link.l1.go = "Step_2_7";
        break;
        case "Step_2_7":
            dialog.text = "Как повесить? Вы же были "+ GetSexPhrase("моим вестовым","моей вестовой") +"!";
			link.l1 = "Думали, что я лазутчи"+ GetSexPhrase("к","ца") +" бандитов, промышляющих грабежом голландских судов близ Кюрасао. В общем, в итоге я наш"+ GetSexPhrase("ел","ла") +" эту банду и покончил"+ GetSexPhrase("","а") +" с ними. Это оказались испанские каперы, как вам это?!";
            link.l1.go = "Step_2_8";
        break;
        case "Step_2_8":
            dialog.text = "Испанские каперы?! Ха-ха, это звучит о-о-очень убедительно.\n"+
				          "Это хорошо, что вы смогли проявить себя в Виллемстаде. Я рад, что поручил это задание "+ GetSexPhrase("такому дотошному флибустьеру","такой сообразительной и отважной девушке") +".\n"+
						  "Сейчас я вас более задерживать не смею - отдыхайте. Но через неделю-другую прошу явиться ко мне в резиденцию, я подберу для вас ещё работу.";
			...
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " исполнял"+ GetSexPhrase("","а") +" обязанности вестово"+ GetSexPhrase("го","й") +" нашего генерал-губернатора. И знаете, странная история приключилась с н"+ GetSexPhrase("им","ей") +" в Виллемстаде - е"+ GetSexPhrase("го","её") +" арестовали. Но к чести французов, "+ GetSexPhrase("он сумел","она сумела") +" выпутаться из ситуации. Д'Ожерон, должно быть, доволен...", FRANCE, 5, 1);
		break;
        //********************** Квест №3 похищение донны Анны ************************
        case "Step_3_1":
            dialog.text = "О вас ходит молва, что вы отчаянн"+ GetSexPhrase("ый головорез","ая сорвиголова") +", и я знаю, что для вас слово 'честь' не пустой звук. Сознаюсь, мне нелегко довериться вам, но полагаю, это лучший вариант... Моя жизнь в ваших руках, и вам решать, разменяете ли вы её на золото или докажете, что вы "+ GetSexPhrase("рыцарь","благородная женщина") +"!";
			link.l1 = "Чёрт возьми, любой скажет, что я умею резать глотки, но никто не посмеет сказать, что я "+ GetSexPhrase("подлец и предатель","предательница") +"! Я слушаю вас.";
            link.l1.go = "Step_3_2";
        break;
        case "Step_3_2":
        ...
        break;
        case "Step_3_3":
            dialog.text = "Дело не во мне. Есть дама, которая будет счастлива вдохнуть вольный воздух нашей колонии, но вынуждена сидеть взаперти под властью жестокого супруга... Вызволить её из темницы, в которой она пребывает - дело"+ GetSexPhrase(", достойное кавалера"," справедливое! Вы, как женщина, должны понять меня") +"!";
			link.l1 = "Слава Создателю, вы наконец-то добрались до сути. Кого я долж"+ GetSexPhrase("ен","на") +" спасти?";
            link.l1.go = "Step_3_4";
        break;
        case "Step_3_4":
            dialog.text = "Значит, вы берётесь за это дело? Отлично! Дама, о которой я говорю, - супруга дона Хосе Рамиреса де Лейва, коменданта Гаваны. Вам надлежит проникнуть в город и найти способ вывести её оттуда.\n"+
						  "Для того, чтобы вы могли сделать это успешно, я даю вам Испанскую торговую лицензию Эскориала сроком на 60 дней, с ней вам будет разрешено заходить в испанские порты и посещать испанские города. И позаботьтесь о том, чтобы на вашем корабле развевался дружественный Испании флаг.\n"+
			...
			link.l1 = "Я понял"+ GetSexPhrase("","а") +" вас, месье. Признаюсь, непривычное дело, однако ценю ваше доверие... Все будет сделано в лучшем виде - не сомневайтесь.";
            link.l1.go = "exit";
        ...
        case "Step_3_5":
			...
			link.l1 = "Да ничего особенного, месье. Я просто не сумел"+ GetSexPhrase("","а") +" к ней подобраться - жена коменданта столицы, как-никак...";
            link.l1.go = "Step_3_6";
        break;
        case "Step_3_6":
            dialog.text = "М-да, печально... Ну что же, это была моя личная просьба к вам, поэтому перед Францией вы ни в чём не виноваты.\n"+
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), -1);
			//слухи
			AddSimpleRumour("Ходят слухи, что капитан " + GetFullName(pchar) + " провалил"+ GetSexPhrase("","а") +" какое-то очень важное задание д'Ожерона, связанное с амурными делами...", FRANCE, 5, 1);
		break;
        case "Step_3_7":
			dialog.text = "Тем не менее, примите от меня скромное вознаграждение.\n"+
				          "И чёрт возьми, вы уж оставьте меня одного, мне сейчас не до административных вопросов. Заходите через некоторое время...";
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что именно капитан " + GetFullName(pchar) + " проявил"+ GetSexPhrase("","а") +" чудеса храбрости и находчивости, и сумел"+ GetSexPhrase("","а") +" доставить сюда испанскую пассию д'Ожерона - донну Анну...", FRANCE, 5, 1);
		break;

        //********************** Квест №4  Солей Руаяль ************************
		case "Step_4_1":
            dialog.text = "Да, я знаю, что вы моря"+ GetSexPhrase("к","чка") +", а не любитель"+ GetSexPhrase("","ница") +" альковных тайн. Но я вас успокою: нынешнее дело в вашем вкусе. Недавно в метрополии спущен на воду самый мощный и прекрасный корабль мира - 'Солей Руаяль'. Его Величество заинтересован в безопасности французских колоний в Вест-Индии, и для нас большая честь, что этот корабль направлен именно к нам.";
		...
		case "Step_4_2":
			...
			link.l1 = "С моим кораблём - охранять лучший корабль Франции? Хм, странно это...";
            link.l1.go = "Step_4_3";
        break;
		case "Step_4_3":
            dialog.text = "Ничего странного. Два корабля всегда лучше, чем один, а вы "+ GetSexPhrase("храбрый и умелый капитан","храбрая и умелая, капитан") +". К тому же у меня есть основания полагать, что испанцы собираются устроить охоту на 'Солей Руаяль'. Трём или четырём галеонам с абордажной командой на борту вполне по силам захватить даже самый мощный корабль.\n"+
				          "Более того, мне достоверно известно, что эти галеоны под командованием некоего Хуана Галено уже наготове. Положите жизнь, если это будет необходимо, но нельзя допустить, чтобы наш флагман попал в руки Эскориала. Или вы вернётесь с докладом об успешном выполнении миссии, или лучше не возвращайтесь...";
			link.l1 = "Положить жизнь... Я далеко не трус"+ GetSexPhrase("","иха") +", но звучит это не очень заманчиво!";
            link.l1.go = "Step_4_4";
        break;
		case "Step_4_4":
            dialog.text = "Я понял намёк, капитан. Надеюсь, заманчиво прозвучит обещание щедрой награды за эту работу?";
			link.l1 = "А зачем везти корабль именно к Доминике? Это же необитаемый остров...";
            link.l1.go = "Step_4_5";
        break;
		case "Step_4_5":
            dialog.text = "Там вы должны будете соединиться с эскадрой из Гваделупы. Её должен отправить к Доминике генерал-губернатор Бас-Тера " + GetFullName(characterFromId("BasTer_Mayor")) + ".";
			link.l1 = "Понятно. Ну что же, я соглас"+ GetSexPhrase("ен","на") +" выполнить данное поручение.";
            link.l1.go = "Step_4_6";
        break;
		case "Step_4_6":
        ...
        break;
		case "Step_4_7":
            dialog.text = "Поверить не могу... Вы бросили 'Солей Руаяль', чтобы спастись само"+ GetSexPhrase("му","й") +"?!";
			link.l1 = "Мне пришлось это сделать месье...";
            link.l1.go = "Step_4_8";
        break;
		case "Step_4_8":
            dialog.text = "Мне все ясно - вы "+ GetSexPhrase("форменный трус","всего лишь трусливая девчонка") +", капитан. Прошу вас удалиться немедленно, я более не желаю вас видеть. Может быть, когда-нибудь вы сможете рассчитывать на мою благосклонность, но не в ближайшее время...";
			link.l1 = "Хорошо, месье, я понял"+ GetSexPhrase("","а") +".";
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что наш генерал-губернатор выставил вас из резиденции за то, что вы бросили в бою 'Солей Руаяль'. Хех, поделом...", FRANCE, 5, 1);
        break;
		case "Step_4_9":
            dialog.text = "Чёрт возьми, вы не сумели защитить 'Солей Руаяль'... Это катастрофа...";
			link.l1 = "Месье генерал-губернатор, я сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +"...";
		...
		case "Step_4_10":
			...
			AddCharacterExpToSkill(pchar, "Cannons", -250);
			//слухи
			AddSimpleRumour("Ходят слухи, что наш генерал-губернатор выставил вас из резиденции за то, что вы умудрились утопить 'Солей Руаяль'. Хех, поделом...", FRANCE, 5, 1);
        break;
		case "Step_4_11":
            dialog.text = "Хм, непредвиденные обстоятельства... Что же, вы приняли правильное решение, судар"+ GetSexPhrase("ь","ыня") +". Я поздравляю вас с удачным завершением очередного дела и прошу принять вознаграждение - 28000 золотых.";
			link.l1 = "Спасибо, месье генерал-губернатор...";
            link.l1.go = "Step_4_12";
        break;
		case "Step_4_12":
            dialog.text = "Я прошу вас быть у меня в резиденции через неделю-другую, возможно, у меня найдётся для вас новое дело.";
		...
		case "Step_4_check":
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что при сопровождении 'Солей Руаяля' на вас напали испанцы! Позвольте выразить вам своё восхищение"+ GetSexPhrase(" - вы прекрасный моряк и настоящий воин"," - вы настоящая Жанна д'Арк") +"!", FRANCE, 5, 1);
			DialogExit();
        break;
        //********************** Квест №6. Доставка письма Олоне ************************
		case "Step_6_1":
            dialog.text = "Именно он. И учтите, что это письмо ни при каких обстоятельствах не должно оказаться в чужих руках. Если вы попадёте в переделку, то даже погибнуть не имеете права прежде, чем уничтожите пакет.";
		...
		case "Step_6_3":
			...
			link.l1 = "Месье генерал-губернатор, мы с Олоне договорились взять Куману... Взяли, но потом вышла ссора... В общем, Олоне мёртв, сударь...";
            link.l1.go = "Step_6_4";
        break;
		case "Step_6_4":
            dialog.text = "Вот это да... И кто же этот герой, что осмелился бросить вызов самому Франсуа Олоне?";
			link.l1 = "Месье, "+ GetSexPhrase("это ваш покорный слуга","гм.. Это я") +"...";
            link.l1.go = "Step_6_5";
        break;
		case "Step_6_5":
            dialog.text = "Да уж, вы, "+ GetSexPhrase("сударь, отчаянный головорез","сударыня, отчаянная сорвиголова") +"! Олоне - демон во плоти.\n"+
		...
		case "Step_6_6":
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что вы расправились с самим Франсуа Олоне! Да уж, скажу я вам, отчаянной вы храбрости "+ GetSexPhrase("человек","девушка") +"...", FRANCE, 5, 1);
        break;
		case "Step_6_7":
            dialog.text = "О, это прекрасно. По сути своей, именно взятия Куманы я и добивался. Ну что же, прекрасная работа, "+ GetSexPhrase("друг мой","мадемуазель") +". Я вполне доволен вашей расторопностью.";
		...
		case "Step_6_9":
			...
			link.l1 = "Он предложил мне поход на Куману. К сожалению, я "+ GetSexPhrase("вынужден был","вынуждена была") +" отказаться. Однако, полагаю, что он и без меня справится, имея в составе своей эскадры три корабля.";
            link.l1.go = "Step_6_10";
        break;
		case "Step_6_10":
            dialog.text = "Ну что же, будем надеяться, что мой план сработает... Вас я больше не смею задерживать, судар"+ GetSexPhrase("ь","ыня") +". Не забывайте бывать у меня время от времени, вы можете понадобиться.";
			link.l1 = "Хорошо, месье генерал-губернатор.";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
            SaveCurrentQuestDateParam("questTemp");
		...
		case "Step_7_1":
            dialog.text = "К испанцам в лапы попал известный флибустьер Рок Бразилец. Милости ему ждать не приходится, поскольку он преизрядно пощипал испанцев. Разумеется, прежде чем познакомить Рока с конопляной тётушкой, они захотят выяснить, где он припрятал отобранное у них золото. Но это даже не самое главное.";
        ...
        break;
		case "Step_7_5":
            dialog.text = "Очень хорошо. И ещё - в городе вам необходимо действовать скрытно, по возможности не поднимая тревоги. Для этого я вновь даю вам верительную грамоту Испанской торговой компании.";
		...
		case "Step_7_6":
            dialog.text = "Хм, бесполезно в вашем исполнении, "+ GetSexPhrase("месье","мадемуазель") +". Не говорите за весь Новый Свет.\n"+
				          "Очень жаль, судар"+ GetSexPhrase("ь","ыня") +", что вы не сумели выполнить задания, очень жаль... Пожалуй, вы мне больше не нужны. Вы можете заглядывать ко мне в резиденцию периодически, возможно, и для вас найдётся работа...";
			link.l1 = "Хорошо, месье генерал-губернатор.";
			...
			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + " не сумел"+ GetSexPhrase("","а") +" вытащить Рока Бразильца из испанских застенков. Плохо, он был хорошим человеком...", FRANCE, 5, 1);
		...
		case "Step_7_9":
			...
			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + " вытащил"+ GetSexPhrase("","а") +" Рока Бразильца из испанских застенков. Радостная весть, скажу я вам, Рока здесь уважают.", FRANCE, 5, 1);
        break;
		case "Step_7_Rock":
			sld = characterFromId("RockBrasilian");
			RemovePassenger(PChar, sld);
        ...
        break;
		case "Step_8_3":
            dialog.text = "Ну что же, пока новых просьб к вам у меня нет, но я буду счастлив, если вы будете время от времени навещать меня - возможно, нам ещё предстоят совместные дела!";
			link.l1 = "Хорошо, сударь. Я, как "+ GetSexPhrase("французский дворянин, барон","французская дворянка, баронесса") +", буду у бывать у вас в резиденции чаще.";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
		...
		case "Step_9_1":
			...
			link.l1 = "Я понял"+ GetSexPhrase("","а") +", сударь. Я могу приступать к выполнению задачи?";
            link.l1.go = "Step_9_11";
        break;
		case "Step_9_11":
            dialog.text = "В принципе, да. Однако, мне нужно довести до вас следующее - 'Солей Руаяль' придаётся вам в качестве усиления эскадры.\n"+
			...
			link.l1 = "Хм, ну что же, я приму все меры к тому, чтобы великолепный 'Солей Руаяль' серьёзно не пострадал.";
            link.l1.go = "exit";
        ...
        break;
		case "Step_9_2":
            dialog.text = "Верно, барон"+ GetSexPhrase("","есса") +", и выполнена блестяще. Французское правительство предусмотрело определённую сумму на ремонт кораблей и пополнение личного состава - 5 тысяч золотых... Извольте получить.";
			link.l1 = "Всего 5 тысяч?! Каррамба, это меньше, чем ничего!";
            link.l1.go = "Step_9_3";
        break;
		case "Step_9_3":
            dialog.text = "Барон"+ GetSexPhrase("","есса") +", эта война требует от всех нас максимально напряжения сил. Я прошу вас понять ситуацию - денег катастрофически не хватает. Поэтому прошу вас принять сложившуюся ситуацию как данность.\n"+
				          "Сейчас я вас задерживать не смею - подготовьтесь к очередным боевым действиям. И помните - вы нужны Франции!";
			link.l1 = "Гм, ну что же, если я так нуж"+ GetSexPhrase("ен","на") +" Франции - она меня получит. Буду у вас в резиденции после того, как приведу в порядок свои дела, сударь. До свидания.";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
        ...
        break;
		case "Step_9_5":
            dialog.text = "Вы сделали недостаточно! В общем, потеря такого корабля привела к тому, что Франция отказывается от ваших услуг, судар"+ GetSexPhrase("ь","ыня") +". Прощайте.";
			link.l1 = "И это после всего, что я сделал"+ GetSexPhrase("","а") +" для Франции?! Прощайте, сударь, мне и само"+ GetSexPhrase("му","й") +" все это уже изрядно надоело...";
            link.l1.go = "exit";
			pchar.questTemp.State = "QuestLineBreake";
			bWorldAlivePause   = false; // Конец линейки
			CloseQuestHeader("Fra_Line_9_GuardPortPax");
        ...
        break;
		case "Step_9_6":
            dialog.text = "Чёрт возьми, да вы просто "+ GetSexPhrase("форменный трус","трусливая девчонка") +"! Я не желаю иметь с вами ничего общего. Прощайте, барон"+ GetSexPhrase("","есса") +"...";
        ...
        break;
		case "Step_9_7":
            dialog.text = "Дьявол, как же так?! Здесь два дня ходу!! В общем так, я не желаю иметь с вами ничего общего. Прощайте, барон"+ GetSexPhrase("","есса") +"...";
			link.l1 = "Прощайте, сударь, мой пламенный привет маркизу Бонрепо...";
            link.l1.go = "exit";
			...
			AddCharacterExpToSkill(pchar, "Fencing", -230);
			//слухи
			AddSimpleRumour("Ходят слухи, что наш генерал-губернатор выставил вас из резиденции за то, что вы не сумели вовремя прибыть к Порт-о-Принсу и город был разорён испанцами. Поделом вам!", FRANCE, 5, 1);
        break;
        ...
        break;
		case "Step_10_2":
            dialog.text = "Хорошо, барон"+ GetSexPhrase("","есса") +". Итак, я поручаю вам захватить Санто-Доминго! Таким образом, вся Эспаньола будет принадлежать целиком одной державе, но не Испании, а Франции. Теперь понятно?";
			link.l1 = "Понятно, сударь. Скажите, как насчёт оплаты данной военной операции? Я не могу содержать 'Солей Руаяль' и вести войну за свой счёт!";
            link.l1.go = "Step_10_3";
        break;
		case "Step_10_3":
            dialog.text = "Да, я понимаю. Вопрос по сути своей решён - после захвата Санто-Доминго вы получите очень весомое вознаграждение.";
		...
		case "Step_10_4":
			...
			link.l1 = "Битва была жаркой, месье генерал-губернатор, корабль-красавец действительно пошёл на дно. Мне очень жаль...";
		...
		case "Step_10_6":
            dialog.text = "Прекрасно, "+ GetSexPhrase("друг мой","мадемуазель") +", просто великолепно!\n"+
				          "Теперь о теме, очень важной для вас - о вознаграждении. Я сумел выбить из бюджета на финансирование вашей экспедиции неслыханную сумму - 40 тысяч золотых... Они ваши, барон"+ GetSexPhrase("","есса") +"!";
			link.l1 = "Отлично, месье генерал-губернатор. Уже гораздо лучше!";
            link.l1.go = "Step_10_7";
        break;
		case "Step_10_7":
            dialog.text = "Я очень рад, что вы довольны... Ну что же, задерживать вас я не смею более, прошу вас заняться подготовкой к другому делу. Приведите в порядок свою эскадру и будьте у меня примерно через месяц, барон"+ GetSexPhrase("","есса") +".";
		...
		case "Step_11_1":
            dialog.text = "Верно, судар"+ GetSexPhrase("ь","ыня") +".";
		...
		case "Step_11_2":
			...
			link.l1 = "Совершенно соглас"+ GetSexPhrase("ен","на") +" с французским правительством. Я готов"+ GetSexPhrase("","а") +" к выполнению данной операции. Приступаю немедленно.";
            link.l1.go = "exit";
		...
		case "Step_11_5":
			...
			link.l1 = "Месье генерал-губернатор, как насчёт финансирования операции?";
        ...
        break;
		case "Step_11_7":
            dialog.text = "Это невозможно, судар"+ GetSexPhrase("ь","ыня") +". Данный вопрос на контроле у Жана-Батиста Кольбера, премьер-министра Франции! Барон"+ GetSexPhrase("","есса") +", негоже делать деньги в то время, когда Франция прилагает сверхусилия в этой войне.";
			link.l1 = "Хм, пожалуй, вы правы, сударь...";
            link.l1.go = "Step_11_8";
        break;
		case "Step_11_8":
            dialog.text = "Ну что же, я искренне рад, что мы хорошо понимаем друг друга. Барон"+ GetSexPhrase("","есса") +", я не смею вас задерживать сейчас, прошу вас привести в порядок свою эскадру и быть готов"+ GetSexPhrase("ым","ой") +" к новым подвигам на благо Франции и нашего великого Короля-Солнце!";
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что вы захватили Санта Каталину. А потом пытались получить долю от жемчужных разработок у д'Ожерона. Хех, раскатали губу, называется...", FRANCE, 5, 1);
        break;
		...
		case "Step_12_1":
            dialog.text = "Вы также внесли вклад в эту победу. По сути дела, именно вы обеспечили решительный разгром сил испанцев в Карибском море.\n"+
				          "Жан-Батист Кольбер отметил ваши удачные действия на докладе в Лувре, ваше имя теперь известно самому Людовику XIV!";
			link.l1 = "Я очень и очень рад"+ GetSexPhrase("","а") +". Скажите, месье, а денежных поощрений по итогам войны не предусмотрено?";
