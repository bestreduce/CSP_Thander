		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "EndOfQuestLine":
					...
					{
						link.l2 = "Господин, Солей Руаяль прекрасный корабль, в интересах нашей державы, необходимо будет построить ещё один королевский мановар для усиления господства на море. Это даст нам большое преимущество в грядущих войнах.";
