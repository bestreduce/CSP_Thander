...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_155":  // работа на благо короны - линейка нации
            // сюда вход только с патентом, проверка выше
            dialog.text = LinkRandPhrase("Вы находитесь на службе Республике Соединённых Провинций! Прошу немедленно приступить к выполнению возложенного на вас поручения!",
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    ...
                    else
                    {
                        ...
                        {
                            case "2":
                                dialog.text = "У меня есть для вас новое поручение. Необходимо закупить в Форт Оранже приготовленную для Кюрасао партию кофе, чёрного, красного и сандалового дерева. Отправляйтесь немедленно, вот необходимые для этого бумаги, вручите их губернатору Форт Оранжа.";
                            ...
                            case "4":
                                ...
                                {
                                    dialog.text = "Вы добыли важнейшую информацию. Мэдифорду сейчас не хватает сил, чтобы доставить нам серьёзные неприятности в Кюрасао, однако Форт Оранж, находящийся у них под боком на Ямайке, они хотят уничтожить.";
                                    link.l1 = "Да, минхер, это мне известно.";
                                    link.l1.go = "Step_4_1";
                                }
                                else
                                {
                                    dialog.text = "Вы не сумели должным образом выполнить предыдущее задание. Вместо вас данное задание с успехом было выполнено другими храбрецами. Теперь я предоставляю вам возможность реабилитироваться. В результате полученной информации я сделал вывод, что Мэдифорду сейчас не хватает сил, чтобы доставить нам серьёзные неприятности в Кюрасао, однако Форт Оранж, находящийся у них под боком на Ямайке, они хотят уничтожить.";
                                    link.l1 = "Понятно...";
                                    link.l1.go = "Step_4_1";
                                }
                            break;
                            case "5":
                                dialog.text = "Итак, вас ждёт следующее задание. Заключается оно в том, что вам нужно сопроводить три гружённых флейта в поселение буканьеров Ла Вега к Эдварду Мэнфилду.";
                                link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер.";
                                link.l1.go = "Step_5_1";
                            break;
                            case "6":
                            ...
                            break;
                            case "7":
                                dialog.text = "У меня для вас есть серьёзная миссия. Мне необходимо доставить депешу генерал-губернатору Тортуги Бертрану д'Ожерону. Связано это с нашими действиями в деволюционной войне Франции против Испании. Данная переписка строго секретна, поэтому прошу вас понимать, насколько я доверю вам. Данная депеша не должна попасть никому, кроме генерал-губернатора Тортуги, это категорическое требование!";
                                link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер. Все будет исполнено в надлежащем виде, именно месье д'Ожерон получит данную депешу.";
                                link.l1.go = "Step_7_1";
                            break;
                            case "8":
                                dialog.text = "У меня к вам личная просьба. Мой друг, глава общины янсенистов Кюрасао, которого вы привезли на остров, просит командировать к нему сметливого офицера. Лучше вашей кандидатуры у меня никого нет. Просьба его заключается в поиске чего-то, очень ему нужного. В общем, Аарон расскажет вам все сам, он сейчас в своём доме, навестите его.";
                                link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер. Немедленно отправлюсь к нему.";
                                link.l1.go = "exit";
                            ...
                            break;
                            case "9":
                                dialog.text = "Мы испытываем серьёзные трудности с постройкой на наших европейских верфях линейных кораблей с большим водоизмещением - мелководные гавани, знаете ли... Я вчера размышлял над этим печальным фактом, и тут мне пришла в голову гениальная мысль!";
                                link.l1 = "Какая же, минхер?";
                                link.l1.go = "Step_9_1";
                            break;
                            case "10":
                                dialog.text = "Чёрт возьми, " + pchar.name + ", вы были правы, когда предлагали мне оставить добытую вами эскадру здесь, в Карибском море...";
                            ...
                            break;
                            case "12":
                                dialog.text = "Спешу уведомить вас, что определён испанский город, который подвергнется нападению. Это Маракайбо. Жители города должны будут присягнуть на верность Республике Соединённых Провинций!";
                ...
                case "":           // Квест №1, доставка главы янсенистов мистера Аарона.
                    dialog.text = "Ну что же, у меня есть для вас весьма важное для города задание. Полагаю, оно будет вам по зубам.\n"+
                                  "Дело вот в чём: к нам на Кюрасао в последнее время стало прибывать довольно много протестантов из Европы, в основном из Фландрии и Бургундии, где свирепствует инквизиция. Недавно к нам прибыли так же сторонники учения Янсения. Дабы возглавить общину янсенистов, французским рейсовым кораблём из Голландии на Сан-Мартин прибыл влиятельный янсенист Аарон Мендес Чумакейро.\n"+
                ...
                case "SeekChumakeiro_GoToVillemstad":
                    dialog.text = "Ну что же, Аарон уже мне все рассказал. Хорошая работа, "+ GetSexPhrase("минхер","госпожа") +". Заходите ко мне через некоторое время, мне кажется, что я буду пользоваться вашими услугами и впредь.";
                    link.l1 = "Хорошо, минхер.";
                    link.l1.go = "exit";
                ...
                case "TakeFoodCuracao_toOrangeStore":
                    ...
                    link.l1 = "Выполняю ваше поручение по доставке груза из Форт Оранж, минхер.";
                    if (GetQuestPastDayParam("questTemp") > 60)
                    {
                        dialog.text = "Я просил вас доставить мне всю партию в течение 60 дней. Вы не справились....";
                        link.l1 = "Верно, я не уложил"+ GetSexPhrase("ся","ась") +" по времени - были серьёзные проблемы с ветром...";
                    }
                    link.l1.go = "Step_2_5";
                break;
                ...
                case "WormEnglPlans_GoodRusultWorm":
                    ...
                    link.l1 = "Мэдифорд готовит нападение на Форт Оранж. Идёт подготовка к штурму силами гарнизона Порт Рояля. Мэдифорд пытался уговорить корсаров напасть на Кюрасао, но у него ничего с этим не вышло. Так что сил для более крупной операции, нежели штурм Форт Оранжа, у Мэдифорда нет.";
                    link.l1.go = "Step_3_7";
                break;
                case "DefenceOrange_LateRiseOrange":
                    dialog.text = "Докладывайте, что с Форт Оранжем?";
                    link.l1 = "Минхер, я не смог"+ GetSexPhrase("","ла") +" прийти на помощь Форт Оранжу. Несчастные жители истреблены, Форт Оранж как голландское поселение более не существует...";
                    link.l1.go = "Step_4_2";
                break;
                case "DefenceOrange_DieHard":
                    dialog.text = "Докладывайте, что с Форт Оранжем?";
                    link.l1 = "Минхер, я не смог"+ GetSexPhrase("","ла") +" прийти на помощь Форт Оранжу. Мы дали бой, но англичане оказались сильней. Нам пришлось спасаться бегством... К сожалению, Форт Оранж как голландское поселение более не существует...";
                    link.l1.go = "Step_4_2";
                break;
                ...
                case "DefenceOrange_SquadronDestroyed":
                    dialog.text = "Докладывайте, что с Форт Оранжем?";
                    link.l1 = "Минхер, мне удалось уничтожить корабли англичан на море. Но, к сожалению, я не смог"+ GetSexPhrase("","ла") +" противостоять наземными силам британцев. Форт Оранж разрушен...";
                    link.l1.go = "Step_4_5";
                break;
                ...
                case "ThreeFleutes_AllFleuts":
                    ...
                    link.l1 = "Минхер, у берегов Эспаньолы на меня напала целая эскадра испанцев! Но я сумел"+ GetSexPhrase("","а") +" сохранить вверенные мне корабли.";
                    link.l1.go = "Step_5_4";
                break;
                ...
                case "DelivLettTortuga_NotFoundLetter":
                    ...
                    link.l1 = "Я успешно доставил"+ GetSexPhrase("","а") +" вашу депешу д'Ожерону.";
                    link.l1.go = "Step_7_2";
                break;
                ...
                case "SeekBible_BadResult":
                    dialog.text = "Чумакейро довёл до меня информацию, что вы не сумели выполнить его поручение.";
                ...
                case "TakeThreeShips_toAbordage":
                    dialog.text = "Та-а-ак, что вы скажете мне по поводу вашего задания? Как идёт захват кораблей?";
                    tempQty = 0;
                    for (i=1; i<=COMPANION_MAX; i++)
                	{
                        ...
                        if(chComp != -1)
                		{
                            ...
                            if (iBaseType == SHIP_MANOWAR || iBaseType == SHIP_CRISTIAN || iBaseType == SHIP_TRINITY || iBaseType == SHIP_OCEAN || iBaseType == SHIP_PRINCE || iBaseType == SHIP_MANOWAR_GUB || iBaseType == SHIP_PRINCE || iBaseType == SHIP_HMS_VICTORY || iBaseType == SHIP_SANFELIPE)
                            {
                                tempQty++;
                    ...
                    else
                    {
                        if (sti(pchar.questTemp.QtyShips) > tempQty)
                        {
                            if (tempQty > 1)
                            {
                                link.l1 = "Неплохо, минхер. Я готов"+ GetSexPhrase("","а") +" сдать " + tempQty +  " корабля.";
                            }
                            else
                            {
                                link.l1 = "Неплохо, минхер. Я готов"+ GetSexPhrase("","а") +" сдать один корабль.";
                            }
                            link.l1.go = "Step_9_5";
                ...
                case "SpaAttackCuracao_GoodWork":
                    ...
                    link.l1 = "Спасибо, моё участие в битве было достаточно скромным...";
                    link.l1.go = "Step_10_3";
                break;
                case "SpaAttackSentMartin_Late":
                    dialog.text = "Докладывайте, вы сумели защитить Сан Мартин?";
                    link.l1 = "Минхер, я сделал"+ GetSexPhrase("","а") +" все, чтобы успеть, было слишком поздно... Мариго теперь испанский город.";
                    link.l1.go = "Step_11_5";
                break;
                case "SpaAttackSentMartin_GoodWork":
                    dialog.text = "Докладывайте, вы сумели защитить Сан Мартин?";
                    link.l1 = "Я успел"+ GetSexPhrase("","а") +", минхер. Осада испанской эскадры с города Сан-Мартин снята. Испанцы разгромлены.";
                    link.l1.go = "Step_11_8";
                break;
                case "OccupyMaracaibo_toWeWon":
                    dialog.text = "Уже знаю, "+ GetSexPhrase("друг мой","" + pchar.name + "") +", уже доложили о вашей блистательной победе!";
        ...
        case "Step_1_1":
            dialog.text = "Христианское религиозное течение, если вам это интересно.\n"+
                          "Началось оно с написания Янсением в 1640 году теологического трактата об Августине. Иезуиты подчёркивают близость янсенистской доктрины с протестантскими догмами и преследуют последователей этого религиозного течения. Людовик XIV также объявил янсенистов вне закона.\n"+
            ...
            link.l1 = "Я готов"+ GetSexPhrase("","а") +", минхер. Ожидайте, я скоро вернусь.";
            link.l1.go = "Step_1_2";
            link.l2 = "Извините, но в данный момент я очень занят"+ GetSexPhrase("","а") +". Позже я готов"+ GetSexPhrase("","а") +" буду выполнить это ваше поручение.";
            link.l2.go = "exit";
        break;
        case "Step_1_2":
            SaveCurrentQuestDateParam("questTemp");
        ...
        case "Step_2_1":
            dialog.text = "Именно закупить. Для закупки этой партии товара Форт Оранж даёт нам очень хорошие цены. Как только вы вручите мою верительную грамоту губернатору Форт Оранжа - вы получите льготные цены.\n"+
                          ...
                          "В соответствии с моими расчётами я выделяю вам на закупку 17700 золотых. Извольте получить.";
        ...
        break;
        case "Step_2_2":
            dialog.text = "Конечно, подскажу. В общей сложности вес всей партии составляет 5600 центнеров.";
            link.l1 = "Хм, немало... Минхер, я "+ GetSexPhrase("свободный капитан","не торговый капитан") +", и мне эти операции с перевозками грузов не очень по душе...";
            link.l1.go = "Step_2_3";
        break;
        case "Step_2_3":
            dialog.text = "Вот потому, что вы, так сказать, "+ GetSexPhrase("свободный капитан","и не торговый капитан") +", я именно вас и привлекаю к выполнению данного поручения. Мне этот груз нужен здесь в целости и сохранности, и мне кажется, что именно "+ GetSexPhrase("свободный капитан","капер") +" сможет обеспечить его целостность и сохранность.\n"+
                          ...
                          "Отказа от выполнения данного поручения я от вас не приму. Приступайте! И помните, что вся партия, все 5600 центнеров, нужна мне здесь, в Виллемстаде, не позже, чем через два месяца.";
            link.l1 = "Хм, м-да... Ну хорошо, минхер, я всё сделаю. Вы не оставляете мне выбора.";
            link.l1.go = "Step_2_4";
        break;
        case "Step_2_4":
        ...
        case "Step_2_5":
            ...
            dialog.text = "Говорите, сколько и чего вы привезли из Форт Оранжа.";
            link.l1 = tempStr;
            link.l1.go = "Step_2_6";
        ...
        break;
        case "Step_2_6":
            tempStr = "Итак, давайте подведём итог.";
        ...
        case "Step_2_7":
            ...
            {
                dialog.text = "Я прошу вас закончить начатое дело. Мне нужна вся партия из Форт Оранжа, до последнего центнера.";
        ...
        break;
        case "Step_2_8":
            dialog.text = "Я понимаю, однако и вы должны понимать, что я руководствуюсь глобальными планам и мне просто необходимо чёткое выполнение моих инструкций./n"+
        ...
        break;
        case "Step_2_9":
            dialog.text = "Всегда к вашим услугам, капитан. Заходите ко мне время от времени, возможно у меня найдётся для вас ещё работа.";
            link.l1 = "Хорошо, минхер.";
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), 1);
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " взял"+ GetSexPhrase("ся","ась") +" за торговую операцию - доставку продовольствия из Форт Оранжа. Задачу "+ GetSexPhrase("он выполнил","она выполнила") +", но в установленные сроки не уложил"+ GetSexPhrase("ся","ась") +".", HOLLAND, 5, 1);
        break;
        case "Step_2_10":
        ...
        case "Step_2_12":
			...
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " взял"+ GetSexPhrase("ся","ась") +" за торговую операцию - доставку продовольствия из Форт Оранжа. Задачу "+ GetSexPhrase("он выполнил","она выполнила") +", да ещё и сделал"+ GetSexPhrase("","а") +" это быстро!", HOLLAND, 5, 1);
        break;
        //********************** Квест №3, Узнать о планах англичан в связи с торговой войной ************************
        case "Step_3_1":
            dialog.text = "Эпицентр войны находится в прибрежных водах Европы и в Индийском океане, однако и здесь, в Карибском море, эта война окажет своё влияние.\n"+
        ...
        case "Step_3_2":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер. Приступаю к выполнению.";
            link.l1.go = "exit";
            SaveCurrentQuestDateParam("questTemp");
        ...
        break;
        case "Step_3_5":
            dialog.text = "Вы не справились с заданием. Мне придётся привлекать других, более расторопных людей к выполнению данной задачи. А сейчас я имею только потерянное время. Я очень разочарован в вас.";
        ...
        case "Step_3_6":
			...
			AddQuestUserData("Hol_Line_3_WormEnglishPlans", "sSex1", GetSexPhrase("мальчишку","девчонку"));
			...
			AddCharacterExpToSkill(pchar, "Sailing", -100);
			//слухи
			AddSimpleRumour("Ходят слухи, что капитан " + GetFullName(pchar) + " провалил"+ GetSexPhrase("","а") +" некое секретное задание Стэвезанта, связанное с большой политикой...", HOLLAND, 5, 1);
        break;
        case "Step_3_7":
			...
			//слухи
			AddSimpleRumour("Ходят слухи, что именно капитан " + GetFullName(pchar) + " сумел"+ GetSexPhrase("","а") +" узнать о планах англичан в новой войне.", HOLLAND, 5, 1);
        break;
        //********************** Квест №4, Защитить Форт Оранж ************************
        case "work_1":
            dialog.text = "Немедленно отправляйтесь к Форт Оранжу, вы должны успеть перехватить английскую экспедицию, иначе нашему поселению конец, они уничтожат город и захватят в плен всех. Отправляйтесь сию же минуту, вы должны понимать, что от вашей расторопности сейчас многое зависит.";
            if (CheckAttribute(pchar, "questTemp.GoodWormRusult"))
            {
                link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер. Приступаю немедленно.";
            }
            else
            {
                link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер, спасибо за доверие. Будте уверены - на этот раз я вас не подведу! Приступаю немедленно.";
            }
            link.l1.go = "exit";
        ...
        break;
        case "Step_4_3":
            dialog.text = "Ну что же, тем не менее, я прошу вас заглядывать ко мне время от времени. Возможно, что у меня найдётся для вас какое-нибудь дело.";
			...
			//слухи
			AddSimpleRumour("Говорят, что это не сумели защитить несчастных жителей Форт Оранжа от англичан. М-да, очень жаль...", HOLLAND, 5, 1);
        break;
        case "Step_4_4":
			...
			//слухи
			AddSimpleRumour("Говорят, что это именно вы защитили жителей Форт Оранжа от англичан. Позвольте выразить вам своё восхищение!", HOLLAND, 5, 1);
        break;
        case "Step_4_5":
            dialog.text = "Чёрт возьми! Вы сделали половину дела, и вам не хватило совсем немного до спасения несчастных жителей Форт Оранжа!";
            link.l1 = "Это так, минхер. Для сухопутной атаки у меня не осталось сил. Сожалею...";
            link.l1.go = "Step_4_6";
        break;
        case "Step_4_6":
            dialog.text = "М-да, печально. Несчастные жители Форт Оранжа\nНу что же, несмотря на провал миссии, я оценил ваше старание. Вы можете рассчитывать на то, что будете и далее получать у меня задания.";
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер. Спасибо.";
            link.l1.go = "exit";
			//--> огонь и пламень убираем
			DeleteAttribute(&locations[FindLocation("FortOrange_town")], "hidden_effects");
			DeleteAttribute(&locations[FindLocation("FortOrange_ExitTown")], "hidden_effects");
			...
			//слухи
			AddSimpleRumour("Говорят, что вы разгромили английскую эскару у Форт Оранжа, но в наземном бою англичане были сильней. Очень, очень жаль...", HOLLAND, 5, 1);
        break;
        ...
        break;
        case "Step_5_3":
            dialog.text = "Мне сложно говорить с капитаном, оказавшимся элементарн"+ GetSexPhrase("ым трусом","ой трусихой") +"! Прошу вас покинуть меня немедленно, я разочарован в крайней степени.";
        ...
        case "Step_5_4":
            ...
            if (tempQty >= 7000)
            {
                link.l1 = "Да, минхер, всё в порядке.";
                link.l1.go = "Step_5_5";
            }
            else
            {
                link.l1 = "Минхер, этого я сделать не сумел"+ GetSexPhrase("","а") +". Всего мной доставлено продовольствия " + tempQty + " центнеров";
                link.l1.go = "Step_5_8";
            }
        break;
        case "Step_5_5":
            dialog.text = "Ну что же, вы не только хороший воин, но и "+ GetSexPhrase("рачительный хозяин","рачительная хозяйка") +". Я благодарен вам за успешное проведение этой очень опасной операции. Ваша награда составляет 60000 монет, извольте получить. Доставленное продовольствие прошу сдать.";
            link.l1 = "Спасибо, минхер.";
            link.l1.go = "Step_5_6";
            tempQty = sti(pchar.Ship.Cargo.Goods.Food);
            for (i=1; i<=3; i++)
        ...
        break;
        case "Step_5_7":
            dialog.text = "Чёрт возьми, какая ужасная новость! Что же, спасибо за информацию, "+ GetSexPhrase("друг мой","госпожа") +". Мэнсфилда жаль...";
        ...
        case "Step_5_8":
            if (tempQty > 4000)
            {
                dialog.text = "Ну что же, вы хороший воин, но вы не "+ GetSexPhrase("рачительный хозяин","рачительная хозяйка") +". Тем не менее, я благодарен вам за успешную в целом операцию. Ваша награда составляет 20000 монет, извольте получить. Все продовольствие я изымаю.";
                link.l1 = "Хорошо, минхер.";
            ...
            {
                dialog.text = "Шутить изволите, "+ GetSexPhrase("мой дорогой","моя дорогая") +"? А где остальное продовольствие? Да вы, я вижу, аферист"+ GetSexPhrase("","ка") +"! Награды вам не видать.";
                link.l1 = "Нет, минхер, я честно пытал"+ GetSexPhrase("ся","ась") +" выполнить свои обязанности! Это все, что я смог привезти...";
            }
            link.l1.go = "Step_5_6";
            for (i=1; i<=3; i++)
            {
        ...
        break;
        case "Step_5_11":
            dialog.text = "Чёрт возьми, мало мне на сегодня неприятных известий! Тем не менее, спасибо за информацию. Мэнсфилда жаль...";
            link.l1 = "Да, минхер. Он был хорошим человеком. За сим разрешите откланяться.";
            link.l1.go = "exit";
            CloseQuestHeader("Hol_Line_5_ThreeFleutes");
            pchar.GenQuest.StoreGoods.HL5_QtyPriceIsBack = true;
        ...
        case "Step_6_1":
            dialog.text = "Нападение испанцев на поселение буканьеров и смерть Мэнсфилда серьёзнейшим образом повлияет на баланс сил в Карибском регионе. Я не уверен, должны ли мы что-либо предпринимать в связи с этим.\n"+
                          ...
                          "Отправляйтесь к Генри Моргану и узнайте у него, что они собираются предпринять. Если Морган решит задействовать вас в операции возмездия, то считайте моё разрешение на ваше участие полученным.";
        ...
        case "Step_6_2":
            ...
            link.l1 = "Морган поручил мне выполнить разведывательную миссию. Я выяснил"+ GetSexPhrase("","а") +", что губернатор Хименес в ближайшее время будет находиться в городе. Судьба Сантьяго предрешена.";
            link.l1.go = "Step_6_3";
        break;
        case "Step_6_3":
        ...
        break;
        case "Step_6_4":
            dialog.text = "Это верно. Ну что же, как говориться - к лучшему! Главное, что Мансвельт будет отомщён, он был хорошим человеком и достойным сыном своего отечества.";
            link.l1 = "Полностью соглас"+ GetSexPhrase("ен","на") +" с вами, минхер.";
            link.l1.go = "Step_6_5";
        break;
        case "Step_6_5":
        ...
        break;
        case "Step_7_3":
            dialog.text = "А почему неудачно? Всё в порядке, давайте её сюда.";
            tempStr = "Кхе-кхе... Дело в том, что она была похищена у меня прямо на Тортуге.";
            switch (pchar.questTemp.State.KingResult)
            {
                case "BrigNotFound":
                    tempStr = tempStr + " Я бросил"+ GetSexPhrase("ся","лась") +" вдогонку за бригом похитителей, но не смог"+ GetSexPhrase("","ла") +" вернуть депешу.";
                break;
                case "BrigSunk":
                    tempStr = tempStr + " Я бросил"+ GetSexPhrase("ся","ась") +" вдогонку за бригом похитителей и потопил"+ GetSexPhrase("","а") +" его, но депешу найти не смог"+ GetSexPhrase("","ла") +". Где она - мне неизвестно.";
                break;
                case "BrigAborded":
                    tempStr = tempStr + " Я бросил"+ GetSexPhrase("ся","ась") +" вдогонку за бригом и взял"+ GetSexPhrase("","а") +" его на абордаж. От капитана захваченного брига я узнал"+ GetSexPhrase("","а") +", что нападение на меня организовали испанцы. Но самой депеши на бриге уже не было, она попала к испанцам.";
                break;
                case "WarshipSunk":
                    tempStr = tempStr + " Я бросил"+ GetSexPhrase("ся","ась") +" вдогонку за бригом и взял"+ GetSexPhrase("","а") +" его на абордаж. От капитана захваченного брига я узнал"+ GetSexPhrase("","а") +", что нападение на меня организовали испанцы. Я настиг"+ GetSexPhrase("","ла") +" галеон, на котором они уходили в сторону Санта-Каталины, но в бою галеон был потоплен, депеша не найдена. Где она в настоящий момент - мне не известно.";
                break;
            }
            link.l1 = tempStr;
            link.l1.go = "Step_7_4";
        ...
        case "Step_7_7":
			...
			AddCharacterExpToSkill(pchar, "Cannons", -150);
			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + " был"+ GetSexPhrase("","а") +" буквально выставлен"+ GetSexPhrase("","а") +" из резиденции генерал-губернатора...", HOLLAND, 5, 1);
        break;

        case "Step_7_20":
            dialog.text = "И это более чем верно! Сейчас я прошу вас покинуть меня, у меня нет для вас никаких дел. Возможно, в будущем что-либо подвернётся, но только не сейчас.";
        ...
        case "Step_7_8":
            dialog.text = "Великолепно! Я доволен, что все так удачно разрешилось.";
            link.l1 = "Да, более чем. Вы себе даже представить не можете - испанцы напали на меня прямо на Тортуге.";
            link.l1.go = "Step_7_9";
        break;
        case "Step_7_9":
        ...
        case "Step_7_10":
            ...
            link.l1 = "Конечно, минхер. Всё в порядке, вот она!";
        ...
        case "Step_7_11":
            ...
            link.l1 = "Месье д'Ожерон обрисовал мне ситуацию, я понимаю, о чем идёт речь.";
        ...
        case "Step_7_13":
			...
			//слухи
			AddSimpleRumour("Говорят, что капитан " + GetFullName(pchar) + ", выполняя функции вестового Стэвезанта, попал"+ GetSexPhrase("","а") +" в серьёзнейшую переделку - на не"+ GetSexPhrase("го","е") +" неожиданно напали испанцы прямо в Тортуге. Но "+ GetSexPhrase("он вышел","она вышла") +" из схватки победителем.", HOLLAND, 5, 1);
        break;
        //********************** Квест №8, Поиски Евангелие для Аарона ************************
        case "Step_8_1":
            dialog.text = "Но этого оказалось недостаточно. Я поражён вашим провалом, вы не смогли выполнить простейшего задания. Ну что же, заглядывайте ко мне время от времени, возможно, я смогу подобрать для вас то, что будет вам по силам.";
            link.l1 = "Хорошо, минхер.";
            link.l1.go = "exit";
        ...
        break;
        case "Step_9_2":
            dialog.text = "Хм, верно... Итак, я прошу вас предоставить в распоряжение голландского флота не менее четырёх кораблей первого класса, то есть мановаров.";
        ...
        case "Step_9_5":
            ...
            {
                dialog.text = "Превосходно, но задача ещё не выполнена полностью, вам обеспечить наш флот ещё одним кораблём. Не теряйте время, я жду от вас хороших вестей.";
            }
        ...
        break;
        case "Step_9_7":
            dialog.text = "Потому что там идёт активное противостояние с Португалией. И именно сейчас в действиях португальцев наметился определённый успех. Полагаю, что данная эскадра восстановит паритет.";
            link.l1 = "Ну что же, смотрите сами. Но я бы не пребывал"+ GetSexPhrase("","а") +" в таком радужном настроении относительно ситуации здесь, в Карибском море.";
            link.l1.go = "Step_9_8";
        break;
        case "Step_9_8":
        ...
        case "Step_9_10":
            ...
            link.l1 = "Я просто высказал"+ GetSexPhrase("","а") +" своё мнение...";
        ...
        break;
        case "Step_11_2":
            dialog.text = "Вы знаете, что Людовик XIV ведёт деволюционную войну с Испанией за так называемое испанское наследство - Фландрию и Бургундию. Эти территории, хоть и не входят в Республику Соединённых Провинций, тем не менее этнически и культурно связаны с Голландией. Поэтому мы всячески помогаем французам в этой войне - финансово, естественно.\n"+
                          "Похоже, что Испания всерьёз решила перекрыть этот денежный ручей, которым Людовик щедро оплачивает проведение войны. Шаг, надо сказать, выверенный, так как Франция находится в очень тяжёлом финансовом положении и без наших денег Людовику просто нечем будет платить за ведение войны.\n"+
        ...
        break;
        case "Step_11_3":
            dialog.text = "Я прошу вас собрать все силы и немедленно двинуться к Сан Мартину на помощь осаждённым. Вы должны постараться успеть спасти город от уничтожения.";
        ...
        case "Step_11_7":
            ...
            link.l1 = "Я понял"+ GetSexPhrase("","а") +", минхер. Через месяц буду у вас.";
            link.l1.go = "exit";
        ...
        break;
        case "Step_11_8":
            dialog.text = "Великолепно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +", просто великолепно. Я в вас никогда не сомневался.";
            link.l1 = "Рад"+ GetSexPhrase("","а") +" слышать, минхер.";
        ...
        case "Step_12_1":
            ...
            link.l1 = "Я готов"+ GetSexPhrase("","а") +" к операции, город Маракайбо будет голландским!";
        ...
        break;
        case "Step_12_3":
            dialog.text = "Я уже отправил доклад об этом приобретении в метрополию. Наше государство, наша молодая нация жаждет побед! И мы делаем все для процветания Республики Соединённых Провинций.\n"+
        ...
        break;
        case "Step_12_4":
            dialog.text = "Вот слова "+ GetSexPhrase("великого воина и настоящего патриота","великой воительницы и настоящей патриотки") +"! А сейчас я прошу принять от меня 300000 монет в качестве платы за вашу преданную службу.";
            link.l1 = "Спасибо, минхер.";
        ...
        case "Step_F2_1":
            ...
            link.l1 = "Разумеется! Я имею честь состоять на службе короля Франции и облече"+ GetSexPhrase("н","на") +" доверием генерал-губернатора.";
        ...
        case "Step_F2_6":
            ...
            link.l1 = "На дне близ Пальмового берега. Я взял"+ GetSexPhrase("","а") +" его на абордаж и перебил"+ GetSexPhrase("","а") +" команду. Капитан перед смертью был мной допрошен, так что сомнений быть не может - этот тот самый галеон, не дававший вам покоя.";
        ...
        case "Step_F2_7":
            ...
            link.l1 = "Я это понял"+ GetSexPhrase("","а") +", месье, поэтому и предпринял"+ GetSexPhrase("","а") +" поиски. Флибустьеры не нападают на голландские суда.";
		...
		break;
		case "TizerFind_2":
			dialog.text = "Именно так! За участие в смуте он был лишён прав гражданства Нидерландов и сослан на каторгу. Однако, корабль, на котором его перевозили, был захвачен пиратами, а сам этот Тизер был продан ими в рабство...";
			link.l1 = "Чёрт возьми, какая интересная судьба!";
		...
		break;
		case "TizerFind_4":
			dialog.text = "Вы что, серьёзно об этом говорите?";
