...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            ...
                            case "4":
                                ...
                                {
                                    dialog.text = "Вы добыли важнейшую информацию. Мэдифорду сейчас не хватает сил, чтобы доставить нам серьёзные неприятности в Кюрасао, однако плохо укреплённый форт Оранж, находящийся у них под боком на Ямайке, они хотят уничтожить.";
                                    link.l1 = "Да, минхер, это мне известно.";
                                    link.l1.go = "Step_4_1";
                                }
                                else
                                {
                                    dialog.text = "Вы не сумели должным образом выполнить предыдущее задание. Вместо вас данное задание с успехом было выполнено другими храбрецами. Теперь я предоставляю вам возможность реабилитироваться. В результате полученной информации я сделал вывод, что Мэдифорду сейчас не хватает сил, чтобы доставить нам серьёзные неприятности в Кюрасао, однако плохо укреплённый форт Оранж, находящийся у них под боком на Ямайке, они хотят уничтожить.";
                                    link.l1 = "Понятно...";
                                    link.l1.go = "Step_4_1";
                                }
                            break;
                ...
                case "WormEnglPlans_GoodRusultWorm":
                    ...
                    link.l1 = "Мэдифорд готовит нападение на форт Оранж. Идёт подготовка к штурму силами гарнизона Порт Рояля. Мэдифорд пытался уговорить корсаров напасть на Кюрасао, но у него ничего с этим не вышло. Так что сил для более крупной операции, нежели штурм Форта Оранж, у Мэдифорда нет.";
                    link.l1.go = "Step_3_7";
                break;
                case "DefenceOrange_LateRiseOrange":
                    dialog.text = "Докладывайте, что с Фортом Оранж?";
                    link.l1 = "Минхер, я не смог"+ GetSexPhrase("","ла") +" прийти на помощь форту Оранж. Несчастные жители истреблены, форта Оранж как голландского поселения более не существует...";
                    link.l1.go = "Step_4_2";
                break;
                case "DefenceOrange_DieHard":
                    dialog.text = "Докладывайте, что с Фортом Оранж?";
                    link.l1 = "Минхер, я не смог"+ GetSexPhrase("","ла") +" прийти на помощь Форту Оранж. Мы дали бой, но англичане оказались сильней. Нам пришлось спасаться бегством... К сожалению, форта Оранж как голландского поселения более не существует...";
                    link.l1.go = "Step_4_2";
                break;
        ...
        case "Step_2_1":
            dialog.text = "Именно закупить. Для закупки этой партии товара Оранж даёт нам очень хорошие цены. Как только вы вручите мою верительную грамоту губернатору форта - вы получите льготные цены.\n"+
        ...
        case "Step_2_9":
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), 1);
			//слухи
			AddSimpleRumour("Вы слышали, капитан " + GetFullName(pchar) + " взял"+ GetSexPhrase("ся","ась") +" за торговую операцию - доставку продовольствия из форта Оранж. Задачу "+ GetSexPhrase("он выполнил","она выполнила") +", но в установленные сроки не уложил"+ GetSexPhrase("ся","ась") +".", HOLLAND, 5, 1);
        break;
        case "Step_2_10":
        ...
        case "Step_4_4":
			...
			//слухи
			AddSimpleRumour("Говорят, что это именно вы защитили жителей Форта Оранж от англичан. Позвольте выразить вам своё восхищение!", HOLLAND, 5, 1);
        break;
        case "Step_4_5":
            dialog.text = "Чёрт возьми! Вы сделали половину дела, и вам не хватило совсем немного до спасения несчастных жителей форта!";
