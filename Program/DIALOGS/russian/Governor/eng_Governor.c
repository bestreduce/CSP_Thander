    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
            ...
            dialog.text = LinkRandPhrase("Вы английский капер и должны держать данное мне слово! Прошу немедленно приступить к выполнению возложенного на вас поручения!",
                                         "До тех пор, пока вы не выполните моё задание, мне не о чем с вами разговаривать.",
			...
			switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    if (GetQuestPastDayParam("questTemp") < sti(pchar.questTemp.Waiting_time))
                    {
                        dialog.text = LinkRandPhrase("Пока у меня нет особых поручений для вас. Заходите ко мне время от времени.",
                                                     ...
                                                     "Ваша ловкость и отвага пока не востребованны, занимайтесь своим каперскими делами, "+ GetSexPhrase("друг мой","" + pchar.name + "") +".");
                        link.l1 = "Хорошо, сэр.";
                        link.l1.go = "exit";
                    }
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            case "2":
                                ...
                                link.l1 = "Я "+ GetSexPhrase("готов","готова") +", сэр.";
                                link.l1.go = "Step_2_1";
                            break;
                            ...
                            break;
                            case "7":
                                dialog.text = "С огромным сожалением должен вам сообщить, что распоряжение британского правительства вернуть груз, захваченный Моррисом Уильямсом испанскому владельцу, привёл к тяжёлым последствиям для Ямайки.";
                            ...
                            break;
                            case "8":
                                dialog.text = "Вы опять нужны мне, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Мне необходимо направить надёжного человека к главе поселения буканьеров Ла Вега, что на Эспаньоле. Да вы же знаете Эдварда Мэнсфилда, по моему поручению вы уже были у него. Помните?";
                                link.l1 = "Я помню, сэр. Я "+ GetSexPhrase("пытался","пыталась") +" уговорить его организовать нападение на Кюрасао.";
                                link.l1.go = "Step_8_1";
                            break;
                            case "9":
                                dialog.text = "Готовы ли вы выполнить серьёзную задачу по штурму испанского города?";
                                link.l1 = "Да, я достаточно "+ GetSexPhrase("подготовлен","подготовлена") +".";
                                link.l1.go = "Step_9_1";
                                link.l2 = "Нет, сэр. У меня недостаточно кораблей для такого серьёзного мероприятия. Я подготовлюсь как следует и вернусь позже.";
                                link.l2.go = "exit";
                            break;
                            case "10":
                                dialog.text = "Правительство Испании снарядило против ямайских корсаров эскадру из семи линейных кораблей под командованием адмиралов де Бустоса и дель Кампо-и-Эспиноса. Они уже подошли к Ямайке. Момент выбран как нельзя лучше, вы сами видели, что на рейде Порт Рояля, кроме вас, нет больше корсаров, все с Морганом в очередной охоте на испанцев. Вы должны отбить нападение. В ваше распоряжение переходят корабли охранения, это все, чем я могу вам помочь. Вперёд, и да поможет нам Господь!";
                            ...
                            break;
                            case "12":
                                dialog.text = ""+ GetSexPhrase("Друг мой","" + pchar.name + "") +", у меня для вас несколько необычное поручение...";
                ...
                case "Albermal_good_time":                  // Геймер успел доставить Альбермаля за неделю.
                    dialog.text = "В доставленном вами письме герцог Альбермаль даёт вам весьма лестную оценку. Герцог - мой родственник, именно ему я обязан назначением на эту должность. Если бы не его активные и своевременные действия в Англии, не известно, чем бы закончилось моё губернаторство на Барбадосе...\n"+
					...
					//слухи
					AddSimpleRumour("Вы слышали, капитана " + GetMainCharacterNameGen() + " наш генерал-губернатор очень хвалил. "+ GetSexPhrase("Тот, якобы, сумел","Та, якобы, сумела") +" тайно переправить с острова его лондонского дядю и покровителя - пэра Англиии, герцога Альбермаля. Вы не знаете, кто такой Альбермаль?! Скажу я вам по секрету, что только благодаря ему сэр Томас Мэдифорд исполняет обязанности губернатора Ямайки, иначе ему бы не поздоровилось...", ENGLAND, 5, 1);
                break;
                case "Albermal_late":  // Геймер не успел за неделю доставить Альбермаля.
                    dialog.text = "Что ж, в доставленном вами письме Альбермаль извещает меня о своём благополучном прибытии в Сент-Джонс. Вы отбили нападение испанского брига, но вы не смогли доставить герцога до места назначения в срок. Ваша награда составляет 20000. Я бы не сказал, что доволен вами в полной мере.";
                ...
                case "Intelligence_Curacao_Sink":  // Голландский флейт с инфой на борту был потоплен, провал миссии
                    ...
                    link.l1 = "К сожалению, мне не удалось захватить корабль, на котором я "+ GetSexPhrase("должен был","должна была") +" найти необходимые бумаги. Мне не удалось узнать ничего толкового.";
                    link.l1.go = "Step_4_1";
                break;
                ...
                case "Intelligence_Curacao_OutPrison":  // Миссия провалена, ГГ побывал в тюрьме
                    dialog.text = "Докладывайте, что вы узнали.";
                    link.l1 = ""+ GetSexPhrase("К сожалению, я был схвачен и заключён в тюрьму. Мне удалось бежать, но я ничего не узнал","К сожалению, я была схвачена и заключена в тюрьму. Мне удалось бежать, но я ничего не узнала") +".";
                    link.l1.go = "Step_4_4";
                break;
                ...
                case "AttackFortOrange_WeWin":   // Форт Оранж взят.
                    dialog.text = "Вы "+ GetSexPhrase("весь","вся") +" в крови.";
                ...
                case "MorrisWillams_ToModifordForCoolTalking": // На разборки после разговора с Уильямсом в таверне
                    ...
                    link.l1 = "Чёрт возьми! Что происходит?";
                    link.l1.go = "Step_6_3";
                break;
                ...
                case "MorrisWillams_ModifordGood5000":
                    ...
                    link.l1 = "Нет, я "+ GetSexPhrase("зашёл","зашла") +" поговорить на отвлечённые темы.";
                    link.l1.go = "exit";
                break;
                ...
                case "MorrisWillams_SeekSpanishGoods":
                    dialog.text = "Ну что, "+ GetSexPhrase("друг мой","" + pchar.name + "") +", вы уже успокоились по поводу Уильямса? Мой вам совет - оставьте это дело, бедняге не повезло. Но такова жизнь, кто-то должен быть проигравшим...";
                    link.l1 = "Сэр, я в крайней степени ценю ваш добрый совет. Постараюсь ему следовать...";
                    link.l1.go = "exit";
                break;
                case "MorrisWillams_PinnaceBoard":
                    dialog.text = "Слышал, вы взяли на абордаж испанский пинас прямо возле Сан-Хуана под огнём форта?!! Надо сказать, рискованная операция...";
                ...
                case "MorrisWillams_PinnaceSink":
                    dialog.text = "Слышал, вы потопили испанский пинас прямо возле Сан-Хуана. И зачем лезть прямо под огонь форта?";
                    link.l1 = "Так вышло, сэр...";
                    link.l1.go = "exit";
                break;
                case "MorrisWillams_DieHard":
                    dialog.text = "Начальник порта доложил мне, что вы бросились в погоню за испанским пинасом. Скажите, друг мой, удачно? (с издёвкой)";
                    link.l1 = "Нет, сэр. "+ GetSexPhrase("Старался","Старалась") +" зря...";
                    link.l1.go = "exit";
                break;
                case "SevenTreasures_GoOn":
                    dialog.text = "Вы нашли золото?";
                    link.l1 = "Нет ещё, но я беспрерывно веду поиски. Задача непроста...";
                    link.l1.go = "exit";
                ...
                case "ToMansfield_NotFoundGaleon":
                    dialog.text = "Вы привезли золото от Мэнсфилда?";
                    link.l1 = "Сэр, Ла Вега подверглась нападенияю испанцев. Мэнсфилд убит, золото похищено. Адмиралом испанской эскадры был Маноэль Риверо Пардаль. Сэр, я "+ GetSexPhrase("проверил","проверила") +" все вплоть до Сантьяго, но не "+ GetSexPhrase("встретил","встретила") +" напавших испанцев.";
                    if (CheckAttribute(npchar , "TempQuest.KnowAboutModiford"))
                    {
                        dialog.text = "Вы смогли настигнуть испанцев?";
                        link.l1 = "Нет, сэр. Мне это не удалось. Я "+ GetSexPhrase("проверил","проверила") +" все вплоть до Сантьяго, но не "+ GetSexPhrase("встретил","встретила") +" галеонов.";
                    }
                    link.l1.go = "Step_8_5";
                break;
                case "ToMansfield_Boarding":
                    dialog.text = "Вы привезли золото от Мэнсфилда?";
                    link.l1 = "Сэр, Ла Вега подверглась нападению испанцев. Мэнсфилд убит, золото похищено. Адмиралом испанской эскадры был Маноэль Риверо Пардаль. Мне удалось настигнуть один из трёх нападавших галеонов и взять его на абордаж. Золота там не было, но в каюте капитана я "+ GetSexPhrase("нашёл","нашла") +" письмо Пардаля губернатору Сантьяго Хименесу. Вот оно.";
                    if (CheckAttribute(npchar , "TempQuest.KnowAboutModiford"))
                    {
                        dialog.text = "Вы смогли настигнуть испанцев?";
                        link.l1 = "Рядом с Сантьяго я "+ GetSexPhrase("сумел","сумела") +" взять на абордаж испанский галеон, один из тех, что участвовали в нападении на буканьеров. Золота там не было, но в каюте капитана было найдено письмо от Пардаля губернатору Сантьяго Хименесу, вот оно.";
                    }
                    link.l1.go = "Step_8_5";
                ...
                case "ToMansfield_BoardingNotFoundLetter":
                    dialog.text = "Вы привезли золото от Мэнсфилда?";
                    link.l1 = "Сэр, Ла Вега подверглась нападению испанцев. Мэнсфилд убит, золото похищено. Адмиралом испанской эскадры был Маноэль Риверо Пардаль. Мне удалось настигнуть один из трёх нападавших галеонов и взять его на абордаж. Золота там не было. По-видимому, оно находилось на другом корабле. Куда ушли два других галеона, мне неизвестно.";
                    if (CheckAttribute(npchar , "TempQuest.KnowAboutModiford"))
                    {
                        dialog.text = "Вы смогли настигнуть испанцев?";
                        link.l1 = "Рядом с Сантьяго я "+ GetSexPhrase("сумел","сумела") +" взять на абордаж испанский галеон, один из тех, что участвовали в нападении на буканьеров. Золота там не было. По видимому оно находилось на другом корабле. Куда ушли два других галеона, мне неизвестно.";
                    }
                    link.l1.go = "Step_8_5";
                ...
                case "ToMansfield_GaleonSink":
                    dialog.text = "Вы привезли золото от Мэнсфилда?";
                    link.l1 = "Сэр, Ла Вега подверглась нападенияю испанцев. Мэнсфилд убит, золото похищено. Адмиралом испанской эскадры был Маноэль Риверо Пардаль. Мне удалось настигнуть один из трёх нападавших галеонов и потопить его. Куда ушли остальные два галеона мне неизвестно.";
                    if (CheckAttribute(npchar , "TempQuest.KnowAboutModiford"))
                    {
                        dialog.text = "Вы смогли настигнуть испанцев?";
                        link.l1 = "Рядом с Сантьяго я "+ GetSexPhrase("сумел","сумела") +" взять на абордаж испанский галеон, один из тех, что учавствовали в нападении на буканьеров. Мне удалось настигнуть один из трёх нападавших галеонов и потопить его. Куда ушли два других галеона, мне неизвестно.";
                    }
                    link.l1.go = "Step_8_5";
                ...
                case "AttackSantiago_GoodWork":
                    dialog.text = "Я уже знаю о ваших подвигах. Это блестящая победа, "+ GetSexPhrase("друг мой","" + pchar.name + "") +".";
                ...
                case "SpanishAttack_GoodWork":
                    dialog.text = "Чёрт возьми, вы буквально спасли всех нас! Город Порт-Рояль обязан вам жизнью!";
                    link.l1 = "Да уж, испанцы собрали силы, о наличии которых я и догадываться не "+ GetSexPhrase("мог","могла") +"...";
                    link.l1.go = "Step_10_1";
                break;
                case "OccupyMein_GoOn":
                    dialog.text = "Вы ещё не захватили ни Куманы, ни Каракаса. Все побережье Мейна до сих пор во власти испанцев...";
                    link.l1 = "Сэр, я этим занимаюсь. Задача не проста и требует серьёзной подготовки. Нападение будет совершено по мере готовности.";
                    link.l1.go = "exit";
                    if (CheckAttribute(pchar, "questTemp.Q11_Caracas"))
                    {
                        dialog.text = "Вы захватили Каракас! Это прекрасно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Но Кумана ещё не захвачена. Поторопитесь!";
                        link.l1 = "Хорошо, сэр.";
                        link.l1.go = "exit";
                    }
                    if (CheckAttribute(pchar, "questTemp.Q11_Cumana"))
                    {
                        dialog.text = "Кумана принадлежит Англии, и это ваша заслуга! Превосходно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +"! Но я жду от вас так же захвата Каракаса, который также должен быть захвачен!";
                ...
                case "ColonelLinch_ArrestModiford":
                    ...
                    link.l1 = "Сэр, в резиденции губернатора Сент-Джонса я "+ GetSexPhrase("встретил","встретила") +" полковника Томаса Линча.";
                    link.l1.go = "Step_12_2";
                break;
                case "ColonelLinch_ModifordArrested":
                    dialog.text = "Вы выполнили поставленную задачу, Мэдифорд арестован и помещён в тюрьму. Сейчас начинается всестороннее расследование его деятельности на посту генерал-губернатора Ямайки. Я очень хотел бы видеть вас у себя примерно через месяц.";
                    link.l1 = "Хорошо, сэр.";
                    link.l1.go = "exit";
                    pchar.questTemp.State = "empty";
                    SaveCurrentQuestDateParam("questTemp");
                ...
                case "EndOfQuestLine":
                    ...
                    link.l1 = "Я "+ GetSexPhrase("понял","поняла") +", сэр. Благодарю за доверие.";
                    link.l1.go = "exit";
                    bWorldAlivePause   = false; // Конец линейки
                break;
             }
		...
		case "Step_1_1":
            ...
            dialog.text = "Сейчас у меня гостит мой близкий родственник, герцог Альбермаль. Его миссия здесь закончена, и я должен срочно препроводить его в Британию. На острове Антигуа, в Сент-Джонсе, герцога ждёт фрегат королевских военно-морских сил. Доставьте герцога в Сент-Джонс, в резиденцию к губернатору.\n"+
                          "Немедленно отправляйтесь и будьте осторожны, в Порт Рояле отловили уже двоих испанских шпионов и я абсолютно уверен, что в городе ещё остались агенты. Я должен исходить из того, что о присутствии здесь столь высокопоставленной английской персоны испанцы знают. Кроме того, мне докладывают о странной активности испанских военных судов вокруг Ямайки.";
            link.l1 = "Хм, действительно, лучше рассчитывать на худшее.";
            link.l1.go = "Step_1_2";
        break;

        case "Step_1_2":
            dialog.text = "Именно в данный момент мне нужен капитан с не привлекающим внимание судном. Мой расчёт основан на внезапности. Вас никто не знает, ваш парусник также не известен. У вас меньше всего риска благополучно доставить герцога Альбермаля к Антигуа.";
        ...
        case "Step_1_3":
            ...
            link.l1 = "Я "+ GetSexPhrase("понял","поняла") +" вас, сэр.";
            link.l1.go = "exit";
            SaveCurrentQuestDateParam("questTemp");
        ...
        case "Step_1_4":
            ...
            link.l1 = "Вы правы, сэр. Вы можете твердо рассчитывать на то, что я буду более "+ GetSexPhrase("исполнителен","исполнительна") +".";
            link.l1.go = "exit";
			...
			//слухи
			AddSimpleRumour("Вы знаете, капитан " + GetFullName(pchar) + " "+ GetSexPhrase("сумел","сумела") +" выполнить очень опасное задание Мэдифорда. "+ GetSexPhrase("Ему","Ей") +" нужно было доставить в безопасное место его герцога Альбермаля... Вы не знаете, кто такой Альбермаль?! Скажу я вам по секрету, что только благодаря ему сэр Томас Мэдифорд исполняет обязанности губернатора Ямайки... Только капитан со сроками "+ GetSexPhrase("подвёл","подвела") +".", ENGLAND, 5, 1);
        break;
        ...
        case "Step_2_21":
            ...
            link.l1 = "Я "+ GetSexPhrase("понял","поняла") +", сэр. Спасибо за предупреждение. Полагаю, разберусь, что к чему.";
            link.l1.go = "exit";
            SaveCurrentQuestDateParam("questTemp");
        ...
        case "Step_2_4":
            ...
            {
                dialog.text = "Хм, понятно. Что ж, несмотря на отрицательный результат миссии, я доволен вашей расторопностью и исполнительностью. Вам полагается 15000 вознаграждения. Надеюсь, впредь я могу пользоваться вашими услугами?";
                link.l1 = "Конечно, сэр. Буду "+ GetSexPhrase("рад","рада") +" помочь вам.";
            ...
            link.l1.go = "exit";
			//слухи
			AddSimpleRumour("Вы знаете, капитан " + GetFullName(pchar) + " "+ GetSexPhrase("поработал","поработала") +" на побегушках у Мэдифорда - "+ GetSexPhrase("мотался","моталась") +" по всему Карибскому морю из конца в конец, даже к Моргану "+ GetSexPhrase("наведывался","наведывалась") +"...", ENGLAND, 5, 1);
        ...
        case "Step_4_1":
            dialog.text = "Это очень плохо, я в вас разочарован. Вы можете появиться здесь позже, когда мне удастся всё-таки получить нужную информацию.";
            link.l1 = "Конечно, сэр. Извините, что не "+ GetSexPhrase("смог","смогла") +" помочь вам.";
            link.l1.go = "exit";
        ...
        case "Step_4_2":
            dialog.text = "Вы сумели раздобыть сам документ?! Прекрасно, я в вас не ошибся.\n"+
                          "Однако, голландцы узнали о наших планах... Я прошу вас появиться у меня несколько позже, я должен подумать. За отлично выполненное задание вам полагается вознаграждение в размере 100000.";
        ...
        case "Step_4_3":
            dialog.text = "Ну что ж, пусть вам выдадут 110000, я распоряжусь. Теперь оставьте меня на время. Прошу вас заглянуть ко мне через пару дней.";
        ...
        case "Step_4_4":
            dialog.text = "То, что вы побывали в голландской тюрьме, меня волнует мало. Мне нужна информация, а у вас её нет. Я разочарован. Вы можете появиться здесь позже, когда мне удастся всё-таки получить нужную информацию.";
            link.l1 = "Конечно, сэр. Извините, что не "+ GetSexPhrase("смог","смогла") +" помочь вам.";
            link.l1.go = "exit";
            CloseQuestHeader("Eng_Line_4_Intelligence_Curacao");
            pchar.questTemp.State = "empty";
        ...
        case "Step_4_5":
            dialog.text = "Вы показали с хорошей стороны себя как воин, но там где требуется хитрость, вы справиться не смогли.\n"+
                          "Мне нужно будет добывать нужную мне информацию через других людей и когда я добуду её, возможно, вы будете мне нужны.";
            link.l1 = "Понятно, сэр. Извините, что не "+ GetSexPhrase("смог","смогла") +" помочь вам.";
            link.l1.go = "exit";
            CloseQuestHeader("Eng_Line_4_Intelligence_Curacao");
            pchar.questTemp.State = "empty";
            pchar.questTemp.CurQuestNumber = "5";
        ...
        case "Step_5_2":
            dialog.text = "Да-а-а, хотел бы я видеть форт сразу после вашей работы... Один ваш вид чего стоит - просто демон во плоти!\n"+
                          ...
                          "Надеюсь видеть вас у себя чаще, "+ GetSexPhrase("мой друг","" + pchar.name + "") +".";
        ...
        case "Step_5_3":
            dialog.text = ""+ GetSexPhrase("Что ж, понимаю... По всему видать, где-то стонет девица в предвкушении вашего появления... Ха-ха","Что ж, понимаю") +".\n"+
                          ""+ GetSexPhrase("Друг мой, я искренне желаю вам провести время хорошо, с такой же полезной нагрузкой, так сказать... Талантливый человек талантлив во всем","" + pchar.name + ", я искренне желаю вам хорошо провести время") +".\n"+
        ...
        case "Step_6_1":
            dialog.text = "Что ж, это хорошо. Так вот, он идёт после удачного похода на испанцев, в его трюме груз красного дерева, серебра и индиго.\n"+
                          "Ему нужно продать трофеи, пусть заходит для этих целей в Порт Рояль. Передайте ему лично моё разрешение на продажу приза в английской колонии.\n"+
        ...
        case "Step_6_3":
            ...
            link.l1 = "Вы конфисковали груз капера Морриса Уильямса! А его "+ GetSexPhrase("пригласил","пригласила") +" в Порт Рояль я!";
            link.l1.go = "Step_6_4";
        break;

        case "Step_6_4":
            dialog.text = "Не Вы, а я пригласил его в Порт Рояль. Вы выполняли роль вестового, не более. Что касается груза, то он возвращён испанскому собственнику.";
        ...
        case "Step_6_5":
            dialog.text = "Отношения между Англией и Испанией налаживаются. Это жест доброй воли.\n"+
                          ""+ GetSexPhrase("Друг мой","" + pchar.name + "") +", не лезьте в политику, вы ничего не сможете изменить. До свидания.";
        ...
        case "Step_6_6":
            dialog.text = "Что стряслось, "+ GetSexPhrase("друг мой","" + pchar.name + "") +"?";
            link.l1 = "Моррис Уильямс томится в тюрьме, причём по моей вине. Я считаю крайне необходимым освободить его.";
            link.l1.go = "Step_6_7";
        break;
        ...
        case "Step_7_2":
			...
			//слухи
			AddSimpleRumour("Вы знаете, капитан " + GetFullName(pchar) + " "+ GetSexPhrase("отказался","отказалась") +" выполнять поручение Мэдифорда по поиску пиратских заначек...", ENGLAND, 5, 1);
        break;
        ...
        case "Step_7_4":
            ...
            link.l1 = "Итак, сэр, сейчас у меня золота " + pchar.items.jewelry5 + " слитков. Я "+ GetSexPhrase("готов","готова") +" сдать его вам.";
            link.l1.go = "Step_7_5";
            link.l2 = "Сэр, у меня с собой " + pchar.items.jewelry5 + " слитков золота. Но это золото я "+ GetSexPhrase("добыл","добыла") +" не в результате поставленной вами задачи. Так что это золото я оставляю себе.";
            link.l2.go = "Step_7_7";
        break;
        ...
        case "Step_7_5":
            if ((sti(pchar.questTemp.GoldQtyGaveModiford) + sti(pchar.items.jewelry5)) <= 2100)
            {
                ...
                {
                    dialog.text = "Очень хорошо, " + pchar.items.jewelry5 + " слитков золота я принимаю у вас. Итого вы сдали " + pchar.questTemp.GoldQtyGaveModiford + " слитков золота. Соответственно, вам осталось разыскать и доставить мне ещё " + pchar.questTemp.GoldQtyForSeek + " слитков.";
                    link.l1 = "Я "+ GetSexPhrase("понял","поняла") +", сэр. Поиски будут продолжены.";
                    link.l1.go = "exit";
            ...
            else
            {
                ...
                link.l1 = "Сэр, 'перевыполнение плана' - это моё личное золото, к выполненному заданию оно не имеет никакого отношения.";
                link.l1.go = "Step_7_6";
        ...
        case "Step_7_10":
            ...
            link.l1 = "Сожалею, что "+ GetSexPhrase("доставил","доставила") +" вам неудобство, сэр.";
            link.l1.go = "exit";
        ...
        case "Step_8_1":
            ...
            link.l1 = "Хорошо, сэр. Я как-то "+ GetSexPhrase("ограничен","ограничена") +" во времени?";
            link.l1.go = "Step_8_2";
        break;

        case "Step_8_2":
            dialog.text = "Нет, торопиться особо некуда. Но и тянуть не стоит.";
            link.l1 = "Понятно. Как только я буду "+ GetSexPhrase("готов","готова") +", то сразу выйду в море.";
            link.l1.go = "exit";
        ...
        case "Step_8_3":
            dialog.text = "Чёрт побери!!! Вам как-нибудь удалось прояснить ситуацию?";
        ...
        case "Step_9_1":
            ...
            {
                dialog.text = "Я предпринял определённые действия и мне удалось совершенно точно установить, кто стоит за нападением испанцев на Ла Вегу.";
            ...
            {
                dialog.text = "Благодаря найденному вами на испанском галеоне письму, мы теперь чётко можем себе представлять, кто стоит за нападением испанцев на Ла Вегу.";
                link.l1 = "Да, сэр. Письмо я "+ GetSexPhrase("прочёл","прочла") +".";
                link.l1.go = "Step_9_2";
            }
        ...
        case "Step_9_2":
            dialog.text = "Данное нападение было организовано губернатором Сантьяго Хосе Санчо Хименесом. Для исполнения этой операции он привлёк Маноэля Риверо Пардаля, единственного испанца-пирата в этих водах.";
        ...
        case "Step_9_3":
            ...
            link.l1 = "Я "+ GetSexPhrase("понял","поняла") +", сэр.";
            link.l1.go = "exit";
        ...
        case "Step_9_4":
            dialog.text = "Чёрт возьми, вы действительно незаменимый человек, " + pchar.name + ". Мэнсфилд отомщён на славу!";
        ...
        case "Step_9_5":
            dialog.text = "Сдайте его моему дежурному офицеру. Я завтра займусь им, сегодня для этого у меня слишком хорошее настроение.\n"+
                          ...
                          "Да, и ещё... Зайдите к Моргану, я думаю, ему будет очень приятно узнать, что месть за Эдварда Мэнсфилда свершилась так скоро и эффективно. Мэнсфилд был для Моргана как отец...";
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), 1);
			//слухи
			AddSimpleRumour("Капитан, все только о том и говорят, что вы привезли в Порт Рояль пленного испанского губернатора! Вы "+ GetSexPhrase("настоящий герой","настоящая героиня") +", капитан...", ENGLAND, 5, 1);
        break;
        ...
        case "Step_10_2":
            dialog.text = "Согласен с вами, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Полагаю, что суммы в 80000 хватит, чтобы привести ваши корабли в порядок и набрать новую команду. Вы нужны Англии, "+ GetSexPhrase("друг мой","" + pchar.name + "") +", и Англия вас не забудет!\n"+
        ...
        case "Step_11_1":
            ...
            link.l1 = "Я "+ GetSexPhrase("понял","поняла") +", сэр. Приступаю по мере готовности.";
            link.l1.go = "exit";
        ...
        case "Step_11_2":
            dialog.text = "Превосходно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Просто великолепно! Захваченная на острове добыча по праву принадлежит вам!\n"+
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), 1);
			//слухи
			AddSimpleRumour("Капитан, похоже, что скоро вам дадут прозвище " + pchar.name + ""+ GetSexPhrase("-Завоеватель","-Завоевательница") +"", ENGLAND, 5, 1);
        break;
        ...
        case "Step_12_1":
            ...
            link.l1 = "Хорошо, сэр. Не думаю, что существуют какие-либо проблемы, но я всё узнаю.";
            link.l1.go = "exit";
        ...
        case "Step_12_4":
            ...
            DialogExit();
			//слухи
			AddSimpleRumour("Ну и дела у нас происходят!! Губернатор Мэдифорд арестован и помещён в тюрьму одним из своих приближенных каперов! Ну, дела!..", ENGLAND, 5, 1);
        break;
        ...
        case "Step_12_5":
            dialog.text = "Не удивляйтесь! Но давайте все по порядку.\n"+
                          ...
                          "Также, в результате проведённого расследования деятельности Мэдифорда, найдено его огромное состояние. Часть этих денег принадлежит вам, сэр. Это триста тысяч золотом. Извольте получить.";
