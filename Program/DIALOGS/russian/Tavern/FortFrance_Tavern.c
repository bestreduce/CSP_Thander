...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "PDM_PJ_1":
			dialog.text = "Так это же не проблема! Хе-хе-хе-хе! Вы пришли как раз куда надо, и говорите как раз с тем, кто вам нужен! Хотите бутылочку вина? Можете купить бочку! Лучшее вино на всём архипелаге!",
		...
		case "PDM_PJ_Rom_3":
			dialog.text = "Воистину, вы почти что гений, капитан. Вы совершенно правы, я могу это сделать... Но я надеюсь, вы понимаете что это эксклюзивные, особые услуги... бутылка вымыта и высушена вручную, сами понимаете...  я могу продать своему клиенту разлитый по бутылкам ром за... 200 монет! Хе-хе-хе!",
			link.l1 = "Ты совсем свихнулся, "+npchar.name+". 200 монет за дешёвый ром? Нет! До свидания!",
			link.l1.go = "exit";
			link.l2 = "Ну, хорошо! Ты действительно развеселил меня, прохвост. Вот твои деньги. Давай сюда ром. Ты, безусловно, заслужил своё золото.",
			link.l2.go = "PDM_PJ_Rom_4";
		break;

		case "PDM_PJ_Rom_4":
			dialog.text = "Спасибо, "+ GetSexPhrase("месье","мадмуазэль") +". Подождите всего одну минутку\n"+
							"Вот ваш разлитый в ДВЕ бутылки бочонок рома, капитан. Лично для вас я перевязал его розовыми ленточками... Ой, хе-хе-хе...",
		...
		case "PDM_PJ_Rom_5":
			...
			Log_info("Вы получили две бутылки, одна из которых теперь ВАША");
