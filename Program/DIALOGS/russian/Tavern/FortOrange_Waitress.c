...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
        ...
        case "DefenceOrange": //Голландская линейка, квест №4, защита форта Оранж.
            dialog.text = "Ох, "+ GetSexPhrase("минхер","госпожа") +", я просто счастлива, что осталась жива! И ещё я счаслива...";
            link.l2 = "А ещё от чего?";
            link.l2.go = "Step_H4_1";
        break;

        case "Step_H4_1":
			dialog.text = ""+ GetSexPhrase("И ещё я счастлива, что вижу такого великого капитана и офицера! Весь Форт вам благодарен, вы просто спасли нас!","И ещё я счастлива, что на свете есть такие отважные женщины! Весь Форт вам благодарен, вы просто спасли нас!") +"";
		...
		case "Jamaica_ratW_1":
            ...
            link.l1 = "Стоп-стоп, хватит! Я знаю о достоинствах моего товарища, можешь мне их не расписывать. Мне всё равно, что там между вами было - хоть женитесь. Мне нужно срочно его найти, понимаешь? Ты знаешь, куда он отправился?";
