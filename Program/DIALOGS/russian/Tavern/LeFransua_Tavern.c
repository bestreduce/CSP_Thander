...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (CheckAttribute(pchar, "questTemp.PKM_SvtvA_LeFrancuaTaverna_1") && pchar.questTemp.PKM_SvtvA_LeFrancuaTaverna_1 == "Taverna") //Квест "Странные вещи творятся на архипелаге"
			{
