...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "PL_Q7_2":
			dialog.text = "Ха, ну ты даёшь! Ричард таких вещей никогда не открывает, до самого последнего момента, даже для своих капитанов. А ты меня спрашиваешь...";
			link.l1 = "Ну мало ли. Спрашиваю, потому что сомневаюсь, стоит ли мне подряжаться на это дело. Как думаешь?";
			link.l1.go = "PL_Q7_3";
		break;
		case "PL_Q7_3":
			dialog.text = "Не знаю, "+ GetSexPhrase("сам","сама") +" решай. У Соукинса репутация удачливого кэпа. Но лично я бы пошёл с ним, уж больно Ричард готовится к этому тщательно - целыми днями сидит в резиденции и строчит в своём журнале чего-то...";
