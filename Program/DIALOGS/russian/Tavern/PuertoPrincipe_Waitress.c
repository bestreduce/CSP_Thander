...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Слушай, "+ GetSexPhrase("красавица","малышка") +", мне нужно знать, что затевает Соукинс. Очень надо...";
				link.l1.go = "PL_Q7_1";
			}
		...
		break;
		case "PL_Q7_3":
			dialog.text = "М-м-м, как красиво!.. Спасибо. Так что ты хотел"+ GetSexPhrase("","а") +" знать?";
