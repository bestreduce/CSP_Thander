	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            if (pchar.questTemp.State == "Sp4Detection_FoundLetter")
            {
    			...
    			link.l1 = "Послушай, "+ GetSexPhrase("красавица","малышка") +", ты не замечала в таверне ничего необычного в последнее время?";
            ...
            if (pchar.questTemp.State == "Fr3TakeAnna_WaitOneDay")
            {
				...
				{
    				dialog.text = "Сеньор"+ GetSexPhrase("","ита") +", я ещё не выполнила вашего поручения. Подождите, будте терпеливы, прошу вас...";
...
//========================== Исп. линейка, квест №4. Расследование убийства ==================================
 	 	case "Step_S4_1":
			dialog.text = "Нет, сеньор"+ GetSexPhrase("","ита") +", всё в порядке.";
        ...
        break;
 	 	case "Step_S4_3":
			dialog.text = "Бывают разные люди... Послушайте, сеньор"+ GetSexPhrase("","ита") +", мне нужно работать. Не мешайте мне, пожалуйста.";
			link.l1 = "Вынужден"+ GetSexPhrase("","а") +" помешать. Ты знаешь об убийстве в доме коменданта Гаваны дона Хосе Рамиреса де Лейва?";
        ...
        break;
 	 	case "Step_S4_5":
			dialog.text = "Хорошо, сеньор"+ GetSexPhrase("","ита") +", я всё скажу! Только пообещайте мне, что ничего плохого мне не сделаете.";
			link.l1 = "Обещаю, что если ты не убийца - я ничего тебе не сделаю.";
			link.l1.go = "Step_S4_6";
        break;
 	 	case "Step_S4_6":
			dialog.text = "Я не убийца сеньор"+ GetSexPhrase("","ита") +", конечно же нет...";
        ...
        break;
 	 	case "Step_S4_10":
			dialog.text = "Спасибо, сеньор"+ GetSexPhrase("","ита") +", да хранит вас Господь! Я очень сожалею, что так все вышло, но я ни в чём не виновата!";
			link.l1 = "Если увидишь этого француза ещё раз - немедленно вызывай стражу. Хотя, вряд ли он появится здесь ещё раз.";
			link.l1.go = "exit";
...
//========================== Фр. линейка, квест №3. Увезти донну Анну ==================================
 	 	case "Step_F3_1":
			dialog.text = "Ну что вы, право... "+ GetSexPhrase("Такому благородному кабальеро отказать ни в чём невозможно!","Такой видной женщине я помогу, конечно.") +"";
        ...
        break;
 	 	case "Step_F3_3":
			dialog.text = "Спасибо, сеньор"+ GetSexPhrase("","ита") +"! Вам придётся подождать день-другой. Я должна сдать смену и найти время для того, чтобы сходить к дому сеньоры де Лейва. Да и случай нужен подходящий - так просто к ним в дом не заявишься...";
        ...
        break;
 	 	case "Step_F3_5":
			dialog.text = "А разве сеньор"+ GetSexPhrase("","ита") +" не хочет ещё помочь бедной девушке?\n"+
        ...
        break;
 	 	case "Step_F3_7":
			dialog.text = "Ничего особенного. Приказала подождать, тут же написала записку и передала её мне.";
        ...
        break;
 	 	case "Step_F3_8":
			...
			link.l1 = "Молодец, хорошая девочка. Не бойся, возьми вот ещё денег, купи себе что-нибудь... И держи язык за зубами, красавица. Тебе понятно?";
        ...
        break;
 	 	case "Step_F3_9":
			...
			AddQuestUserData("Fra_Line_3_TakeAnna", "sSex", GetSexPhrase("ел","ла"));
