...
//******************** Квест Аскольда, узнаем о мановарах с ипанским добром ******************
		...
		case "Step_A2":
			dialog.text = "Да корабль, гружённый всяким барахлом. Сам генерал-губернатор Орегон-и-Гаскон обязал всех горожан заниматься погрузкой. Таскали всякое барахло: мозайки, кувшины, индейских божков разных - тьфу!";
		...
		case "Step_A3":
			...
			Link.l1 = "Совсем Марианна с ума сошла. А куда пошёл этот мановар?";
			Link.l1.go = "Step_A4";
		break;

		case "Step_A4":
			dialog.text = "Ты говори, да не заговаривайся, королева-мать у нас в почёте, а ты кто "+ GetSexPhrase("такой","такая") +"? И зачем тебе знать, куда пошёл мановар?";
		...
		case "Havana_ratT_1":
			dialog.text = "А-а, этот мрачный тип? Да, заходил он ко мне, останавливался. Скажу тебе по секрету: он ходил на приём к самому Орегон-и-Гаскону. Подавал ходатайство на получение патента. Но что-то там у него не выгорело, и он убрался прочь.";
		...
		case "Havana_ratT_2":
			dialog.text = "А зачем он тебе? Он чужаков боится - вечно прячется ото всех, как увидит вооружённого незнакомца - за шпагу хватается. Ходит только в сопровождении четырёх охранников. Не от тебя ли он так бережётся?";
		...
		case "Havana_ratT_4":
			dialog.text = "Ну, после того как ему дали у нас от ворот поворот, он бубнил, что к лягушатникам, своим соотечественникам, подастся. На Тортугу он отправился, к д'Ожерону... Что-то он ещё про любовницу свою бормотал, да я так и не понял толком.";
