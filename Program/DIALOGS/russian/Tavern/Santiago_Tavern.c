		...
		case "quests":
			...
			switch(pchar.questTemp.State)
            {
                ...
                case "Fr7RockBras_toSeekPlace": //Фр. линейка, квест №7. Узнать инфу о Роке Бразильце.
					link.l1 = "Я "+ GetSexPhrase("слышал","слышала") +", что известный пират, Рок Бразилец, попал в руки к Инквизиции...";
...
//**************************** Голл. линейка, квест №6. Узнать для Моргана инфу о губере Сантьяго ************************
        ...
        break;
 	 	case "Step_H6_4":
			dialog.text = "А чёрт его знает. Наверное потому, что все они были сплошь - грязные французы. Эспаньола должна быть испанской!";
        ...
        break;
 	 	case "Step_H6_8":
			dialog.text = "Что-то ты "+ GetSexPhrase("подозрителен дюже, мил человек","подозрительна дюже, дорогая сеньорита") +".\n"+
                          "Ой, сеньоры офицеры, вы очень вовремя! Задержите "+ GetSexPhrase("этого человека","эту женщину") +" до выяснения, похоже, что это шпион"+ GetSexPhrase("","ка") +"!!!";
...
//**************************** Фр. линейка, квест №7. Узнать инфу о Роке Бразильце ************************
 	 	case "Step_F7_1":
			dialog.text = NPCStringReactionRepeat("Верно, он сейчас у святых отцов.", "Вы уже спрашивали меня о Бразильце.",
