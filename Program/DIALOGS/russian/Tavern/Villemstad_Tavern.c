    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			case "Fr2Letter_SeekProblems":
				...
				link.l1 = "Я хочу понять, какого черта генерал-губернатор Стэвезант засадил за решётку официального курьера Франции. Что у вас тут, разрази дьявол, происходит?";
...
//*************************** Квест №4 английки, разведка в Кюрасао ***************************
 		...
 		case "E4_OK_pay":
            ...
            {
        		dialog.text = "Этого человека зовут Йозеф Нунен де Фонкесао. Он негоциант, прибыл сюда с теми янсенистами, которые организовали здесь довольно многочисленную общину, Йозеф и является главным её организатором и руководителем.\n"+
                         "Но если все эти янсенисты - люди как люди, то этот человек совести не имеет, он сразу стал ростовщиком в городе. Деньги даёт охотно и любые, но если не вернул ему долга день в день, то будешь сидеть в тюрьме следующим утром.\n"+
            ...
            {
        		dialog.text = "Хех, "+ GetSexPhrase("братец","сестрёнка") +", денег нет? Что ж ты мне голову морочишь? Приходи, когда будут.";
...
//*************************** Квест №2 испанки, задания Инквизиции ***************************
 		case "Step_S2_1":
    		dialog.text =  NPCStringReactionRepeat("Джоао Ильхайо - хороший человек, торгует честно, товар дешёвый, деньги под процент не ссужает. Яков Лопез де Фонсека - компаньон Джоао Ильхайо, они содержат магазин вместе. А вот Йозеф Нунен де Фонкесао - ростовщик, на его совести не одно самоубийство людей, которых он разорил.",
...
//*************************** ГПК, Мастер Ключей ***************************
		...
		break;
		case "TizerFind_4":
			dialog.text = "Жаль, хороший был человек, хоть и бродяга. Знаешь, бывают люди с обострённым чувством справделивости. Вот Тизер был из таких, да ещё жизнь его изрядно побила. Рассказы об Острове Справедливости были его любимой темой.";
		...
		break;
		case "TizerFind_7":
			dialog.text = "Т-с-с!! Тихо, "+ GetSexPhrase("приятель","подруга") +". Об этих связях нашего Петера говорить не принято. И спрашивать тоже не рекомендую - отгребёшь неприятностей по самое небалуйся!";
		...
		case "TizerFind_10":
			...
			link.l1 = "Вот дьявол! Серьёзная контора.";
		...
		//ОЗГ, Хален
		case "Halen_tavern_1":
			dialog.text = "Нет, его сейчас здесь нет. Он ушёл в плавание, но вернётся со дня на день. Можете остановиться у меня. Когда он вернётся - я вам сообщу.";
		...
		case "Halen_tavern_2_2":
			...
			link.l1 = "Успокойся. Лучше сделай так: тихонько вывези трупы через задний двор, не поднимая лишнего шума, чтобы не повредило репутации твоего заведения... Не думаю, что эта парочка из местных, так что никто ничего и не узнает. Ты видел, как они заходили? Два типа, в чёрном, лица закрыты платками.";
		...
		case "Halen_tavern_7_7":
			dialog.text = "Да, он отправился с визитом к генерал-губернатору сразу по прибытию. Думаю, если поторопитесь - застанете его у резиденции. Или найдёте его на корабле.";
