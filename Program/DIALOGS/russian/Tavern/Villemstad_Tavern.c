    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			case "Fr2Letter_SeekProblems":
				...
				link.l1 = "Я хочу понять, какого чёрта генерал-губернатор Стэвезант засадил за решётку официального курьера Франции. Что у вас тут, разрази дьявол, происходит?";
