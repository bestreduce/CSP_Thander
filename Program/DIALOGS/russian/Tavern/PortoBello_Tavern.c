...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Mushket_stid_2":
			dialog.text = "Ха-ха! Да Зиверту даже его собственная шкура не принадлежит - Джекмен поклялся, что снимет, как только его поймает. Хотя нет - 'Стрела' принадлежит ему законно - строил у Алексуса на свои деньги, по своим чертежам.\nСлушай, а не на кораблик ли его ты глаз положил"+ GetSexPhrase("","а") +", а? А то я всё думаю - что за 'дело' у тебя к нему! Только учти - Зиверт может запросто пустить тебя на дно, прежде, чем ты спустишь шлюпку. Такие уж у него манеры - сначала стреляет, потом говорит.";
		...
		case "Mushket_stid_nopay":
			dialog.text = "Не считай меня простофилей - его бриг стоит намного дороже. А свою байку про 'вещицу' будешь рассказывать гусыне на заднем дворе таверны - тебе поверит только сын панамского верфиста... Если удастся завладеть бригом - ещё благодарить меня будешь. А, если не удастся - покойникам деньги ни к чему, ха-ха-ха...";
			link.l1 = "Ладно, чёрт с тобой. Держи.";
		...
		case "Mushket_stid_nomoney":
			dialog.text = "Ну что ж - видно не судьба тебе достать 'Стрелу'. Подожду, пока моим бывшим приятелем заинтересуется кто-то посолиднее. А ждать, что ты разбогатеешь, смысла нет - он сегодня в одном месте, а завтра в другом... Так что, захочешь - найдёшь, если будешь смотреть в оба. А я тебе не помощник.";
		...
		case "Mushket_late_1":
			dialog.text = "Ну что я могу сказать... Не свезло тебе, "+ GetSexPhrase("приятель","подруга") +". Приди ты ко мне немного пораньше - я бы поделился с тобой информацией, в какой бухте можно отыскать Зиверта.\nНо теперь поздно - он ушёл оттуда, а куда - не ведаю. Так что ищи теперь сам"+ GetSexPhrase("","а") +"... по всему архипелагу. Он может быть где угодно. Хотя можешь попробовать заглянуть попозже, вдруг свезёт?";
