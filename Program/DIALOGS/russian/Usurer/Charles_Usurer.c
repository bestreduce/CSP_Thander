...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l5 = "Я приш"+ GetSexPhrase("ел","ла") +" по поручению Аззи. У вас для меня должно быть кое-что приготовлено.";
		...
		break;
		case "Step_Az_3":
			dialog.text = ""+ GetSexPhrase("Сэр","Мисс") +", советую вам не проявлять излишнего любопытства. С Аззи это - опасно для жизни. Если у вас все, то позвольте мне заняться своими делами...";
		...
		case "Step_Az_5":
			dialog.text = "К сожалению, я не знаю. Даже понятия не имею.\n"+
                     "Знаете, я взял эти пять миллионов, особо не задумываясь над последствиями. Да-да, именно пять, так как два из них предназначались мне в качестве оплаты за работу.\n"+
