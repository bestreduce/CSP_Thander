	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.id == "W_Chard")
			{
				...
				{
					Lai_SetPlayerType(pchar);
					dialog.text = "Ты ещё кто такая? Кажется я бордельных девок к себе в номер не заказывал.";
					link.l1 = "То есть ты позвал меня сюда только ради того, чтоб поглумиться? Ещё одна такая шуточка и 'бордельная девка' вспорет тебе брюхо.";
		...
		case "Chinaman_plead_2":
			dialog.Text = "Всё это время я считать, что меч навсегда утерян. Но когда мы зашли в порт, я услышать разговор двух людей. Они говорить про ростовщика-коллекционера редких артефактов из разных частей света. В разговоре как раз шла речь про 'меч с пятью кольцами'. В последний раз правда в моём мече быть девять коцец, но я всё равно уверен, что речь шла про мой. Должно быть эти варвары его испортить. Прошу вас, капитан, помогите вернуть его!";
		...
		case "chard_in_cave":
			...
			if (CheckAttribute(pchar, "WhisperWonSword"))
			{
				dialog.Text = "Ха-ха-ха! А этот клинок по мне! Гляди какой широкий. И в руках отдаёт приятной тяжестью. Загляни в сундук, может и для себя что-то интересное найдёшь.";
			}
			else
			{
				...
				PlaySound("interface\important_item.wav");
				dialog.Text = "Ха-ха-ха! А этот клинок по мне! Гляди какой широкий. И в руках отдаёт приятной тяжестью. И кстати, я же обещал, отдаю тебе твой меч-пёрышко. Не забудь заглянуть в сундук, может и для себя что-то интересное найдёшь.";
		...
		case "chard_discuss_recruitment":
			dialog.Text = "Хм... Я хожу только с теми, в удаче кого я абсолютно уверен. Ты обыграла меня в карты, но я в них не так силён, как в костях. Давай проверим. Если удача на самом деле тебя любит, то ты выиграешь, а я пойду за тобой хоть на край света. Правила те же, до пяти побед.";
		...
		case "chard_discuss_esteban_1":
			dialog.Text = "Сам не знаю, мне показалась просто красивой безделушкой. Я её продал на следующий же день какому-то типу в капюшоне, что вдруг ко мне заявился.";
			Link.l1 = "Как выглядела эта безделушка?";
			Link.l1.go = "chard_discuss_esteban_2";
		break;
		case "chard_discuss_esteban_2":
			dialog.Text = "Металлическая пластина, на которую прикрепили кучу стеклянных трубок и рычажков. А ещё она была покрыта странными надписями и прочей мишурой.";
			Link.l1 = "Проклятье, это же моя машина времени!";
			Link.l1.go = "chard_discuss_esteban_3";
		break;
		case "chard_discuss_esteban_3":
			dialog.Text = "Чего?";
			Link.l1 = "Ничего. Куда ушёл этот твой покупатель?";
			Link.l1.go = "chard_discuss_esteban_4";
		break;
		case "chard_discuss_esteban_4":
			dialog.Text = "Понятия не имею, после нашей сделки я сам хотел его отыскать и показать ещё парочку предметов на продажу, но не смог. Он словно испарился. Ни трактирщик, ни портовый начальник его не видели. Я почти было поверил, что сам его никогда не видел, если бы не тяжесть в моём кошельке. Возможно, он заплатил этим людям кругленькую сумму за молчание.";
			Link.l1 = "Ясно, опять тупик, но, по крайней мене, у меня появилась надежда. Спасибо за информацию.";
			Link.l1.go = "exit";
		break;
		case "chard_discuss_esteban_old":
			dialog.Text = "У тебя с ним были свои счёты, я не могу за это осуждать. Да и на Карибах люди убивают друг друга каждый день, мне такое уже стало безразлично. А вот потерять крупного должника - всегда обидно. Но спрашивать с тебя за него я не буду.";
			Link.l1 = "Ясно.";
			Link.l1.go = "exit";
		break;
		case "chard_discuss_quest":
			dialog.Text = "Однажды я побывал на Бермудах. Там, в подземелье, я нашёл чей-то клад, полный всяких драгоценностей, а также библию. Её я поначалу отложил и не обращал внимания, но когда пропил свою долю клада, решил из любопытства полистать. Помимо того, что она вся была написана на латыни или каком-то другом странном языке, в ней не было ничего примечательного. За исключением нескольких подчёркнутых фраз, разбросанных по всей книге. Как я потом понял, это был шифр. Мне с командой понадобилось несколько дней, чтоб его разгадать\nВ этом скрытом послании говорилось о кладе куда больших размеров, собраном усилиями группы корсаров, даже прилагались координаты его местонахождения. Вот только не полные, часть страниц испортилась. Для получения точного места мне не хватает одного числа. Также в книге говорилось о некоем Ральфе Портмане, то ли это товарищ того, кто оставил библию, то ли сам владелец. Возможно это слабая зацепка, да и людей с таким именем на Карибах может быть много, но я всё же копнул глубже и узнал, что есть такой капер на службе у англичан. ";
			Link.l1 = "Ты очень много уже рассказал, но так и не перешёл к сути. Я тебе зачем?";
		...
		case "chard_discuss_quest_2":
			dialog.Text = "Видишь ли, в моём владении находится лишь скромный бриг, а у Портмана - несколько фрегатов. Боюсь, если дело дойдёт до боя, от моей лоханки только мокрое место останется. Но твой 'Пёс' без проблем их одолеет.";
		...
		case "chard_discuss_quest_4":
			dialog.Text = "Ну как же, мастер-корабел, лучший во всем архипелаге. У него на Бермудах своя верфь есть. Можешь показать ему свой корабль. Хоть 'Пёс' и хорош, я уверен, Алексус найдёт способы, как его можно улучшить. Тогда ты без проблем расправишься с любой эскадрой.";
			Link.l2 = "Ладно, я подумаю. Где вообще искать этого англичанина?";
			Link.l2.go = "chard_discuss_quest_5";
		break;
		...
		break;
		case "Jim_EndLine":
			dialog.text = "Да прямо здесь, в бухте. Подходи к берегу и залезай в шлюпку\nИ ещё. Дело, которое затевал Билл наверняка не совсем законное. Советую переодеться во что-нибудь неприметное, прежде чем за него браться. У нас на корабле полно всякого тряпья, можешь подобрать себе что-нибудь.";
		...
		case "IncqGuard_bad_wheel":
			...
			dialog.text = "Вот и наша красавица\nЕсли я правильно помню инструкцию, тебя следует сначала привязать к колесу, после чего, медленными движениями вращать рычаг. Шипы внизу безнадёжно искалечат и изуродуют твоё тело. Вряд ли после такого ты вообще сможешь ходить без чужой помощи\nТак... Ну и куда же подевалась верёвка?";
			link.l1 = "Прости, но я вынуждена отказаться от твоего предложения. Способность ходить мне ещё понадобится, когда я буду искать отсюда выход. (Пока он замешкался, ты резким движением выхватываешь его пистолет из кобуры)";
		...
		break;
		case "IncqGuard":
			dialog.text = "Я слыхал, что в местной таверне о тебе говорят. Якобы ты в одиночку смогла уделать толпу матросов. Это правда?";
			link.l1 = "С моим-то современным оружием, это было несложно. А ты чего на меня так уставился?";
			link.l1.go = "IncqGuard_1";
		break;
		case "IncqGuard_1":
			dialog.text = "Никогда в жизни не видел таких красивых девушек, да ещё с фиолетовыми волосами... Ты... Ты ведьма?";
			link.l1 = "Хочешь, и тебя заколдую?";
			link.l1.go = "IncqGuard_2";
		break;
		case "IncqGuard_2":
			dialog.text = "Помилуй меня Господь! Я вовсе не...";
			link.l1 = "...Абуда, кабуда, авара кадава!";
			link.l1.go = "IncqGuard_3";
		break;
		case "IncqGuard_3":
			dialog.text = "А ну немедленно замолчи, а не то тебя сейчас!";
			link.l1 = "Кумпрана, вокамос, превратись в лягушку, БДЫЫЩ!";
		...
		case "OrderHunterMeeting_1":
            ...
            Link.l1 = "Ожидаемый ответ. Раз уж ты всё ещё здесь, думаю тебе не терпится отправиться на небеса.";
			Link.l1.go = "OrderHunterBattle";
		break;
		...
		case "OrderLeader_4":
			dialog.text = "А, ты заметила. Я нашёл это оружие среди документов в кабинете де Соузы, когда занял его пост. Говоришь, эта вещь твоя? Должен признаться, я в восхищении от этого механизма, грешники толпами падают от каждого выстрела. Думаю, ты и сама это знаешь. А скоро даже испытаешь на себе.";
		...
		case "CapitolCaptured_1":
			dialog.text = "Ну как же, я оборонял тылы, на случай, если нас попытаются окружить. Не сердитесь, капитан\nВот что, я знаю, как вас обрадовать! Пока я, кхм... оборонял другие помещения, я успел немного их осмотреть. Здесь целый склад вооружения разных видов, тонны припасов, а самое интересное - я нашёл библиотеку, наполненную книгами на военную тематику. Похоже, инквизиция собиралась обучить здесь собственную армию.";
		...
		case "BS_3_WhisperIsHere":
			dialog.text = "'Держи друзей близко, а врагов - ещё ближе.' Мне нравится эта Гатри!";
			Link.l1.go = "WhisperIsHere_exit";
		break;
		...
		case "BS_6_WhisperIsHere_3":
			dialog.text = "Только не спеши, у меня голова всё ещё кружится.";
			Link.l1.go = "WhisperIsHere_exit";
		break;
		...
		case "BS_13_WhisperIsHere_1":
			...
			Link.l1 = "Разве это так уж дорого? Садись пассажиром на любой попутный корабль, и вперёд!";
