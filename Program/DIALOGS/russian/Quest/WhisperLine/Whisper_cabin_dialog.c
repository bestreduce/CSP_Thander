void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Portman_Cabin_1":
			dialog.Text = "А... Я всё того вора, что обчистил мой схрон на Бермудах. У тебя ещё хватило наглости заявляться прямо ко мне? Ничего ты от меня не узнаешь!";
		...
		break;
		case "Portman_ally_1":
			dialog.Text = "Никогда не слышал такого имени. Ну и неважно. Если это правда он, наверняка у него моя библия. Убей этого Чарда и принеси её.";
		...
		case "Portman_ally_2":
			...
			dialog.Text = "С этим не обижу, поверь мне. Ну всё, ступай. Когда сделаешь дело, думаю сможешь без проблем меня найти, раз уже сделала это однажды.";
		...
		case "DeSouza_6":
			...
			Link.l1 = "Я удовлетворила твоё любопытство. Твой черёд.";
