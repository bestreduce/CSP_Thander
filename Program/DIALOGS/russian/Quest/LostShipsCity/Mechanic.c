...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FT_24":
			dialog.text = "Дело в том, что у меня есть корабль на плаву. Пару лет назад к Городу прибило штормом судно невиданной конструкции, на рынде есть занятная маркировка: 'Балтиморские верфи', но это нелепица, Балтимор просто захудалая деревенька на берегу! Откуда там верфи? Конструкция и технические характеристики корабля просто невероятны! Из обрывков судового журнала узнал, что это клипер 'Ариэль', порт приписки Бостон. Был я там, шумный торговый порт и таких судов я там не видел. Была пара незначительных пробоин и поломан такелаж, ничего серьёзного. Удалось довольно быстро его подлатать. Пока у меня была такая возможность...";
		...
		break;
		case "FT_26":
			dialog.text = "Сначала вы должны купить у меня клипер. Затем достать со дна кое-что, без чего мы не сможем освободить судно от стискивающих его кораблей.";
		...
		break;
		case "FT_27":
			dialog.text = "Ну, я же не знаю точно, когда случится катастрофа. К тому же, я вижу, что вы "+ GetSexPhrase("человек смелый и деятельный","девушка смелая и деятельная") +", и вам вполне по силам будет выполнить мои условия. Тем более, что я много не прошу, всего лишь полтора миллиона за клипер и возможность один раз спуститься под воду.";
		...
		case "OffM_GiveMoney_1":
			...
			{
				dialog.text = "Ну что же, дело сделано. Я получил требуемую сумму, теперь клипер ваш.";
		...
		break;
		case "FreeCorvett_1":
			dialog.text = "Я уже все подготовил. У меня на платформе стоит лебёдка, к ней я прикрепил обломки вокруг клипера. Так что стоит только привести механизм в действие - и вуаля, корабль свободен!";
		...
		break;
		case "endImmersion_1":
			dialog.text = "Теперь, когда у меня есть все необходимое, я займусь восстановлением механизма лебёдки, которая освободит ваш клипер. Это займёт у меня определённое время. Вам же пока не следует почивать на лаврах, а стоит провести ряд важных подготовительных мероприятий.";
		...
		case "takeGoods":
			NextDiag.TempNode = "takeGoods";
			dialog.text = "Приветствую. Ну, как дела с заполнением трюма клипера?";
		...
		//Набор команды
		case "TakeCrew":
			dialog.text = "Прекрасно, "+ GetSexPhrase("друг мой","дорогая моя") +", все уже размещено в трюме вашего клипера. Теперь вам нужно набрать команду из жителей Города. Сами понимаете, вдвоём мы с кораблём не управимся.";
		...
		case "TakeCrew_4":
			...
			link.l1 = "Хорошо, я так и сделаю. Кстати, вы сумели освободить клипер?";
		...
		break;
		case "inPrison_4":
			dialog.text = "Нет, это вряд ли. Да и не стоит рисковать клипером и жизнями стольких людей, что уже находятся на нем. Слушайте, что вам нужно сделать...";
		...
		break;
		case "inPrison_6":
			dialog.text = "Да, я так решил. А теперь слушайте, что вы должны сделать, чтобы попасть на свой клипер.";
			link.l1 = "Я слушаю.";
			link.l1.go = "inPrison_7";
		break;
		case "inPrison_7":
			dialog.text = "Отправляйтесь ко второй мачте 'Фернадо Диффиндура', оттуда до корабля уже рукой подать. Я успел использовать лебёдку до ареста и растащил корабли, окружающие клипер. Теперь вы с лёгкостью оторвётесь от Города.\nШторм набирает силу, боюсь, что сейчас вам придётся нелегко... При выходе из 'Тартаруса', вы должны чётко представлять себе, куда направиться - направо отсюда. Иначе в этом хаосе вы погибнете. Я ещё раз повторю, что вы должны двигаться по направлению ко второй мачте 'Фернандо Диффиндура'.";
