...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "Man_FackYou":
			dialog.text = LinkRandPhrase("Да ты вор"+ GetSexPhrase("","овка") +"!!! Нарушение Закона Города!", "Вот это да! Чуть я загляделся, а ты сразу в сундук с головой! Он"+ GetSexPhrase("","а") +" нарушил"+ GetSexPhrase("","а") +" Закон!", "Милиция! Грабят!!! Держи "+ GetSexPhrase("его, он нарушил","её, она нарушила") +" Закон!");
		...
		case "LSCNotBlade":
			dialog.text = LinkRandPhrase("Слушай, ты бы убрал"+ GetSexPhrase("","а") +" оружие. А то нервируешь немного...", "Знаешь, у нас тут не принято сабелькой размахивать. Убери оружие.", "Слушай, что ты, как три мушкетёра, бегаешь тут, шпагой машешь? Убери оружие, не к лицу это "+ GetSexPhrase("серьёзному мужчине","девушке") +"...");
		...
		break;
		case "FT_3":
			dialog.text = "Все-таки, я бы послушал. Понимаете, я долгое время был лишён общения с нормальными людьми. 'Касперы' - и те со мной старались не общаться. Кстати, о клане 'Каспер'. Вы что, их всех уложили?";
			link.l1 = "Всех до единого. А до этого я пустил"+ GetSexPhrase("","а") +" под нож ещё и клан 'Нарвал'.";
			link.l1.go = "FT_4";
		break;
		case "FT_4":
			dialog.text = "Хе-хе, так Город теперь лишён разбойников? Н-да, снимаю шляпу, как говорится\nНу, а теперь расскажите мне, пожалуйста, ради чего вы совершали эти впечатляющие подвиги.";
		...
		break;
		case "FT_9":
			dialog.text = "Ясно. Значит, Тизер всё-таки сдержал данное мне обещание до конца, даже несмотря на угрозу своей жизни. Чёрт возьми, как жаль, что он погиб!";
			link.l1 = "Жаль, конечно. Вы знаете, столько хороших людей умерло за последнее время, что я уже устал"+ GetSexPhrase("","а") +" жалеть...";
			link.l1.go = "FT_10";
		break;
		case "FT_10":
			dialog.text = "Ну, не будем о грустном. Вы знаете, эта ваша Голландская компания права насчёт ценностей Города. Тут чего только нет. А ещё больше - под водой...";
			link.l1 = "Серьёзно? А откуда вы знаете?";
			link.l1.go = "FT_11";
		break;
		case "FT_11":
		...
		break;
		case "FT_14":
			dialog.text = "Хм, 'касперы' действовали в связке с Каппером, поэтому вынужден с вами согласиться... Ну что же, благодаря вам жизнь в Городе серьёзно изменилась...";
			link.l1 = "Верно! И теперь я предлагаю провести выборы адмирала. Хочу выставить свою кандидатуру на эту должность.";
			link.l1.go = "FT_15";
		break;
		case "FT_15":
			dialog.text = "Какие выборы, "+ GetSexPhrase("друг мой","девушка") +"! Нужно спасать свои жизни, пока ещё не поздно...";
		...
		break;
		case "FT_20":
			dialog.text = "Я спускался под воду, изучал рифы. Так вот, Город держится всего на трёх кораблях, которые зацепились за рифы. Остальные корабли попросту сцеплены с этими тремя! Понимаете, что это значит?";
			link.l1 = "М-да, неприятно это осознавать... А что будет, если Город оторвётся? Мы ляжем в дрейф?";
			link.l1.go = "FT_21";
		break;
		case "FT_21":
			dialog.text = "Ничего подобного! Всё пойдёт ко дну, ведь корабли Города не на плаву. Не выживет никто, так как разрушение Города будет происходить в шторм, причём очень сильный шторм.";
			link.l1 = "Апокалипсис какой-то... И когда это произойдёт?";
			link.l1.go = "FT_22";
		break;
		case "FT_22":
			dialog.text = "Не знаю. Я учёный, а не медиум\nА вообще, это может произойти в любую бурю.";
		...
		break;
		case "FT_24":
			dialog.text = "Дело в том, что у меня есть корабль на плаву. Пару лет назад к Городу прибило штормом судно невиданной конструкции, на рынде есть занятная маркировка: 'Балтиморские верфи', но это нелепица, Балтимор просто захудалая деревенька на берегу! Откуда там верфи? Конструкция и технические характеристики корабля просто невероятны! Из обрывков судового журнала узнал, что это клиппер 'Ариэль', порт приписки Бостон. Был я там, шумный торговый порт и таких судов я там не видел. Была пара незначительных пробоин и поломан такелаж, ничего серьёзного. Удалось довольно быстро его подлатать. Пока у меня была такая возможность...";
			link.l1 = "Тут, в Новом Свете много странного происходит. Нежить, древние индейские боги, пришельцы из других времён... Возможно это один из них. Вы уже несколько раз упоминаете о какой-то утерянной возможности...";
			link.l1.go = "FT_25";
		break;
		case "FT_25":
			dialog.text = "А-а, ну это возможность спускаться под воду в моём костюме. Дело в том, что под водой завелись здоровенные твари, которые ходят по дну и жрут все, что попало. Вот я и не рискую теперь спускаться. Я ведь учёный, а не боец...";
			link.l1 = "Понятно. Так что я долж"+ GetSexPhrase("ен","на") +" сделать?";
			link.l1.go = "FT_26";
		break;
		case "FT_26":
			dialog.text = "Сначала вы должны купить у меня клиппер. Затем достать со дна кое-что, без чего мы не сможем освободить судно от стискивающих его кораблей.";
		...
		break;
		case "FT_27":
			dialog.text = "Ну, я же не знаю точно, когда случится катастрофа. К тому же, я вижу, что вы "+ GetSexPhrase("человек смелый и деятельный","девушка смелая и деятельная") +", и вам вполне по силам будет выполнить мои условия. Тем более, что я много не прошу, всего лишь полтора миллиона за клиппер и возможность один раз спуститься под воду.";
		...
		break;
		case "FT_29":
			dialog.text = "Ну, деньги здесь не проблема, "+ GetSexPhrase("друг мой","" + pchar.name + "") +". Ищите, и, полагаю, без труда отыщете нужную мне сумму, так как Город буквально напичкан ценностями. К тому же, можно занять у Августо Брамса, он охотно даёт в долг до миллиона монет.";
			link.l1 = "Хех, про него ходят всякие слухи нехорошие... Говорят, что он чернокнижник.";
			link.l1.go = "FT_30";
		break;
		case "FT_30":
			dialog.text = "Ну вот, и вы туда же. Послушайте, я учёный, мракобесие мне чуждо... Да и вообще, я дам вам возможность спуститься по воду, а там денег ещё больше!";
		...
		break;
		case "FT_31":
			dialog.text = "Ну, вот и отлично! Жду вас с деньгами, "+ GetSexPhrase("друг мой","леди") +", и это только первый вопрос. Сейчас вам нужно явиться к Чаду Капперу, рассказать ему, что я освободился, так сказать... Только никаких выборов! Иначе он убьёт вас.";
		...
		break;
		case "FT_33":
			dialog.text = "Но он же всё равно узнает, если ещё не узнал. Потому, хорошо бы было уведомить его от лица виновника торжества, так сказать. С Чадом нужно вести себя очень аккуратно, иначе...";
			link.l1 = "Что иначе?";
			link.l1.go = "FT_34";
		break;
		case "FT_34":
		...
		case "FT_35":
			...
			link.l1 = "Понятно... Ну что же, я всё понял"+ GetSexPhrase("","а") +". Пош"+ GetSexPhrase("ел","ла") +" заниматься делами.";
			link.l1.go = "exit";
		...
		case "OffM_GiveMoney_1":
			...
			{
				dialog.text = "Ну что же, отлично! Сейчас вы отдали мне " + FindRussianMoneyString(iTemp) + ", всего вы принесли мне " + FindRussianMoneyString(sti(Npchar.quest.money)) + ". Вам осталось раздобыть ещё " + FindRussianMoneyString(1500000 - sti(Npchar.quest.money)) + ".";
			...
			{
				dialog.text = "Ну что же, дело сделано. Я получил требуемую сумму, теперь клиппер ваш.";
		...
		//освобождние корвета
		case "FreeCorvett":
			dialog.text = "Теперь корабль нужно освободить. Дело в том, что он находится на внешнем кольце корабельного хлама острова и стиснут обломками со всех сторон.";
			link.l1 = "Ну и как это сделать?";
			link.l1.go = "FreeCorvett_1";
		break;
		case "FreeCorvett_1":
			dialog.text = "Я уже все подготовил. У меня на платформе стоит лебёдка, к ней я прикрепил обломки вокруг клиппера. Так что стоит только привести механизм в действие - и вуаля, корабль свободен!";
			link.l1 = "Звучит прекрасно. А в чём подвох?";
			link.l1.go = "FreeCorvett_2";
		break;
		case "FreeCorvett_2":
			dialog.text = "Да, подвох действительно имеется. Я уронил шестерёнку от механизма лебёдки в воду. Эту шестерёнку нужно достать со дна.";
		...
		break;
		case "FreeCorvett_6":
			dialog.text = "Итак, давайте я расскажу, как пользоваться костюмом. Костюм заправляется сжатым воздухом, которым вы и дышите. Воздуха хватает на 6 минут беспрерывного дыхания под водой. За это время вы должны успеть всплыть на поверхность. Если этого не произойдёт - вам конец. Все понятно?";
		...
		case "FreeCorvett_7":
			...
			AddSimpleRumourCityTip("А я не верю, что этот Механик так важен для Города. Сколько жили без него, проживём и ещё...", "LostShipsCity", 10, 1, "LSC", "");
		...
		case "takeArmor":
			...
			{
				link.l1 = "Мне нужно ещё раз спуститься на дно. Не успел"+ GetSexPhrase("","а") +" сделать там все, что хотел"+ GetSexPhrase("","а") +".";
				link.l1.go = "DeepAgain";
				if (CheckCharacterItem(pchar, "Pinion"))
				{
					link.l2 = "Я наш"+ GetSexPhrase("ел","ла") +" шестерёнку, вот она!";
		...
		case "DeepAgain":
			...
			link.l1 = "Опять деньги нужны? Я же прин"+ GetSexPhrase("ёс","есла") +" вам полтора миллиона!";
			link.l1.go = "DeepAgain_1";
		break;
		case "DeepAgain_1":
			dialog.text = "Эти деньги - плата за корабль и за одно погружение. Я не обещал вам продать костюм, он остаётся у меня. Я сдаю его вам в аренду. Амортизация и все дела...";
		...
		case "takeArmor2":
			...
			{
				link.l1 = "Я хочу ещё раз спуститься на дно.";
		...
		case "DeepAgain2":
			...
			{
				link.l1 = "Нет ещё... Но я их раздобуду обязательно.";
				link.l1.go = "exit";
			}
		break;
		case "DeepAgain2_1":
		...
		case "FoundPinion":
			dialog.text = "Великолепно! Давайте её быстрей...";
			link.l1 = "Да, конечно.";
			link.l1.go = "FoundPinion_1";
		break;
		case "FoundPinion_1":
			dialog.text = "Ну что же, теперь я могу заняться восстановлением механизма лебёдки. Скажите, вы ещё будете совершать погружения?";
		...
		break;
		case "endImmersion_1":
			dialog.text = "Теперь, когда у меня есть все необходимое, я займусь восстановлением механизма лебёдки, которая освободит ваш клиппер. Это займёт у меня определённое время. Вам же пока не следует почивать на лаврах, а стоит провести ряд важных подготовительных мероприятий.";
			link.l1 = "Что вы имеете в виду?";
			link.l1.go = "endImmersion_2";
		break;
		case "endImmersion_2":
			dialog.text = "Для начала обеспечьте корабль всем необходимым. Весь набор боеприпасов, продовольствие, оружие... Ну, не мне вас учить. Все найденное доставляйте на 'Сан Габриэль', а переправкой этого добра на судно я займусь сам.";
		...
		case "takeGoods":
			NextDiag.TempNode = "takeGoods";
			dialog.text = "Приветствую. Ну, как дела с заполнением трюма клиппера?";
		...
		//Набор команды
		case "TakeCrew":
			dialog.text = "Прекрасно, "+ GetSexPhrase("друг мой","дорогая моя") +", все уже размещено в трюме вашего клиппера. Теперь вам нужно набрать команду из жителей Города. Сами понимаете, вдвоём мы с кораблём не управимся.";
			link.l1 = "Хех, а раньше нельзя было об этом сказать? Я оббегал"+ GetSexPhrase("","а") +" весь Город в поисках товаров на судно, заодно мог"+ GetSexPhrase("","ла") +" бы и команду набрать.";
		...
		case "TakeCrew_4":
			...
			link.l1 = "Хорошо, я так и сделаю. Кстати, вы сумели освободить клиппер?";
			link.l1.go = "TakeCrew_5";
		break;
		case "TakeCrew_5":
			dialog.text = "Ещё нет, но опробовал лебёдку, она в полной готовности. Договаривайтесь с людьми, пусть они прибывают сюда, а я буду переправлять их на корабль. Нам нужно хотя бы пятнадцать человек, чтобы отплыть. Как только вы соберёте необходимое количество - сразу же бегите сюда. По вашему прибытию на 'Сан Габриэль', мы задействуем лебёдку и освободим клиппер.";
		...
		case "TakeCrewNew":
			...
			{
				dialog.text = "Вы ещё не набрали достаточного количества людей для плавания. Всего ко мне прибыли " + FindRussianPeoplesString(sti(pchar.questTemp.LSC.crew), "Acc") + ". Продолжайте, и прошу вас - быстрей...";
			}
			else
			{
				dialog.text = "Вы ещё никого не уговорили пойти к вам в команду. Поторопитесь!";
			}
			link.l1 = "Хорошо.";
			link.l1.go = "exit";
		break;
		...
		break;
		case "inPrison_4":
			dialog.text = "Нет, это вряд ли. Да и не стоит рисковать клиппером и жизнями стольких людей, что уже находятся на нем. Слушайте, что вам нужно сделать...";
			link.l1 = "Хенрик, я успею и освобожу вас.";
			link.l1.go = "inPrison_5";
		break;
		case "inPrison_5":
			dialog.text = "Я решил, что остаюсь. Проверю, как говорится, воочию, правильность своей теории. Большое дело для учёного - видеть собственными глазами воплощение в жизнь своих прогнозов.\nК тому же, возможно, я ошибался, и город устоит перед натиском стихии. Тогда оставшиеся здесь начнут новую жизнь, без кланов и адмирала.";
			link.l1 = "Вы уверены?";
			link.l1.go = "inPrison_6";
		break;
		case "inPrison_6":
			dialog.text = "Да, я так решил. А теперь слушайте, что вы должны сделать, чтобы попасть на свой клиппер.";
			link.l1 = "Я слушаю.";
			link.l1.go = "inPrison_7";
		break;
		case "inPrison_7":
			dialog.text = "Отправляйтесь ко второй мачте 'Фернадо Диффиндура', оттуда до корабля уже рукой подать. Я успел использовать лебёдку до ареста и растащил корабли, окружающие клиппер. Теперь вы с лёгкостью оторвётесь от Города.\nШторм набирает силу, боюсь, что сейчас вам придётся нелегко... При выходе из 'Тартаруса', вы должны чётко представлять себе, куда направиться - направо отсюда. Иначе в этом хаосе вы погибнете. Я ещё раз повторю, что вы должны двигаться по направлению ко второй мачте 'Фернандо Диффиндура'.";
			link.l1 = "Я понял"+ GetSexPhrase("","а") +", спасибо вам... Может быть, всё-таки попытаться открыть это чёртову клетку?";
