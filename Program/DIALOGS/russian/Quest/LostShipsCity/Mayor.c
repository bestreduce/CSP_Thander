	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "А-а-а, вот и ты. Это хорошо, что ты сам"+ GetSexPhrase("","а") +" приш"+ GetSexPhrase("ел","ла") +" ко мне. Не люблю, когда от меня бегают, да ещё в такой шторм...";
		...
		break;
		case "FT_1_1":
			dialog.text = "Да, обо мне ещё помнят в Карибском море... Видишь, как получилось. Два дня мы гнались за испанским галеоном, а в ночь на третьи сутки оказались здесь... Дьявол, вся моя команда пошла ко дну, выбраться смогли только я, Уоркман и Форе.";
			link.l1 = "Сожалею...";
			link.l1.go = "FT_1_2";
		break;
		case "FT_1_2":
		...
		break;
		case "FT_3":
			dialog.text = "С Законом знакомлю тебя я в данный конкретный момент. На скрижалях он не выбит, так как с камнем у нас напряжёнка, ха-ха... А Закон по сути своей заключается в следующих пунктах\n"+
				"Все граждане Города Потерянных Кораблей имеют право на жизнь. Это право обеспечивает гарнизон милиции, который находится в распоряжении адмирала, то есть в моём распоряжении... Кстати, а ты не хочешь записаться в милицию?";
		...
		break;
		case "FT_5":
			dialog.text = "Понятно... Но сейчас, собственно, мне до этого дела нет. Будь ты до попадания сюда испан"+ GetSexPhrase("цем","кой") +" или францу"+ GetSexPhrase("зом","жёнкой") +", ангелом или чёртом лысым - здесь все равны. Теперь ты стал"+ GetSexPhrase("","а") +" граждан"+ GetSexPhrase("ином","кой") +" Города, со своими правами, важнейшим из которых является право на жизнь! Хех, как завернул!..";
		...
		break;
		case "FT_6":
			dialog.text = "Нет, этого не может быть. Путь отсюда заказан... Ну, продолжим. Итак, с правами все, теперь о твоих обязанностях. Первое: ты не можешь покушаться на жизнь граждан Города. Если ты убьёшь кого-то, то тебя убью я. Это ясно?";
			link.l1 = "Хм, ясно...";
			link.l1.go = "FT_7";
		break;
		case "FT_7":
		...
		break;
		case "FT_7_1":
			dialog.text = "Пойдём дальше. Второе: запрещается строить корабли, плоты и прочие плавсредства. Выбраться отсюда всё равно невозможно, а разрушать Город нельзя.";
		...
		break;
		case "FT_12":
			dialog.text = "Не ты перв"+ GetSexPhrase("ый","ая") +", "+ GetSexPhrase("приятель","подруга") +", кому это не нравится. Но только, уж поверь мне, все это в твоих интересах. Чем быстрей ты избавишься от всего того, что тебя связывает с большим миром, тем быстрей ты вольёшься в нашу размеренную жизнь.\nА так можешь сойти с ума, такое бывает. И, скажу я тебе, с такими мы не церемонимся - груз на шею, и на дно!";
		...
		case "FT_13":
			...
			link.l1 = "М-да... Ну что же, придётся смириться. Похоже, у меня нет другого выхода.";
			link.l1.go = "FT_14";
		break;
		case "FT_14":
		...
		case "FoundHero":
			...
			dialog.text = "Ага, вот, значит, и ты, выживш"+ GetSexPhrase("ий","ая") +" в последнем шторме. Скажи-ка мне, "+ GetSexPhrase("приятель","подруга") +", какого это чёрта я должен искать тебя по всему Городу? Ты что, не знаешь наших порядков?";
		...
		case "FoundHero_2":
			...
			link.l1 = "Я прошу прощения за опоздание, я ещё не изучил"+ GetSexPhrase("","а") +" Законов Города. Надеюсь, что дальше будет лучше... Меня зовут " + GetFullName(pchar) + ".";
			link.l1.go = "FT_1";
		break;
		...
		case "NarvalRing_9":
			...
			link.l1 = "Чёрт! Я как-то на такой поворот сюжета не рассчитывал"+ GetSexPhrase("","а") +"...";
		...
		case "DestrNarval_Bad":
			dialog.text = "М-да, печально... Однако, задача выполнена, 'нарвалы' уничтожены, а это главное. Так что всё в порядке.";
			link.l1 = "Ну да, все путём, как говорится...";
		...
		case "DestrNarval_Ok":
			...
			link.l1 = "Хм, мне здесь пока деньги не нужны, но всё равно спасибо тебе.";
		...
		case "DestrNarval_BadOk":
			dialog.text = "М-да, неприятно несколько... Ну да ладно, всё-таки это была резня, а не лёгкая прогулка по палубе. В общем, я рад, что все кончилось хорошо. Хочу подкинуть тебе деньжат за работу. Десять тысяч золотых!";
			link.l1 = "Ну, деньги здесь особо не нужны... Но всё равно спасибо.";
			link.l1.go = "DestrNarval_Ok1";
		...
		case "Interception":
			...
			{
				dialog.text = "Рад тебя видеть, адмирал.";
				link.l1 = "Тихо... Кажется, за решёткой кто-то есть. Поговорим в другом месте.";
				link.l1.go = "exit";
		...
		case "Interception_2":
			...
			link.l1 = "Да "+ NPCharSexPhrase(sld, "этому новому гражданину","этой новой гражданке") +", " + GetFullName(sld) + " "+ NPCharSexPhrase(sld, "его","её") +" зовут. Ты, наверное, слышал, что убили одного милиционера и нашего плотника. Так вот, "+ NPCharSexPhrase(sld, "этот новый гражданин принёс","эта новая гражданка принесла") +" мне амулет нарвалов и сказал"+ NPCharSexPhrase(sld, "","а") +", что наш"+ NPCharSexPhrase(sld, "ел","ла") +" его на месте убийства. Хоть это и шито белыми нитками, я не стал долго разбираться с этим делом, так как подвернулся удобный случай осуществить давно задуманное, не навлекая на себя подозрения. Послал "+ NPCharSexPhrase(sld, "этого 'героя'","эту 'героиню'") +" на разборки, дал "+ NPCharSexPhrase(sld, "ему","ей") +" ещё людей из милиции в подмогу.";
			link.l1.go = "Interception_4";
		break;
		case "Interception_4":
		sld = characterFromId("Blaze");
			dialog.text = ""+ NPCharSexPhrase(sld, "","Вот это девка! ") +"Ну, то, что он"+ NPCharSexPhrase(sld, "","а") +" на тебя поработал"+ NPCharSexPhrase(sld, "","а") +" – это прекрасно. Но ты, надеюсь, не ввёл "+ NPCharSexPhrase(sld, "его","её") +" в курс наших дел?";
			link.l1 = "Нет, я не доверяю "+ NPCharSexPhrase(sld, "ему","ей") +". На Большой земле он"+ NPCharSexPhrase(sld, "","а") +" был"+ NPCharSexPhrase(sld, "","а") +" каперским капитаном, а таких людей всегда нужно опасаться. Одно дело использовать "+ NPCharSexPhrase(sld, "его","её") +" в своих интересах, а другое – подключать к нашему делу.";
			link.l1.go = "Interception_5";
		break;
		case "Interception_5":
			dialog.text = "Кстати, о нашем деле. Уже много всего собрано, моим ребятам не терпится прокутить свою долю в борделях Карибского моря. Когда мы начнём приготовления к отплытию из этого чёртова места?";
			link.l1 = "Пока рано, я ещё не собрал достаточно денег.";
		...
		break;
		case "Interception_8":
			dialog.text = "Понятно. Но и ты пойми нас. Мы столько времени работаем с тобой, собираем ценности и деньги, а мы даже ещё не начали строить корабль! Я с трудом удерживаю людей под контролем.";
		...
		case "Interception_9":
			...
			link.l1 = "Я против. Этот безумец ненадёжен, а своими бредовыми речами он кому хочешь мозги запудрит. Твои люди, кстати, с ним не общаются?";
			link.l1.go = "Interception_10";
		break;
		case "Interception_10":
			dialog.text = "Нет, я за этим строго слежу. Механик не вылезает из своей конуры.";
			link.l1 = "Хорошо... Значит, своим людям скажешь, что строить корабль начнём, как только появится новый плотник. Хе-хе, следующему дровосеку повезёт...";
		...
		break;
		case "BarmenDead_2":
			dialog.text = "Хм, хорошая мысль. Может быть, ты и сейчас пойдёшь на место убийства и найдёшь что-нибудь эдакое, что укажет нам на преступника? Не желаешь?";
		...
		break;
		case "BarmenDead_5":
			dialog.text = "Это вряд ли. И вообще, мне не очень понятно твоё рвение. Вы что, друзья-товарищи с Хиллом были? Что вас связывает?";
		...
		break;
		case "CasperDead_3":
			dialog.text = ""+ GetSexPhrase("Идиот","Ах ты, чёрт возьми") +"! Я что, не говорил тебе не лезть туда?";
		...
		break;
		case "CasperDead_9":
			dialog.text = "Хм, не тронул"+ GetSexPhrase("","а") +"... Вот что, "+ GetSexPhrase("'крутой Уокер'","крутая девчонка") +"! Ты меня всерьёз утомил"+ GetSexPhrase("","а") +" своими выходками. Я сейчас очень зол на тебя и подумываю, не отправить ли тебя на дно с грузом на шее!";
		...
		break;
		case "CasperDead_10":
			dialog.text = "Заткнись, "+ GetSexPhrase("полудурок","наглая девчонка") +"!\nТы ещё жив"+ GetSexPhrase("","а") +" только потому, что я хочу закончить эту череду убийств. Кто бы ни был в этом виноват, я не хочу вести дальнейших расследований. Допустим, что во всем виноваты 'касперы', и на этом поставим точку. Тебе ясно?";
			link.l1 = "Да, адмирал.";
		...
		break;
		case "CasperDead_12":
			dialog.text = "Если ты ещё кого-нибудь хоть пальцем тронешь...";
			link.l1 = "Адмирал, я знаю Закон. Право на жизнь для граждан - это все очень правильно.";
			link.l1.go = "CasperDead_13";
		break;
		case "CasperDead_13":
			dialog.text = "Ну, смотри у меня!.. Ведекеру передай, чтобы он сидел себе на 'Сан Габриэле' и сопел в трубочку. Будет шататься по городу и пугать народ своими бреднями - брошу его за решётку!\nХотя, я лучше кого-нибудь из милиции пошлю к нему. Свобод"+ GetSexPhrase("ен","на") +".";
		...
		break;
		case "SeekCrew_1":
			dialog.text = "Н-да, всё-таки крыша у тебя поехала...";
		...
		break;
		case "SeekCrew_3":
			dialog.text = "Ещё ты мне порассуждай о Городе! Механик - человек грамотный, но трус и паникёр. Мы здесь столько штормов видели, что его теории уже просто смешны. Я говорил ему, чтобы он держал свои мысли при себе...";
			link.l1 = "А он и держит... Послушай меня, Чад, сюда идёт не шторм, а настоящая буря...";
		...
		//финальный диалог
		case "fightTalking":
			dialog.text = "Твоё время вышло. Ты готов"+ GetSexPhrase("","а") +" к смерти?";
		...
		case "ELTHusb_begin":
			...
			link.l1 = HeroStringReactionRepeat("Хм... Ну, интересуюсь.",
				"Да-да, я помню.",
                "Конечно.",
				"И верно, "+ GetSexPhrase("болван ещё тот","дура ещё та") +". Зачем одно и тоже спрашиваю - сам"+ GetSexPhrase("","а") +" не пойму...", npchar, Dialog.CurrentNode);
			link.l1.go = DialogGoNodeRepeat("ELTHusb_begin_1", "", "", "", npchar, Dialog.CurrentNode);
		break;
		case "ELTHusb_begin_1":
			dialog.text = "Больше не интересуйся. Это не твоё дело.";
		...
		break;
		case "ELTHusb_SF_1":
			dialog.text = "Нет, "+ GetSexPhrase("приятель","" + pchar.name + "") +", этому не бывать! Хватит, от него устал уже весь Город. Он сгниёт в своей клетке.";
		...
		case "ELTHusb_SF_2":
			...
			link.l1 = "Чёрт, да что же он сделал такого? Адмирал, расскажи, пожалуйста.";
		...
		case "ELTHusb_SF_3":
			...
			link.l1 = "Слушай, он был пьян и ничего не помнит. Может, ты войдёшь в положение и простишь его?";
		...
		break;
		case "LostDecster_5":
			dialog.text = "Хорошо. А теперь ты удовлетвори моё. К чему эти расспросы о Лейтоне?";
