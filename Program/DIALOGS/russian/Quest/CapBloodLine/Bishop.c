    ...
    */
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "WStep_12":
            ...
            dialog.text = "Все дело в том, что у меня на руках только 18000 пиастров, а вам понадобится примерно 25000. Тем не менее, я уверен, вы сможете раздобыть оставшуюся сумму.";
