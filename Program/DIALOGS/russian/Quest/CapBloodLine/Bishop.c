...
/*
    ...
    */
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "Man_FackYou":
			dialog.text = LinkRandPhrase("Грабёж среди бела дня!!! Это что же такое делается?! Ну, погоди, приятель...", "Эй, ты чего это там копаешься?! Никак, вздумал ограбить меня? Ну, тогда тебе конец...", "Постой, ты куда это полез? Да ты вор, оказывается! Ну, считай, что ты приплыл, родной...");
		...
		case "First time":
            ...
            if (npchar.id == "Bridgetown_Mayor" )
            {
                if( Pchar.questTemp.CapBloodLine.stat == "CureMisStid" )
                {
            		...
            		link.l1.go = "SStep_0";
            		link.l2 = "Ваши люди задержали меня, губернатор Стид. Как выяснилось, Ваши приказы подлежат обсуждению, и ещё как - некоторые индивидуумы активно препятствуют мне в деле лечения испанских солдат.";
            		link.l2.go = "SStep_1";
            		break;
                }
    		...
    		if (npchar.id == "Spain_spy" )
    		{
    		 ...
    		 if(npchar.id == "Volverston")
    		 {
                if(Pchar.questTemp.CapBloodLine.statcrew == "find")
                {
                    ...
                    link.l1 = "Не хочешь составить мне и ещё нескольким нашим братьям по несчастью компанию по пути в голландскую колонию Кюрасао завтрешней ночью?";
                    link.l1.go = "VLStep_0";
              		break;
                }
                dialog.text = "А-а, Питер, рад тебя видеть!.";
    		 ...
    		 if(npchar.id == "Hugtorp")
    		 {
                if(Pchar.questTemp.CapBloodLine.statcrew == "find")
                {
                    ...
                    link.l1 = "Но почему? Ты сомневаешься в чём-то?";
                    link.l1.go = "HTStep_1";
              		break;
                }
    		 ...
    		 if(npchar.id == "Dieke")
    		 {
                ...
                dialog.text = "Чем могу быть полезен вам, доктор?";
                link.l1 = "Нет, ничего, просто шёл мимо.";
                link.l1.go = "Exit";
    		 }
    		 ...
    		 if(npchar.id == "Ogl")
    		 {
                if(Pchar.questTemp.CapBloodLine.statcrew == "find")
                {
                    ...
                    link.l1 = "Как насчёт дельца, Огл? Есть ещё порох в пороховницах?";
		...
		case "First Bishop":
            if(NPChar.quest.meeting == "0")
            {
                ...
                link.l1 = "...есть Вакер и Бронсон, которых вы всегда можете порекомендовать губернатору, сославшись на мою чрезвычайную занятость на плантации. Врачи те ещё, но все же люди образованные и трудолюбивые. В ином же случае, если губернатор Стид потребует доложить о состоянии раненых, я вынужден буду ему ответить, а после отправиться к беднягам и осмотреть их.";
                link.l1.go = "BStep_0";
                npchar.quest.meeting = "1";
            }
            else
            {
           	    dialog.text = "Убирайся отсюда, никчёмный бездельник, а то я прикажу заковать тебя в кандалы!";
                link.l1 = "Как скажете.";
                link.l1.go = "Exit";
            }
		break;
		...
		case "BStep_1":
        	dialog.text = "Если ты будешь совать свой нос в мои дела, мне придётся кое-что предпринять, красавец, чтобы ты не лодырничал и не злоупотреблял предоставленной тебе свободой. Не забывай, что ты осуждённый бунтовщик!";
		...
		case "BStep_2":
        	dialog.text = "Ты шляешься без дела целыми днями! Насколько мне известно, у губернатора и его супруги всё в порядке. Уж не закрыть ли тебе доступ в город до поры?";
            link.l1 = "Вы собираетесь продать Николаса Дайка?";
            link.l1.go = "BStep_3";
		break;

		case "BStep_3":
        	dialog.text = "...а то про тебя уже слухи ходят... что? Какое тебе дело до этого несчастного, пёс?";
		...
		case "BStep_4":
        	dialog.text = "Что ты несёшь? Не смей соваться в мои дела, иначе я отправлю тебя мотыжить, предварительно выпоров до полусмерти!..";
		...
		case "EBStep_0":
            ...
            dialog.text = "Я принесу всё, что вы просите. Прошу вас, поспешите, милорд совсем плох!";
        	link.l1 = "Я сделаю всё, что в моих силах.";
		...
		case "CGStep_1":
    		...
    		link.l1 = "Во имя человечности, сэр! Мы  живём в Англии, а не в Танжере. Этот человек тяжело ранен, его нельзя трогать без опасности для жизни.";
    		link.l1.go = "CGStep_2";

		break;

		case "CGStep_2":
        	dialog.text = "Ах, так я ещё должен заботиться о здоровье мятежников! Чёрт побери! Вы думаете, что мы будем его лечить? Вдоль всей дороги от Вестона до Бриджуотера расставлены виселицы, и он подойдёт для любой из них. Полковник Кирк научит этих дураков-протестантов кое-чему такому, о чем будут помнить их дети, внуки и правнуки!";
    		link.l1 = "Прекрасно, но если вы это сделаете, боюсь, что завтра могут повесить вас. Он не принадлежит к категории людей, которых вы можете вздёрнуть, не задавая вопросов. Он имеет право требовать суда, суда пэров.";
    		link.l1.go = "CGStep_3";
		...
		case "CGStep_4":
    		...
    		link.l1 = "Он не перенесёт этого пути. Его нельзя сейчас трогать.";
    		link.l1.go = "CGStep_5";

		break;

		case "CGStep_5":
        	dialog.text = "Тем хуже для него. Моё дело - арестовывать мятежников!\nА это что за тип, который прятался в камине? Ещё один вельможа? Его-то я уж точно повешу собственными руками.";
		...
		case "CGStep_6":
        	dialog.text = "Ты лжёшь, не правда ли? Клянусь богом, он издевается надо мной!";
    		link.l1 = "Если вы в этом  уверены, то повесьте его и увидите, что с вами сделают.";
    		link.l1.go = "CGStep_7";
		break;

		case "CGStep_7":
        	dialog.text = "Дьявол. Да кто ты такой, чёрт бы тебя побрал? И как ты здесь очутился?";
        ...
        case "CGStep_9":
			...
			link.l1 = LinkRandPhrase("Дьявол!!", "Как бы не так!", "А-ать, чёрт!");
			link.l1.go = "Exit";
        ...
        case "MSStep_0":
        	...
        	link.l1 = "Похоже, никак не обойтись без лекарств, но аптека давно закрыта. Мне придётся пойти к мистеру Дэну домой, чтобы получить все необходимое. Попейте тёплой воды и ждите меня, я вернусь так скоро, как только смогу!";
            link.l1.go = "Exit";
        ...
        case "MSStep_1":
            ...
            {
                link.l1 = "Ещё нет, я как раз шёл за ними.";
                link.l1.go = "Exit";
            }
        ...
        case "NStep_1":
            ...
            dialog.text = "Твоё здоровье, доктор! Эх-х-х!";
            if( Pchar.questTemp.CapBloodLine.stat == "needMoney")
            {
        ...
        case "NStep_2":
            ...
            {
                link.l1 = "Будь готов, как только я соберу необходимую сумму денег, ты займёшься покупкой шлюпа.";
                link.l1.go = "Exit";
        ...
        case "NStep_6":
        	...
        	link.l1 = "Ну, в общем, я всё возьму на себя. Тебе нужно всего-навсего пойти на верфь и купить шлюп, деньги я тебе принесу. Отправляйся в таверну, а то здесь мы очень бросаемся в глаза.";
            link.l1.go = "Nettl_Away";
            NextDiag.TempNode = "NStep_5";
            Pchar.questTemp.CapBloodLine.TalkWithNettl = true;
		break;
        ...
        case "WStep_2":
            ...
            dialog.text = "Что ж, я и сам не в настроении обсуждать все то, что обсудить необходимо, именно здесь и сейчас. Я, пожалуй, пойду, а вы, если угодно, дождитесь Дэна. Поговорим завтра. Как только найдёте свободную минуту, приходите в таверну. Очень на вас надеюсь.";
        	link.l1 = "До свидания.";
            link.l1.go = "Exit_Away";
            Pchar.questTemp.CapBloodLine.sLocator = "reload1";
        ...
        case "WStep_12":
            ...
            dialog.text = "Всё дело в том, что у меня на руках только 18000 пиастров, а вам понадобится примерно 25000. Тем не менее, я уверен, вы сможете раздобыть оставшуюся сумму.";
        	link.l1 = "Это будет затруднительно, но выбора у меня нет. Что насчёт шлюпа? Никто из рабов не сможет просто прийти на верфь и прикупить себе шлюп, как ни в чём не бывало.";
            link.l1.go = "WStep_13";
        ...
        case "PStep_2":
            ...
            dialog.text = "Хорошо, я понял, я всё понял. Сделаю все, что в моих силах, чтобы помочь...";
        ...
        case "PStep_5":
        	...
        	link.l1 = "Думаю, нам нечего бояться, ведь мы живём в христианской стране, а христиане не воюют с ранеными и с теми, кто их приютил. А вот Питту лучше куда-нибудь исчезнуть.";
            link.l1.go = "PStep_6";
            //NextDiag.TempNode = "SStep_4";
        ...
        case "PStep_8":
            dialog.text = "К счастью для страдальца, он умер от побоев\nНо я пришёл к тебе не жаловаться на тяготы, а чтобы сообщить, что тебя зачем-то разыскивает Бишоп. Постарайся не злить его, а то мы рискуем остаться без твоей врачебной помощи.";
        ...
        case "PStep_11":
        	...
        	link.l1 = "Успокойся, Питт, Хагторп все мне рассказал. Ты, наверное, полагал, будто мы обойдёмся без штурмана, если дал этой  скотине Бишопу повод чуть не убить тебя?";
            link.l1.go = "PStep_12";
        ...
        case "PStep_13":
        	...
        	link.l1 = "К чёрту Нэтталла! Мы что-нибудь придумаем. Выкрадем шлюп, в конце концов! Хагторп и остальные уже ждут нас в городе, нужно предупредить их, пока их не схватили!";
            link.l1.go = "PStep_14";
        ...
        case "PStep_16":
        	...
        	link.l1 = "Рад видеть тебя на ногах дружище. К сожалению, ещё не вырвались. Нам ещё нужно выйти в открытое море и решить, куда мы отправимся.";
            link.l1.go = "PStep_17";
        ...
        case "PStep_17":
        	...
        	link.l1 = "Думаю, у нас ещё будет время поразмыслить над этим. А сейчас нельзя терять времени, те, кто остался на берегу - не слепые и не умерли и скоро поймут, что с  кораблём что-то неладно. Нужно выбрать капитана и подготовиться к обороне.";
            link.l1.go = "PStep_18";
        ...
        case "PStep_18":
        	...
        	link.l1 = "Ну, если возражений нет, тогда готовим корабль к бою. Ты будешь штурманом, Джереми, так как ты единственный из нас можешь управлять кораблём.";
            link.l1.go = "PStep_19";
...
//            SetCharacterGoods(Pchar,GOOD_RUM,40);//600);
        ...
        case "GRStep_0":
            ...
            dialog.text = "При всем уважении, доктор, коего вы, бесспорно, заслуживаете... провались к морскому чёрту ваши неотложные дела!";
        ...
        case "GRStep_8":
            ...
            {
            	link.l1 = "Я просто зашёл вас проведать.";
                link.l1.go = "Exit";
                NextDiag.TempNode = "GRStep_8";
            }
        ...
        case "GRStep_9":
            ...
            dialog.text = "Хм... что ж, меня даже не интересует, как вам это удалось и многих ли вы убили в процессе. Сегодня через час точно такой же свёрток будет готов для вас. А теперь попрошу меня оставить, предварительно, конечно, оплатив мой труд.";
        ...
        case "GRStep_12":
            ...
            {
                dialog.text = "Оружие для вас ещё не готово, приходите позднее.";
                link.l1 = "Хорошо.";
                link.l1.go = "Exit";
                NextDiag.TempNode = "GRStep_12";
        ...
        case "GRStep_16":
        	...
        	link.l1 = "Успокойтесь, мне вовсе не нужно, чтобы вы что-то делали официально. Никаких опознавательных гравировок на эфесе, никаких бумаг и отчётов - все тихо и мирно. Никто и никогда не узнает о том, что это произошло.";
        ...
        case "HStep_5":
            ...
            dialog.text = "У меня найдётся для тебя кое-какая работа, если тебе интересно. Хотя, уверен, что это вопрос глупый. Вам всем нужны деньги.";
        	link.l1 = "Сколько?";
            link.l1.go = "HStep_6";
        ...
        case "HStep_6":
            ...
            dialog.text = "Я готов заплатить тебе две тысячи за кое-какую информацию. Дело в том, что Арнольд Саммерлайт - мой конкурент - нашёл какое-то место... очень рыбное место. Он разоряет меня! Узнай любой ценой, где он добывает свой улов, и я с радостью расстанусь с двумя тысячами. Идёт?";
        	link.l1 = "Идет.";
            link.l1.go = "HStep_7";
        ...
        case "SSStep_0":
        	...
        	link.l1 = "Его дом тут неподалёку. Во-о-он там.";
            link.l1.go = "SSStep_1";
        ...
        case "QSStep_0":
            ...
            dialog.text = "Стоп, стоп, стоп... просить о такой услуге немногим лучше, чем просить меня увезти вас отсюда. Причём, увозить вас с этих земель я не рискну и под страхом смерти, ибо если об этом узнают, я умру куда как более мучительно, но оружие! Надо быть человеком достаточно дерзким и немного безумным, чтобы об этом попросить в таверне, будучи привилегированным рабом. И ещё большим безумцем нужно быть, чтобы согласиться помочь вам в этом...";
		...
		case "VLStep_0_2":
            dialog.text = "Ты принёс то, что я просил?";
        ...
        case "VLStep_1":
            ...
            dialog.text = "Дьявол, когда же уже наступит эта чёртова ночь?!";
        	link.l1 = "Немного терпения, мой друг. Совсем скоро мы уберёмся с этого проклятого острова.";
            link.l1.go = "Exit";
            NextDiag.TempNode = "VLStep_1";
        ...
        case "VLStep_12":
        	...
        	link.l1 = "Но я не о том хотел с тобой поговорить. Волверстон, ты хороший боец, сравнится с тобой в силе может не каждый, да и, думаю, если тебе немного походить под парусом, ты станешь отличным первым помошником. Пойдёшь ко мне офицером?";
        ...
        case "VLStep_13":
            ...
            dialog.text = "Поднять Весёлый Роджер, стать свободным пиратом, проводить в море больше времени, чем на суше, каждый день риск, запах пороха, золото, ром? С огромным удовольствием!";
        ...
        case "HTStep_3":
            ...
            dialog.text = "Недавно сюда прибыл человек по имени Стюарт Уинтервуд. Поймёшь ли ты меня - не знаю, но он - мой кровник. Из-за него я лишился всего: семьи, чести, жизни. Из-за него я попал сюда!..";
        ...
        case "HTStep_5":
            ...
            dialog.text = "Таверна, бордель... он где-то там, дьявол! Веселится и пьёт, играет в карты! На его руке МОЕ обручальное кольцо, дома его ждёт МОЯ жена! Принеси мне кольцо... вместе с пальцем.";
        ...
        case "HTStep_7":
            ...
            dialog.text = "Дьявол тебя разбери, Блад! Это дело чести, я же сказал! Боишься рисковать, не осмелишься помочь мне - не надо! Уплывёшь к морскому дьяволу и без меня!";
        	link.l1 = "Хорошо, Хагторп. Я убью его.";
            link.l1.go = "HTStep_13";
           	link.l2 = "Без тебя? Едва ли возможно, но при должном умении... послушай меня. Мы можем сейчас уйти в море и начать новую жизнь, а ты рано или поздно встретишь чертового Уинтервуда и отомстишь, как захочешь, без риска для собственной шкуры. Вздёрнешь его на нок-рее, срубив хоть все пальцы до единого!";
            link.l2.go = "HTStep_8";
            NextDiag.TempNode = "HTStep_10";
        ...
        case "HTStep_9":
            ...
            dialog.text = "Ладно, я согласен! К чёрту Уинтервуда до некоторых пор. Я присоединюсь к тебе.";
        	link.l1 = "По рукам.";
            link.l1.go = "Exit";
        ...
        case "HTStep_10":
            ...
            dialog.text = "Ты уже вернулся? Он мёртв?";
        ...
        case "HTStep_12":
        	...
        	link.l1 = "Пока ещё нет, я сообщу, когда придёт время.";
            link.l1.go = "Exit";
            NextDiag.TempNode = "HTStep_12";
        ...
        case "HTStep_16":
            ...
            dialog.text = "Питт держится, но тебе лучше не ходить к полковнику, он может приказать запереть тебя под замок. Лучше сейчас ничего не предпринимать - дождёмся темноты. А как стемнеет, достанем оружие и освободим Джереми.";
        ...
        case "HTStep_19":
            ...
            dialog.text = "Испанцы захватили Бриджтаун. Сегодня в наш порт под чужим флагом зашёл большой корабль. Это был испанский капер. Его хитрость с флагом осталась нераскрытой настолько, что, не возбудив подозрений, он преспокойно вошёл в бухту и отсалютовал форту в упор бортовым залпом из двадцати пушек.";
        ...
        case "HTStep_22b":
        	...
        	link.l1 = "Все за мной, мы идём на штурм.";
            link.l1.go = "Exit";
            NextDiag.TempNode = "HTStep_22b";
            AddDialogExitQuestFunction("CapBloodOfficers");
        ...
        case "HTStep_24":
            ...
            dialog.text = "Ты был прав, Питер. Все вышло, как ты и сказал, мы овладели этим прекрасным кораблём почти без потерь.";
        	link.l1 = "Да, Хагторп, но боюсь, все только начинается. Мне кажется, ты отличный моряк. Пойдёшь ко мне офицером?";
        ...
        case "HTStep_25":
            ...
            dialog.text = "Питер, ты добрый и отзывчивый человек, слово 'честь' для тебя не пустой звук, ты прекрассный врач, таллантливый капитан и отличный лидер. Если понадобится, я отдам за тебя жизнь.";
        	link.l1 = "Спасибо, Натаниэль, но отдать за меня жизнь у тебя ещё будет время, а сейчас нам ещё нужно вырваться из этого ада.";
            link.l1.go = "Exit_RunAway";
            Pchar.questTemp.CapBloodLine.sLocator = "reloadShip";
            Pchar.questTemp.CapBloodLine.iTime = 3;
        ...
        case "DKStep_0":
            ...
            dialog.text = "Нет, увы, я ничего не знаю. Возможно, он ещё не успел... но это уже неважно.";
        ...
        case "DKStep_1":
            ...
            dialog.text = "Полковник Бишоп продаёт меня. Вчера в город прибыл покупатель, которому нужен раб, неплохо знакомый с морским делом. Боюсь, уже ничего нельзя сделать...";
        ...
        case "DKStep_2":
        	...
        	link.l1 = "Ещё не все потерянно, Ник.";
            link.l1.go = "exit";
            NextDiag.TempNode = "DKStep_2";
		break;
        ...
        case "DKStep_5":
            ...
            dialog.text = "Не думал, что на пути к свободе придётся пролить столько крови.";
        	link.l1 = "Николас, ты славный парень, из тебя выйдет толковый офицер. Пойдёшь с нами?";
            link.l1.go = "DKStep_6";
        ...
        case "OGLStep_5":
            ...
            dialog.text = "Я взял заём некоторое время назад. Ростовщик сжалился надо мной, а мне это было очень нужно. Он помог мне, а я уже не в том возрасте, чтобы быть таким равнодушным\nНе хочу иметь за спиной долги.";
        ...
        case "OGLStep_12":
        	...
        	link.l1 = "Тогда, раз уж я капитан этого судна, пойдёшь ко мне старшим канониром?";
