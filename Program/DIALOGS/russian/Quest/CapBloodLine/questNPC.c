...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SoldierNotBlade":
            ...
            {
                dialog.text = LinkRandPhrase("Какого черта ты бегаешь по городу с обнажённым клинком? Немедленно убери оружие!", "Приказываю вам немедленно убрать оружие в ножны!", "Эй, приятель, прекрати пугать народ! Убери оружие в ножны.");
        ...
        case "SLQStep_1":
            ...
            dialog.text = "Доктор, в моем положение следовать вашему совету затруднительно. Денег у меня нет, но есть кое-что, что может сильно вам пригодиться. Так, что если вам всё-таки удастся раздобыть что-нибудь для меня, то я в долгу не останусь.";
