...
*/
		...
		case "On_MyShip_Deck_1":
			...
			{
				// карты не было
				dialog.text = "Капитан! Бросьте печалиться! Раз уж всё равно было миром не уйти, в суматохе мы решили заскочить к местному ростовщику и слегка облегчили его сундуки. Вот Ваша доля - " + sti(pchar.questTemp.ReasonToFast.p9) + " пиастров...";
			}
			if(pchar.questTemp.ReasonToFast == "speakSuccess_chain_B")
			{
				// карту отобрали
				GiveItem2Character(pchar, pchar.questTemp.ReasonToFast.p6);
				dialog.text = "Капитан! Бросьте печалиться! Раз уж всё равно было миром не уйти, в суматохе мы решили заскочить к местному ростовщику и слегка облегчили его сундуки. Да ещё и клинок приличный прихватили из ломбардного шкафа. Вот Ваша доля - " + sti(pchar.questTemp.ReasonToFast.p9) + " пиастров и клинок...";
			}
