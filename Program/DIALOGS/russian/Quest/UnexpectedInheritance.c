void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "GrottoSkeleton_1":
			...
			Link.l1 = "Я прош"+GetSexPhrase("ёл","ла")+" по всем его подсказкам, они нетронуты, почти. Как вы добрались сюда?";
		...
		case "GrottoSkeleton_3":
			dialog.Text = "Всё пошло не так. Я застал его за открытием сундука и выстрелил ему в голову. Грохот выстрела, обрушил свод пещеры, и меня придавило к трупу моего сводного братца. Так я и лежал во тьме, лицом в месиве, оставшемся от его головы. Потом я умер. А теперь приш"+GetSexPhrase("ёл","ла")+" ты.";
