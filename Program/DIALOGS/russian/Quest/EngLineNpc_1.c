...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            if (npchar.id == "Albermal")
            {
                ...
                link.l1 = "Меня зовут " + GetFullName(pchar) + ". Я получил"+ GetSexPhrase("","а") +" необходимые инструкции от губернатора Мэдифорда.";
                link.l1.go = "Step_E1_1";
            }
            // тюремщик в Кюрасао, квест №4
            if (npchar.id == "Hoverd_Tantum")
            {
    			dialog.text = "Что, "+ GetSexPhrase("попался, голубь","попалась, голубка") +"?";
    			link.l1 = "Издеваешься?";
            ...
            {
                dialog.text = "Будь проклят тот день, когда ты вош"+ GetSexPhrase("ел","ла") +" ко мне на палубу...";
            ...
            if (pchar.questTemp.State == "MorrisWillams_GoToMorrisBegin" && npchar.id == "Morris_Willams")
            {
    			...
    			link.l1 = "Приш"+ GetSexPhrase("ел","ла") +" посмотреть на удачливого капера. Говорят, ты взял три испанских галеона!";
            ...
            if (pchar.questTemp.State == "MorrisWillams_ModifordGood5000" && npchar.id == "Morris_Willams")
            {
                ...
                dialog.text = "Чёрт возьми! Я послушался тебя, зашёл в порт и у меня тут же конфисковали груз! Ты подставил"+ GetSexPhrase("","а") +" меня!";
            ...
            {
                dialog.text = "Ты захватил"+ GetSexPhrase("","а") +" мой индиго?";
                link.l1 = "У берегов Сан-Хуана я захватил"+ GetSexPhrase("","а") +" тот самый испанский пинас. Только в трюмах не оказалось ни индиго, ни серебра, ни красного дерева.";
                link.l1.go = "Step_E6_10";
            }
            if (pchar.questTemp.State == "MorrisWillams_PinnaceBoardNotFoundMoney" && npchar.id == "Morris_Willams")
            {
                dialog.text = "Ты захватил"+ GetSexPhrase("","а") +" мой индиго?";
                link.l1 = "У берегов Сан-Хуна я захватил"+ GetSexPhrase("","а") +" тот самый испанский пинас. Только в трюмах не оказалось ни индиго, ни серебра, ни красного дерева. Я обыскал"+ GetSexPhrase("","а") +" весь корабль, но ничего ценного не наш"+ GetSexPhrase("ел","ла") +", извини.";
                link.l1.go = "Step_E6_11";
            }
            if (pchar.questTemp.State == "MorrisWillams_DieHard" && npchar.id == "Morris_Willams")
            {
                dialog.text = "Ты захватил"+ GetSexPhrase("","а") +" мой индиго?";
                link.l1 = "Извини, но этот пинас оказался мне не по зубам. Я не сумел"+ GetSexPhrase("","а") +" взять его.";
                link.l1.go = "Step_E6_11";
            }
            if (pchar.questTemp.State == "MorrisWillams_PinnaceSink" && npchar.id == "Morris_Willams")
            {
                dialog.text = "Ты захватил"+ GetSexPhrase("","а") +" мой индиго?";
                link.l1 = "Чёртов пинас пошёл ко дну, а вместе с ним и весь твой приз. Я сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +", извини.";
                link.l1.go = "Step_E6_11";
            }
            ...
            if (pchar.questTemp.State == "ColonelLinch_GoToKingstown")
            {
                ...
                link.l1 = "Я английский капер, сэр. Моё имя - " + GetFullName(pchar) + ".";
...
//<<<<<<<<<<<<===== Разброс диалогов по персонажам =====================
        case "Step_E1_1":
            if (GetQuestPastDayParam("questTemp") < 2)
            {
                ...
                link.l1 = "Я готов"+ GetSexPhrase("","а") +", отправляемся немедленно.";
                link.l1.go = "Go_with_Albermal";
                link.l2 = "Позже, мне нужно пополнить запасы. Путешествие будет опасным.";
                link.l2.go = "exit";
			}
			else
			{
				...
				link.l1 = "Сэр, прошу прощения за задержку, но это было вызвано необходимостью. Теперь я готов"+ GetSexPhrase("","а") +", выступаем немедленно!";
				link.l1.go = "Go_with_Albermal";
				link.l2 = "Сэр, мне нужно провести ещё ряд подготовительных мероприятий. Я не могу подвергать вашу жизнь неоправданному риску из-за недостаточной подготовки операции. Прошу вас подождать ещё немного.";
				link.l2.go = "exit";
        ...
        case "in_the_SentJons":
            ...
            {
                dialog.text = "Я благодарен вам от всей души. Вы проявили настоящий героизм в сражении с серьёзным противником. К тому же, в Сент-Джонс мы успели в срок. Я даю вам письмо для сэра Томаса Мэдифорда, передайте эту депешу ему лично в руки. Прощайте!";
            ...
            {
                dialog.text = "Я благодарен вам за героизм, проявленный в сражении с испанцами. Но из-за вашей медлительности рухнули все мои планы! Я передаю с вами письмо для Мэдифорда. Ступайте, я вас больше не задерживаю.";
...
//********************************* Диалоги тюремщика по четвёртому квесту английки **********************************
 		case "Step_E4_1":
			dialog.text = "Нет, спрашиваю. Вляпал"+ GetSexPhrase("ся","ась") +" ты серьёзно. А что случилось то? Что за шум был в городе из-за тебя?";
			link.l1 = "Ваш ростовщик Йозеф Нунен де Фонкейсао - порядочный мерзавец. У меня было к нему деловое предложение, но, когда мы не договорились, он вызвал охрану и меня арестовали, забрали оружие и деньги. Теперь я обвиняюсь в шпионаже.";
			link.l1.go = "Step_E4_2";
		break;

 		case "Step_E4_2":
			dialog.text = "Хм, похоже на нашего Йозефа... А что за дело ты ему предложил"+ GetSexPhrase("","а") +"?";
			link.l1 = "Купить драгоценности и кое-какое испанское барахло. Я корсар, не хотел"+ GetSexPhrase("","а") +" идти на Тортугу, решил"+ GetSexPhrase("","а") +" сдать добычу поблизости.";
			link.l1.go = "Step_E4_3";
		break;

 		case "Step_E4_3":
			dialog.text = "Хех, против парней-корсаров"+ GetSexPhrase("",", а тем более девчонок-корсаров") +" я ничего не имею, вы мне нравитесь, ребята. Однако, как пить дать, Йозеф этой же ночью постарается тебя здесь убить, чтобы ты не сболтнул"+ GetSexPhrase("","а") +" лишнего, ведь связи с корсарами и слава барахольщика ему ни к чему. Он, вроде как, уважаемый человек в городе.";
			link.l1 = "Поможешь мне выбраться - я в долгу не останусь.";
			link.l1.go = "Step_E4_4";
		break;

 		case "Step_E4_4":
			dialog.text = "Я открою твой замок на решётке. Ты сможешь выйти, как только я уйду. Денег мне не нужно, у меня с Йозефом свои счеты...";
			link.l1 = "Понял"+ GetSexPhrase("","а") +". Что ж, спасибо тебе.";
			link.l1.go = "Step_E4_5";
		break;

 		case "Step_E4_5":
			dialog.text = "Отсюда пробивайся сам"+ GetSexPhrase("","а") +", здесь я тебе не помощник. Кстати, так у тебя нет оружия, даю тебе саблю из тюремного арсенала.\n"+
                          "Прощай. Надеюсь, Йозеф долго будет в бешенстве.";
			link.l1 = "Это уж не сомневайся. Прощай, друг. Ещё раз спасибо за помощь.";
...
//**************************************** Диалоги Морриса Уильямса **************************************
        ...
        case "Willams_waiting": // если ГГ подойдёт в таверне к Уильямсу до проведения разговора с Мэдифордом
            dialog.text = "Ну что, узнал"+ GetSexPhrase("","а") +" что-нибудь?";
        ...
        case "Step_E6_6":
            dialog.text = "Ты просто уничтожил"+ GetSexPhrase("","а") +" меня. Этот товар шёл у меня в погашение долгов.\n"+
                          "Как только я сошёл на берег в порту, то к своему величайшему удивлению узнал, что все мои долговые расписки скупил местный ростовщик. Он заблокировал мне выход в море, а мой корабль находится под залогом выплаты долга. Вот так!";
        ...
        case "Step_E6_7":
            ...
            link.l2 = "У меня есть 140000. Я виноват"+ GetSexPhrase("","а") +" перед тобой, ведь из-за меня ты попал в ловушку. Так что бери и решай свои проблемы.";
        ...
        case "Willams_Fack":
            ...
            NextDiag.TempNode = "Willams_Fack";
			//слухи
			AddSimpleRumour("Моррис Вильямс рассказывает о вас такие жуткие вещи! Послушать его, так вы форменн"+ GetSexPhrase("ый мерзавец","ая мерзавка") +"...", ENGLAND, 5, 1);
        break;

        case "Willams_GiveMoney":
            dialog.text = "Вот это да, таких денег у тебя нет. Что ж, я буду ждать здесь в таверне, пока ты их соберешь.";
            link.l1 = "Да, точно, упустил"+ GetSexPhrase("","а") +" из виду... Но ничего, я скоро вернусь, долго ждать тебе не придётся.";
            link.l1.go = "exit";
            NextDiag.TempNode = "Step_E6_7";
            if (sti(pchar.money) >= 140000)
            {
                dialog.text = "Ты честн"+ GetSexPhrase("ый","ая") +" и благородн"+ GetSexPhrase("ый человек","ая девушка") +", капитан. Законы берегового братства для тебя не пустой звук. Я возьму эти деньги, так как они мне крайне необходимы. Благодарю тебя.";
				...
				//слухи
				AddSimpleRumour("Капитан, говорят, вы здорово выручили Вильямса, погасив его долг. Вы благородный человек, капитан, для меня честь разговаривать с вами!", ENGLAND, 5, 1);
            }
        break;

        case "Willams_NiceTalking":
            dialog.text = "Очень рад видеть своего друга! Как поживаете, капитан " + GetFullName(pchar) + "?";
            link.l1 = "Всё в порядке, Моррис. Надеюсь, у тебя тоже всё в порядке.";
            link.l1.go = "exit";
            NextDiag.TempNode = "Willams_NiceTalking";
        break;
        ...
        case "Willams_BackGoods":
            dialog.text = "Хотел бы я взяться за это, но не могу, мой корабль в порту на приколе.\n"+
                          "А тебе пожелаю удачи. Конфискованный товар испанцы уже должны были забрать. Тебе нужно узнать, каким кораблём они собираются его вывезти, и тогда - дело за малым!";
            link.l1 = "По-твоему, кто может это знать?";
            link.l1.go = "Step_E6_8";
        break;

        case "Step_E6_8":
            dialog.text = "Твой друг Мэдифорд в первую очередь, кто же ещё!\n"+
        ...
        case "Willams_WaitSeek":
            dialog.text = "Раскопал"+ GetSexPhrase("","а") +" что-нибудь? Когда я получу свой груз?";
        ...
        case "Step_E6_10":
            dialog.text = "Чёрт возьми! А куда же девался мой товар?";
            link.l1 = "Понятия не имею, возможно, испанцы разгрузились где-то по дороге. Извини.";
            link.l1.go = "MorrisWillams_NotGiveMoney";
            link.l2 = "Полагаю, испанцы продали его по дороге. В каюте капитана я наш"+ GetSexPhrase("ел","ла") +" сто сорок тысяч монет! Это твои деньги, теперь ты можешь рассчитаться с долгами.";
        ...
        case "MorrisWillams_NotGiveMoney":
            dialog.text = "Все, я пропал. Что ж, "+ GetSexPhrase("дружище","подруга") +", спасибо тебе, ты сделал"+ GetSexPhrase("","а") +" все, что мог"+ GetSexPhrase("","ла") +".";
        ...
        if (sti(pchar.money) >= 140000)
        {
            dialog.text = "Ты сдержал"+ GetSexPhrase("","а") +" слово, спасибо! Отныне ты мой друг навсегда. Мне нечем тебя сейчас отблагодарить. Правда... есть одна вещица, важность которой в нашем деле трудно переоценить. Ты "+ GetSexPhrase("человек бесстрашный","девушка бесстрашная") +" и, возможно, сможешь сделать то, на что я и моя команда решиться так и не смогли.";
            link.l1 = "Хм, заинтересовал. Говори дальше, что это за вещица и на что не решились такие отчаянные головорезы.";
            link.l1.go = "Step_E6_14";
        }
        else
        {
            dialog.text = "И где деньги? У тебя же их нет!";
            link.l1 = "Вот чёрт, забыл"+ GetSexPhrase("","а") +" в каюте. Сейчас сбегаю, и все 140000 будут у тебя, не волнуйся.";
            link.l1.go = "exit";
        ...
        case "Step_E6_14":
            dialog.text = "Вещица - это кираса, второй такой на Карибах, полагаю, нет. Об стальном слушай дальше... \n"+
                          ...
                          "Вот у него то, кроме другой прекрасной амуниции, и была та самая кираса, настоящее произведение искусства и в крайней степени надёжный доспех. Хотел я было вернуться к кораблю потом, но мои оставшиеся в живых головорезы в слезах уговорили меня не делать этого.\n"+
                          "А все дело в том, что после крушения мы кое-как добрались до залива Косумель, там нас подобрало голландское торговое судно, которое доставило нас до Тортуги. По прибытии пять человек из моей команды изъявили желание уйти на люггере к мысу Каточе, в бухту с нашим разбитым фрегатом.\n"+
                          "Оно и понятно - нужно было забрать сохранившиеся драгоценности, деньги. Когда не вернулись первые, отправились ещё пять пиратов. Только вот больше их никто не видел, ни тех, ни других. Так что я до сих пор не знаю, где эти корсары и что с ними. Но на место крушения своего фрегата, пожалуй, действительно не сунусь.\n"+
                          "Ну а ты смотри сам"+ GetSexPhrase("","а") +", можешь и попытаться. Возможно, мои пираты просто удрали с деньгами прямиком в Старый Свет или ещё куда. Кто его знает...\n"+
                          "А кираса, чёрт её дери, дорогого стоит. И не в деньгах дело, а в сохранении собственного здоровья и жизни в бою.";
			...
			//слухи
			AddSimpleRumour("Моррис Вильямс всюду только и говорит, как"+ GetSexPhrase("ой","ая") +" вы отчаянн"+ GetSexPhrase("ый","ая") +" рубака, прекрасный кэп и честн"+ GetSexPhrase("ый человек","ая девушка") +". Характеристика, однако, просто великолепная! Не думал даже, что ещё живут такие люди на земле.", ENGLAND, 5, 1);
        break;
        ...
        case "Step_E6_11":
            dialog.text = "Да пош"+ GetSexPhrase("ел","ла") +" ты со своими извинениями. Мне грозит тюрьма, а ты извинения просишь...";
            link.l1 = "Несмотря на неудачу с пинасом, я всё же попытаюсь тебе помочь.";
            link.l1.go = "Step_E6_12";
            link.l2 = "Знаешь, твоё хамство мне уже порядком надоело. В конце-то концов, я тебе ничем не обязан"+ GetSexPhrase("","а") +". Прощай и будь здоров.";
            link.l2.go = "Willams_GoogBye";
        break;

        case "Step_E6_12":
            dialog.text = "Ну что ж, буду благодарен за любую помощь. А что ты собираешься предпринять?";
            link.l1 = "Пока не знаю. Давай посмотрим, что будет дальше, а потом уже будем принимать решение.";
        ...
        case "Step_E6_20":
			dialog.text = "Так и есть. Мне удалось перехватить небольшую эскадру, состоящую из трёх испанцев.\n"+
                          "Мой фрегат атаковал этих ханжей-католиков, и те бросились наутёк, вместо того, чтобы сообща противостоять мне. Я взял галеоны на абордаж по очереди!";
        ...
        case "Step_E6_22":
			dialog.text = "Репутация милосердного пирата может быстро сделать меня богатым. Это я уже понял, хотя о спартанцах ничего такого не знал.\n"+
                          "Ладно, говори, зачем приш"+ GetSexPhrase("ел","ла") +"?";
			link.l1 = "Томас Мэдифорд даёт тебе разрешение пристать к Порт Роялю и реализовать призовой товар в магазинах острова.";
        ...
        case "Step_E6_24":
			...
			link.l1 = "Всего хорошего, Моррис. Мы встретимся ещё.";
			link.l1.go = "exit";
...
//**************************************** Диалоги Томаса Линча **************************************
        ...
        case "Step_E12_3":
            dialog.text = "Он больше не является губернатором Ямайки. Вы должны знать, что терпение правительства лопнуло.\n"+
                          "По назначении губернатором Ямайки Мэдифорд имел совершенно чёткие распоряжения от Его Величества Карла II обуздать пиратство и поддерживать дружеские отношения с Испанией.\n"+
                          "Вместо того, чтобы следовать полученным указаниям, Мэдифорд потворствовал пиратству, а последний его 'фокус' - захват и разграбление побережья Мейна - вызвал беспрецедентный скандал в Европе! Королева Испании Анна Австрийская трое суток пребывала в форменной истерике.";
            link.l1 = "Сэр, испанцы сами виноваты в этом. Это они начали боевые действия, напав на Порт Рояль.";
        ...
        case "Step_E12_5":
            dialog.text = "Тортуга является французской колонией, а Испания и Франция перманентно находятся в состоянии войны. Ха, Людовик, если так можно выразиться, остужает пыл папистов в Европе.\n"+
                          "Англия не может позволить себе серьёзного усиления французского влияния в Старом Свете, поэтому мы и имеем мирный договор с Испанией.\n"+
                          "А наш 'уважаемый' сэр Томас Мэдифорд творит здесь чёрт знает что!!!";
            link.l1 = "Понятно, сэр.";
            link.l1.go = "Step_E12_6";
        break;

        case "Step_E12_6":
            dialog.text = "Более того, мы имеем совершенно чёткие основания полагать, что Мэдифорд сохраняет существующее в Порт Рояле положение вещей ради собственных корыстных интересов.\n"+
        ...
        case "Step_E12_7":
            dialog.text = "Черта с два! Английское правительство не видит этих денег.\n"+
                          "Нам также известно, что Мэдифорд имеет особые отношения с авторитетными пиратами и буканьерами. И их совместные так называемые 'дела' приносят астрономические прибыли.";
        ...
        case "Step_E12_9":
            dialog.text = "Дело в том, что Мэдифорд подлежит аресту. Однако сделать это так просто не удастся.\n"+
                          "Для находящегося в Порт Рояле английского гарнизона он остаётся губернатором Ямайки. По сути, мы можем спровоцировать кровопролитие между англичанами, чего допускать я не намерен. К тому же гарнизон Порт Рояля очень силён.\n"+
        ...
        break;
         ...
         case "Step_E12_11":
            ...
            link.l1 = "В последнее время я был"+ GetSexPhrase("","а") +" довольно близ"+ GetSexPhrase("ок","ка") +" Мэдифорду, и я хочу снисходительного отношения ко мне новой английской власти на Карибах.";
            link.l1.go = "Step_E12_12";
        break;

         case "Step_E12_12":
            dialog.text = "Мне не в чём вас обвинять, вы действовали на основании каперского свидетельства. В случае успешного задержания Мэдифорда я гарантирую вам не снисходительное, а лояльное отношение английских властей к вашей персоне.";
			link.l1 = "Великолепно! И второе: я хочу получить половину от доходов, которые Мэдифорд незаконно нажил.";
            link.l1.go = "Step_E12_13";
        break;

        case "Step_E12_13":
            dialog.text = "Гм... А вы весьма "+ GetSexPhrase("хваткий человек","хваткая девушка") +", " + GetFullName(pchar) + ".";
        ...
        case "Step_E12_14":
            dialog.text = "Э-э-эх, чёрт возьми... Договорились! Половина от конфиската - ваша. Итак, я назначаю вас своим помощником и даю вам поручение чрезвычайной важности.\n"+
