...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Проваливай, пока цел"+ GetSexPhrase("","а") +"...";
            ...
            {
    			dialog.text = "Я благодарен вам за удачно завершившееся путешествие. И благодарен вдвойне за то, что вы так вовремя появились в Сан-Мартине. Я надеюсь, мы встретимся ещё.";
            ...
            if (npchar.id == "Alan_MacLine" && pchar.questTemp.State == "WormEnglPlans_SaveOfficer")
            {
    			...
    			link.l1 = "Я приш"+ GetSexPhrase("ел","ла") +" освободить вас!";
            ...
            {
    			dialog.text = "Ох, в невесёлое время ты появил"+ GetSexPhrase("ся","ась") +" у нас... Мэнсфилд убит.";
    			link.l1 = "Как убит?!";
            ...
            {
    			dialog.text = "Скажите, вы не кто ин"+ GetSexPhrase("ой","ая") +", как вестов"+ GetSexPhrase("ой","ая") +" генерал-губернатора Кюрасао?";
            ...
            {
    			dialog.text = "А, вот и ты, наконец...";
    			link.l1 = "Вы хотели меня видеть? Кто вы?";
    			link.l1.go = "Step_H7_4";
            }
            if (pchar.questTemp.State == "DelivLettTortuga_NotFoundLetter")
            {
    			dialog.text = "Проклятье! Не думал снова увидеть тебя, да ещё так быстро...";
    			link.l1 = "Здравствуй, Антонио. Давай продолжим нашу занимательную беседу. Только теперь все будет проходить по моим правилам.";
            ...
            if (npchar.id == "Chumakeiro" && pchar.questTemp.State == "SeekBible_toAaron")
            {
    			...
    			link.l1 = "Минхер, я откомандирован"+ GetSexPhrase("","а") +" в ваше распоряжение Петером Стэвезантом.";
            ...
            {
    			dialog.text = "С нетерпением ожидаю вашего доклада о поисках.";
    			link.l1 = "Минхер, мне удалось выяснить, кто продавал искомую христианскую книгу. Этого флибустьера зовут Лоран де Граф. Вернее, звали, так как он погиб. Когда я добрал"+ GetSexPhrase("ся","ась") +" до него у берегов Картахены, он вёл бой с очень мощной испанской эскадрой. Мне не удалось спасти его фрегат, сам Лоран утонул вместе с кораблём. Боюсь, что это все, книгу найти теперь просто невозможно.";
    			link.l1.go = "Step_H8_12";
            }
            if (npchar.id == "Chumakeiro" && pchar.questTemp.State == "SeekBible_DeGrafDieHard")
            {
    			dialog.text = "С нетерпением ожидаю вашего доклада о поисках.";
    			link.l1 = "Минхер, мне удалось выяснить, кто продавал искомую христианскую книгу. Этого флибустьера зовут Лоран де Граф. Когда я наш"+ GetSexPhrase("ел","ла") +" его близ Картахены, он вёл бой с очень мощной испанской эскадрой. Я не смог"+ GetSexPhrase("","ла") +" ничем помочь де Графу, силы были слишком неравны. Мне пришлось покинуть поле боя.";
    			link.l1.go = "Step_H8_12";
            }
...
//********************************* Дилоги бандитов, грабящих Аарона. Квест №1 **********************************
		...
		break;
 		case "Step_H1_3":
			dialog.text = "Это я.";
			link.l1 = "Меня прислал за вами Петер Стэвезант, я долж"+ GetSexPhrase("ен","на") +" доставить вас в Кюрасао. А что делали в вашем доме эти неучтивые люди?";
		...
		break;
 		case "Step_H1_4":
			...
			link.l1 = "Ну что же, все хорошо, что хорошо кончается. Собирайтесь и добро пожаловать на борт моего парусника. Стэвезант ждёт вас, выходим немедленно.";
			link.l1.go = "Step_H1_5";
		break;
 		case "Step_H1_5":
            AddQuestRecord("Hol_Line_1_Chumakeiro", "2");
			AddQuestUserData("Hol_Line_1_Chumakeiro", "sSex", GetSexPhrase("ел","ла"));
...
//********************************* Дилоги лейтенанта в тюрьме. Квест №3 **********************************
 		case "Step_H3_1":
			dialog.text = "Ух ты, да это же здорово! Чему обязан за такое внимание к моей персоне и такое участие в моей судьбе?";
			link.l1 = "Мне нужно кое-что узнать от вас.";
			link.l1.go = "Step_H3_2";
		break;
 		case "Step_H3_2":
			dialog.text = "Весь к вашим услугам. Только сначала давайте выберем более умиротворённое место для столь занимательной беседы.";
			link.l1 = "Я обещаю, что выпущу тебя на свободу. Но сначала я долж"+ GetSexPhrase("ен","на") +" получить необходимую мне информацию. Я хочу знать, куда Мэдифорд готовит высадку десанта.";
			link.l1.go = "Step_H3_3";
		break;
 		case "Step_H3_3":
			dialog.text = "Будет взят и уничтожен голландский Форт Оранж.";
			link.l1 = "Чёрт возьми, все указывало именно на это! Я держу своё слово: ты свободен и можешь идти куда угодно. Прощай.";
...
//********************************* Базар с незнакомцем на Тортуге. Квест №7 **********************************
  		case "Step_H7_1":
			dialog.text = "В таверне вас ждёт доверенное лицо Стэвезанта.";
		...
		break;
        case "Step_H7_7":
			dialog.text = "Хм... Знаешь, в данный конкретный момент мои конечности очень мне дороги. Так что задавай свои вопросы, я всё скажу.";
			link.l1 = "Вопрос номер один: кто ты и что делал на Тортуге?";
			link.l1.go = "Step_H7_8";
		break;
        case "Step_H7_8":
			dialog.text = "Меня зовут Антонио де Баррас, я испанский агент. На Тортуге я не ждал именно тебя, просто караулил посыльного от Стэвезанта. Определить голландский корабль, входящий в порт, не сложно. Ну а когда ты прямиком направил"+ GetSexPhrase("ся","ась") +" к д'Ожерону, все стало ясно.";
			link.l1 = "Хорошо... Вопрос номер два: где депеша?";
			link.l1.go = "Step_H7_9";
		break;
        case "Step_H7_9":
			dialog.text = "Она у меня. Пожалуйста, забирай...";
			link.l1 = "Очень хорошо, я рад"+ GetSexPhrase("","а") +" за твои пальцы... Ну и хватит на этом, остальное - в Виллемстаде. Я надеюсь, вы окажите мне любезность, сеньор Антонио, посетить сей славный голландский город?";
			link.l1.go = "Step_H7_10";
            GiveItem2Character(pchar,"letter_1");
		break;
        case "Step_H7_10":
			dialog.text = "Боюсь, что в данном конкретном случае моё желание в учёт принято не будет...";
...
//********************************* Поиски Библии. Квест №8 **********************************
        case "Step_H8_1":
			...
			link.l1 = "О каких поисках идёт речь? Стэвезант ничего конкретного не сказал...";
			link.l1.go = "Step_H8_2";
		break;
        case "Step_H8_2":
			dialog.text = "Все верно, "+ GetSexPhrase("друг мой","" + pchar.name + "") +"
. Но давайте по порядку.\n"+
                          "Первым приверженцем учения Янсения, бежавшим из Европы в Кюрасао около двадцати лет назад, был некто Самуэль Кохэно. Он был очень богатым человеком, и однажды ему удалось через посредников выкупить за баснословные деньги в самой канцелярии Инквизиции в Севилье один очень и очень таинственный документ. Речь идёт об ещё одном Евангелии.\n"+
        ...
        case "Step_H8_4":
			dialog.text = "Дело в том, что Библию не написали сразу же после Воскресения Христа. Прошло достаточно много времени, прежде чем окрепшая церковь озаботилась необходимостью сбора и классификации христианского материала, дабы привести веру к единым догмам.\n"+
                          "Вот тогда-то и произошла детальная ревизия всего, что находилось в то время в руках церкви. Когда сбор и анализ информации был проведён, оказалось, что некоторые вещи прямо противоречат друг другу. Тогда был проведён церковный собор на самом высоком уровне, где и принимались решения относительно того, можно ли считать тот или иной документ истинным.";
        ...
        case "Step_H8_11":
			...
			link.l1 = "Эта обнадёживающая новость, несомненно, придаст мне рвения. До встречи, Аарон, я немедленно приступаю к поискам.";
			link.l1.go = "exit";
		...
		break;
        case "Step_H8_16":
			dialog.text = "Бренное существование человечества на этой земле - трагедия людей. Но скоро все придёт в норму, к тому, с чего началось...";
			link.l1 = "Вы это серьёзно? Проклятье, испортили мне все настроение от получения такой значительной суммы. Ну да ладно... Вы, пожалуй, ожидайте развязки своей трагедии, а я займусь более прозаичными вещами - суетой сует. С такой суммой в кармане эта моя личная трагедия существования доставит мне очень много приятных минут.";
