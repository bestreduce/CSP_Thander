...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "Next_1":
            ...
            dialog.text = "Сеньоры, а не сеньориты. Я - хозяйка этого дома, " + GetFullName(npchar) + ". Зачем вы забрались в мои покои?";
		...
		case "Next_2":
			NextDiag.TempNode = "Next_2";
            dialog.text = "Вы ещё здесь? Оставьте меня в покое!";
		...
		case "Next_5":
            ...
            link.l1 = "Просто бесподобно! У вас такой утончённый вкус!";
			link.l1.go = "Next_8";
		...
		case "Next_9":
		    NextDiag.TempNode = "Next_2";
            dialog.text = "По-моему, вы просто неотёсанный болван!";
		...
		case "Good_1":
            ...
            link.l1 = "Просто зашёл поприветствовать вас, прекрасная "+Npchar.Name+".";
			link.l1.go = "exit";
		...
		case "TalkInShop_4":
            dialog.text = "Я пришла узнать, почему сегодня нам не принесли продукты, как было условлено. Я была уверена, что мой супруг заплатил за них, но, видимо, он позабыл. Оказалось, что у нас долг за целый месяц. У меня нет с собой 1200 золотых. Я сказала, что принесу их позже, а сеньор " +
		...
		case "TalkInShop_5":
            ...
            link.l1 = "Пустое, сеньора Изабелла. Я сполна вознаграждён тем, что имел счастье увидиться с вами.";
		...
		case "TalkInChurch":
            ...
            link.l1 = "'Пять ран Христовых'? Такому грешнику, как я, никогда не пришло бы в голову назвать свою посудину столь благочестивым именем. Впрочем, ради прекрасной сеньоры я готов сменить не только имя корабля, но и своё собственное.";
		...
		case "TalkInChurch_2":
            dialog.text = "Я помню, вы тоже капитан, правда? Бриг 'Пять ран Христовых' должен был ещё вчера бросить якорь в гавани Сан-Хуана. Может быть, недавний шторм застал его на пути из Куманы?";
		...
		case "Brother_1":
            ...
            link.l1 = "Изабелла! Если бы не этот храбрый капитан, то я долго ещё не смог бы добраться до Сан-Хуана. Ужасные штормы бушевали вокруг Куманы подобно демонам. Я принёс ужасную весть - наш отец умер, Изабелла! Он был вынужден продать родовое поместье, чтобы оплатить твои векселя. Для него это была настоящая трагедия, и его сердце не вынесло этого!";
			link.l1.go = "Brother_2";
		break;
		case "Brother_2":
            dialog.text = "Но, Мигель! Но я не выдавала никаких векселей! Это какое-то трагическое недоразумение!";
            link.l1 = "Сестра, ты ещё не поблагодарила нашего замечательного капитана за столь любезно оказанную нам услугу. Полагаю, мы сможем выяснить наши семейные вопросы позже.";
			link.l1.go = "exit";
		...
		break;
		case "BrigAbordage_2":
            dialog.text = "Мой брат мёртв, а вы сбежали! Я не желаю слушать ваших оправданий!";
			if (CheckCharacterItem(pchar, "Order"))
			{
				link.l1 = "Мне ни к чему оправдываться, ибо я сам видел, как Сальватор заколол вашего брата. Мигель выяснил, что именно Сальватор подделал векселя, убившие вашего отца. Он собирался доложить об этом властям, и тогда Сальватор убил его. Я нашёл фальшивые векселя на теле вашего брата. Они залиты кровью дона Мигеля, но вполне читаемы. Вот они, взгляните...";
				link.l1.go = "BrigAbordage_8";
			}
			else
			{
				link.l1 = "Мне не к чему оправдываться, ибо я сам видел, как Сальватор зарезал вашего брата. Ваш брат выяснил, что именно Сальватор подделал векселя, убившие вашего отца. Дон Мигель собирался доложить об этом губернатору и тогда Сальватор убил его. Он пытался убить и меня, чтобы сокрыть своё преступление. Вы всё равно бы мне не поверили, и я решил покинуть город на время.";
				link.l1.go = "BrigAbordage_3";
			}
		break;
		// --> нету поддельных векселей в наличие
		case "BrigAbordage_3":
            dialog.text = "Вы, капитан, не только кровавый убийца, но ещё и грязный лжец! Чем вы можете подтвердить правоту ваших слов?";
		...
		case "BrigAbordage_5":
            ...
            link.l1 = "Сеньора Изабелла, у нас нет времени на разговоры, корабль скоро пойдёт ко дну. Я предлагаю продолжить эту беседу у меня на судне.";
		...
		case "BrigAbordage_11":
            ...
            link.l1 = "Конечно, сеньора. Но позвольте мне, раз мы рядом с Порто Белло, посетить этот город. Попытаюсь разыскать там Сальватора, ведь он ждёт вашего прибытия.";
		...
		case "BelizTalk":
            ...
            link.l1 = "Сеньора, я выполнил вашу просьбу. Роситу я уже известил о вашем прибытии, она ждёт вас. К тому же я осмотрел дом и узнал у вашей кузины, что Сальватор не появлялся в округе.";
		...
		case "BelizTalk_4":
            ...
            link.l1 = "Я просто счастлив, чёрт возьми, и готов прыгать от радости, как мальчишка! Ох, простите меня, сеньора, за крепкое словцо - вырвалось...";
		...
		case "BelizTalk_6":
            ...
            link.l1 = "Не знаю, чётких зацепок нет, Сальватор постоянно в движении. Но у меня есть один наш общий знакомый - пират по имени Атилла. Сальватор здорово ему задолжал...";
		...
		case "IsabellaInCave":
            ...
            link.l1 = "Изабелла, вы живы! Слава Господу! В джунглях я нашёл мёртвую девушку, по всей видимости, это служанка, с которой вчера вы покинули дом Роситы.";
			link.l1.go = "IsabellaInCave_1";
		break;
		case "IsabellaInCave_1":
            dialog.text = "Бедная Канчита, Сальватор убил её!";
            link.l1 = "Мерзавец! Расскажите мне быстро, Изабелла, что произошло?";
			link.l1.go = "IsabellaInCave_2";
		break;
		case "IsabellaInCave_2":
            dialog.text = pchar.name + ", мой муж - исчадие ада! Должна признатся, что я поступала очень опрометчиво - ежедневно выходила на прогулку за город. Вчера Сальватор с ещё одним бандитом напали на нас, и этот убийца, не медля ни секунды, ударил Канчиту ножом. Боже мой!..";
		...
		case "IsabellaInCave_6":
            dialog.text = "Он ушёл в город, но скоро обещал вернуться с жаровней.";
		...
		case "IsabellaInCave_7":
            ...
            link.l1 = "Чёрт возьми! Я действительно появился здесь вовремя...";
			link.l1.go = "exit";
			LAi_SetActorType(npchar);
		...
		case "SalvatorIsDead_5":
            ...
            link.l1 = "Сеньора, это серьёзный шаг для меня. Я зарабатываю этим на жизнь. Но ради вас я готов на все... Я согласен, Изабелла!";
		...
		case "RositaHouse":
            ...
            link.l1 = "Хорошо, Изабелла. Но вы уверены, что доберётесь сами без проблем?";
		...
		case "InSanJuanAgain":
            ...
            link.l1 = "Да, сеньора Изабелла. Всё в порядке?";
		...
		case "InSanJuanAgain_after":
			dialog.text = NPCStringReactionRepeat("До свадьбы вам тут делать нечего...", "Сеньор, будьте благоразумны! До свадьбы - нельзя!", "Нет, нет и ещё раз нет!",
		...
		case "Cancel_Widding":
            dialog.text = "Как вы посмели не явиться в церковь на венчание?! Я отдала вам свою любовь, а вы так жестоко и бездарно её растоптали!";
            link.l1 = "Изабелла...";
			link.l1.go = "exit";
		...
		case "IsabellaIsMyWife_3":
			...
			{
				link.l1 = "Хорошо, Изабелла, я всё сделаю...";
		...
		case "NewLife_firstTime":
			rColony = GetColonyByIndex(FindColony("SanJuan"));
			dialog.text = "Ах, дорогой, как хорошо, что ты наконец-то пришёл домой! Уладил все вопросы с происшествием в церкви?";
			if (sti(rColony.HeroOwn))
			{
				dialog.text = "Ах, дорогой, как хорошо, что ты наконец-то пришёл домой! Всё в порядке?";
				link.l1 = "Да, дорогая, все нормально...";
			}
			else
			{
				dialog.text = "Ах, дорогой, как хорошо, что ты наконец-то пришёл домой! Уладил все вопросы с происшествием в церкви?";
				link.l1 = "Да, дорогая, я был на приёме у губернатора. Всё в порядке - он нас поздравляет.";
			}
		...
		case "NewLife_firstTime_2":
			dialog.text = "И я тебя тоже, дорогой. Но семья - это не только любовь, это ещё и совместный быт. Таким образом, помимо взаимной любви, у нас есть ещё как минимум два принципа, по которым должна жить наша семья.";
			link.l1 = "Изабелла, я восхищён твоим благоразумием! Но, может быть, мы пока остановимся на первом принципе и претворим его в жизнь немедленно?";
			link.l1.go = "NewLife_firstTime_3";
		break;
		case "NewLife_firstTime_3":
			dialog.text = "Дорогой, всему своё время, не будь слишком настойчив! Давай сначала обсудим оставшиеся два, ты не против?..";
		...
		case "NewLife_firstTime_4":
			dialog.text = "Милый, я тебя обожаю... Итак, принцип номер два - финансы. Мы должны определить семейный бюджет. Твоим домом был корабль, но теперь твой дом здесь, и ты должен понимать, что обладание недвижимостью - это определённое финансовое бремя, то есть городские налоги.\n"+
		...
		case "NewLife_firstTime_6":
			dialog.text = "Третий принцип - это твоё обещание бросить каперство. Обеспечивай семью другим способом, не надо топить корабли и захватывать города - Господь нам этого не простит...";
...
//************************************ новая жизнь бывшего корсара ********************************
		case "NewLife_hello":
			...
			if (GetQuestPastDayParam("RomanticQuest") > 3 && pchar.RomanticQuest == "OpenTheDoosOfHouse")
			{
				...
				link.l1 = "Изабелла, я всё понимаю, но и ты пойми меня - я моряк!";
		...
		case "NewLife_hello_1":
			...
			link.l1 = RandPhraseSimple("Изабелла, я понимаю... Ты уж извини, что пришлось оставить тебя одну надолго.", "Прости меня, что тебе пришлось остаться одной надолго, я всё понимаю...");
			link.l1.go = "NewLife";
		...
		case "NewLife":
			...
			if (CheckAttribute(pchar, "RomanticQuest.Cheking.AbordShip") && pchar.RomanticQuest.Cheking != "Ok")
			{
				...
				{
					dialog.text = RandPhraseSimple("До меня дошли ужасные слухи, что ты берёшь на абордаж корабли. Это правда?", "Слушай, тут ходят слухи, что ты опять взялся за старое - берёшь на абордаж и грабишь корабли. Правда ли это?");
					link.l1 = LinkRandPhrase("Ну что ты, дорогая, это клевета!", "Дорогая, это ничего такого я не делал.", "Нет, милая, это неправда, я же обещал!");
					link.l1.go = "NewLife_KnowPirates";
			...
			link.l3 = "Дорогая, я принёс тебе подарок.";
		...
		case "NewLife_Budget":
			...
			if (iMoney > -(MOD_SKILL_ENEMY_RATE*10000)) //деньги на исходе
			{
				...
				else
				{
					...
					link.l1 = RandPhraseSimple("Ну, придёт время - будем решать...", "Мне сейчас не до этого, расходуй то, что есть...");
					link.l1.go = "NewLife";
				}
				link.l2 = RandPhraseSimple("Ну что же, тогда подкинем тебе пиастров, дорогуша!", "Нужно срочно пополнить бюджет, давай этим и займёмся!");
				link.l2.go = "NewLife_Budget_Add";
				LAi_CharacterPlaySound(npchar, "Gr_Isabella_4");
			}
			else //профицит
			{
				dialog.text = RandPhraseSimple("Никаких проблем, дорогой, денег пока хватает - " + FindRussianMoneyString(-iMoney) + " ещё у меня есть.", "Все нормально, милый, денег в нашем бюджете достаточно - " + FindRussianMoneyString(-iMoney) + ".");
				link.l1 = RandPhraseSimple("Ну что же, это радует.", "Прекрасно, дорогая, очень хорошо!");
				link.l1.go = "NewLife";
				link.l2 = "Хочу ещё оставить тебе денег, чтобы ты ни в чём не нуждалась.";
				link.l2.go = "NewLife_Budget_Add";
			}
		break;
		case "NewLife_Budget_Add":
            dialog.text = NPCStringReactionRepeat("Хорошо, дорогой. Сколько денег ты хочешь мне оставить?", "Зачем ты хочешь мне что-то оставить уже второй раз на дню - не пойму... Так сколько ты хочешь оставить?", "Ты что, издеваешься надо мной? Третий раз на дню ты хочешь дать мне денег! Сразу все нельзя решить?", "Ну всё, ты мне надоел - зануда нестерпимый! Не буду больше с тобой разговаривать!", "repeat", 10, npchar, Dialog.CurrentNode);
		...
		case "NewLife_Budget_Pay":
			...
			dialog.text = NPCStringReactionRepeat("Верно, капитан " + pchar.lastname + ", вы изрядно запустили это дело! Так что извольте погасить задолженность!",
				...
				"Капитан, я устала повторять одно и то же. Я все говорю, говорю, а воз финансовых проблем и ныне там. Вот что я вам скажу, муженёк: я и сама в состоянии справится с проблемами! Ну, а вас я видеть не желаю!", "quest", 30, npchar, Dialog.CurrentNode);
			if (sti(pchar.money) >= iMoney)
			{
				link.l1 = HeroStringReactionRepeat("Хорошо, дорогая, я готов погасить задолженность.", "И я их нашёл, Изабелла! Я готов рассчитаться с долгами!", "Изабелла, дорогая, я всё прекрасно помню. Я нашёл деньги и готов закрыть долги.", "Изабелла, как раз сейчас...", npchar, Dialog.CurrentNode);
			...
			{
				link.l1 = HeroStringReactionRepeat("Послушай, дорогуша, у меня нет сейчас " + FindRussianMoneyString(iMoney) + "...", "Должен был, но не нашёл...", "Изабелла, нет у меня сейчас денег!", "Вот, значит как?..", npchar, Dialog.CurrentNode);
				link.l1.go = "NewLife_Budget_Pay_1";
			}
		break;
		case "NewLife_Budget_Pay_1":
			dialog.text = RandPhraseSimple("Так идите и найдите! Я не собираюсь из-за вас попадать в долговую яму!", "Послушайте меня, муженёк! Я не желаю, чтобы ко мне в дом через день заходил судебный исполнитель и требовал выплат задолженностей! Разыщите деньги, это ваша прямая обязанность!");
		...
		case "NewLife_Budget_Pay_2":
			...
			link.l1 = RandPhraseSimple("Да уж...", "Хех, ещё бы!");
			link.l1.go = "NewLife";
			iMoney = IsabellaCheckBudgetMoney();
		...
		case "NewLife_Sex_1":
			...
			dialog.text = "Я бы на твоём месте, дорогой, не отлучалась так надолго из дома...";
			link.l1 = "Это почему?";
			link.l1.go = "NewLife_Sex_2";
		break;
		case "NewLife_Sex_2":
			dialog.text = "Потому, что жена у тебя - красивая женщина, если ты этого раньше не замечал. А в Сан-Хуане не один женщины живут, есть ещё много интересных кабальеро...";
		...
		case "NewLife_Sex_5":
			if (GetNpcQuestPastDayParam(npchar, "sex") > 3)
			{
				...
				link.l1 = HeroStringReactionRepeat("Изабелла, я сгораю от страсти!!",
					...
					"Ну какие это глупости, Изабелла?! Давай быстренько пойдём в спальню, дорогая?..", npchar, Dialog.CurrentNode);
		...
		case "NewLife_Sex_11":
			...
			else //не свезло
			{
				...
				link.l1 = RandPhraseSimple("Эх, как не вовремя!..", "Чёрт!.. Прости, Изабелла, вырвалось...");
				link.l1.go = "NewLife_exit";
			}
		break;
		case "NewLife_Sex_12":
		...
		case "NewLife_Sex_13":
			...
			{
				dialog.text = "Никуда мы не пройдём! И впредь не позволяй себе вульгарных фраз!";
		...
		case "NewLife_Sleep_day":
			...
			link.l1 = "Ну, здорово. Тогда я пошёл в спальню...";
		...
		case "NewLife_Sleep_night":
			...
			link.l1 = "Отлично, дорогая. Тогда я пошёл в спальню...";
		...
		case "NewLife_JustTalk":
			...
			{
				case 0:
					dialog.text = LinkRandPhrase("Ах, дорогой, как мне приятно твоё внимание...", pchar.name + ", ты настоящий рыцарь...", "Ах, Господи, какое счастье, что ты послал мне в мужья " + GetMainCharacterNameGen() + "...");
				...
				case 1:
					...
					link.l1 = RandPhraseSimple("Да всё в порядке, так ему и скажи в следующий раз.", "Не сказал бы, что мне льстит внимание губернатора к тебе...");
					link.l1.go = "NewLife_exit";
				break;
			}
		break;
		...
		case "NewLife_Present":
			...
			if (iTemp == 1)
			{
				dialog.text = NPCStringReactionRepeat("И что ты хочешь подарить мне, дорогой?",
					...
					"Ну всё, ты меня достал, тупица! Я сердита на тебя и не желаю с тобой разговаривать!", "repeat", 20, npchar, Dialog.CurrentNode);
				link.l1 = HeroStringReactionRepeat("Да ничего такого...",
					"Ничего, достойного тебя у меня нет, извини...",
					"Изабелла, я опять ничего не нашёл для тебя, прости...",
...
// ======================== блок нод angry ===============>>>>>>>>>>>>>>>
		...
		case "AngryRepeat_Budget_Add":
            dialog.text = RandPhraseSimple("Я не желаю говорить с таким занудой! Разве что серебряное и золотое колечко с сапфирами растопят моё сердце...", "Не хочу разговаривать, я обиделась на тебя, зануду и скрягу! Вообще, я хочу серебряное и золотое кольцо с сапфирами...");
			link.l1 = "Эх, Изабелла...";
            ...
            if (CheckAttribute(npchar, "angry.terms")) //примиряемся 10 дней.
            {
                ...
                {
         			dialog.text = "Ну, хорошо, муженёк, я согласна с тобой общаться. Но не будь таким скрягой! И тем более, не обещай ничего, когда денег нет!";
				...
				else //примирение через кольцо с сапфиром
				{
					...
					{
         				dialog.text = "Ах, ты принёс мне то, что я хотела - золотое и серебряное кольца с сапфиром! Хм, ты знаешь, как мне угодить... Ну хорошо, я готова с тобой общаться...";
		...
		case "AngryRepeat_Budget_Pay":
            dialog.text = RandPhraseSimple("Послушайте, муженёк, вы не способны обеспечить существование жены, мне пришлось самой решать наши финансовые проблемы. Это никуда не годится!", "Подумать только, я сама должна решать все вопросы в семье! Ваша неспособность обеспечить семью меня поражает!");
            ...
            if (CheckAttribute(npchar, "angry.terms")) //примиряемся 30 дней.
            {
				...
				else //примирение через изумруды
				{
					...
					{
         				dialog.text = "Ах ты негодник! Ты принёс мне украшения с изумрудами... Обожаю эти камни, они так мне нравятся!.. Ну хорошо, я согласна на примирение, но всю образовавшуюся задолженность тебе нужно погасить!";
		...
		case "AngryRepeat_KnowPirates":
            dialog.text = RandPhraseSimple("Вы нарушили своё слово, данное мне перед свадьбой! Я не желаю вас видеть!", "Ты же обещал, что с каперством покончено, а сам и не думал прекращать проливать кровь невинных!");
            ...
            if (CheckAttribute(npchar, "angry.terms")) //примиряемся 80 дней.
            {
                if (GetNpcQuestPastDayParam(npchar, "angry.terms") > sti(npchar.angry.terms))
                {
         			dialog.text = "Вот что, супруг! Я готова к примирению, но ты должен впредь держать своё слово!";
				...
				else //примирение через алмаз, рубины и большую жемчужину
				{
					...
					{
         				dialog.text = "Ох, " + pchar.name + ", ты знаешь, как сделать, чтобы я не сердилась... Но ты должен держать своё слово и покончить с каперством!";
            ...
            if (CheckAttribute(npchar, "angry.terms")) //примиряемся 20 дней.
            {
				...
				else //примирение через злато-серебро
				{
					if (CheckCharacterItem(pchar, "jewelry5") && CheckCharacterItem(pchar, "jewelry17"))
					{
						...
						{
         					dialog.text = "Ну надо же!.. Ты принёс единственное, что я сейчас действительно хочу - золотые и серебряные слитки... Ну хорошо, я готова возобновить общение. Но только чтобы не было повторений этого издевательства с подарками!!";
