...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ShipToDomingoTavenr_2":
			dialog.text = "Он самый, сеньор.  Проклятый шторм!  Мой бриг ещё долго не выйдет в море.  Каррамба!  А я, как на грех, взял пассажира.  Уж как он ругается, Матерь Божья!\n"+
				          "Обещает шкуру с меня спустить, да ведь я своим задом все одно всех щелей в днище не заткну.  Позарез ему надо в Сан-Хуан, а ни одно судно туда не идёт. Сеньор благородный, знатный, рад бы ему услужить, да не могу!";
		...
		case "Romantic_Brother_Thanks":
			...
			link.l1 = "Не берите в голову, Мигель. Всё в порядке. Главное, чтобы ваша сестра была счастлива...";
			link.l1.go = "Step_3";
		break;
		case "Step_3":
		...
		case "ArrestInHome_5":
			dialog.text = "Простите, но я не мог знать, что это вы. Ещё раз сожалею...";
		...
		case "BrigAbordage":
			dialog.text = "Проклятье! Какого чёрта ты напал на мой корабль?!!";
		...
		break;
		case "BrigAbordage_3":
			dialog.text = "Ну, это мы ещё посмотрим, кто кого прикончит...";
		...
		case "AmbushPotroBello_6":
			dialog.text = "Это ж надо было так лопухнуться! Ну всё, приятель, тебе пора на тот свет...";
		...
		case "Rosita":
			dialog.text = "Приветствую вас в моём доме, сеньор. Кто вы?";
			link.l1 = "Здравствуйте, сеньора. Меня зовут капитан " + GetFullName(pchar) + ", полагаю, моё имя вам ничего не скажет.";
			link.l1.go = "Rosita_1";
		break;
		case "Rosita_1":
			dialog.text = "Да, оно мне не известно. Так чему я обязана чести видеть вас в моём доме?";
			link.l1 = "Сеньора, я действую по поручению вашей кузины - Изабеллы Олеварес.";
			link.l1.go = "Rosita_2";
		break;
		case "Rosita_2":
			dialog.text = "Продолжайте, сеньор.";
			link.l1 = "Сеньора Изабелла изъявила желание прибыть к вам, и я с удовольствием исполнил эту её просьбу.";
			link.l1.go = "Rosita_3";
		break;
		case "Rosita_3":
			dialog.text = "Господи, капитан, неужели вы привезли сюда Изабеллу живой и невредимой?!";
			link.l1 = "Именно так, сеньора. Она на моём корабле и сейчас готовится сойти на берег.";
			link.l1.go = "Rosita_4";
		break;
		case "Rosita_4":
		...
		case "Rosita_5":
			...
			link.l1 = "Полагаю, лучше будет, если сама Изабелла все вам расскажет. Я убедился, что ваш дом для Изабеллы безопасен и сейчас отправлю её к вам. Берегите её, сеньора, ей здорово досталось за последнее время...";
			link.l1.go = "Rosita_6";
		break;
		case "Rosita_6":
		...
		break;
		case "BackRosita_2":
			dialog.text = "Вчера утром она отправилась на рынок со служанкой, и с тех пор её никто не видел!";
		...
		case "IsabellaIsDead_Beliz_1":
			dialog.text = "Поверить не могу... Она так на вас надеялась! Упокой Господь её душу...";
		...
		case "SavedIsabella_2":
			...
			link.l1 = "Росита, меня похитил Сальватор. А Канчита мертва - её убил мой муж...";
		...
		case "IsabellaIsDead":
			...
			link.l1 = "Новости хуже некуда, Росита. Изабелла мертва, её убили в церкви прямо на алтаре. Нападавших было слишком много...";
		...
		case "IsabellaIsDead_1":
			dialog.text = "О, Господи, бедная Изабелла!! Она так страдала, ей так не повезло с мужем.\n"+
				          "Потом появились вы и я подумала, что её судьба наконец-то изменилась к лучшему. Но от судьбы, видимо, не уйдешь...";
		...
		break;
		case "HorseCheck_2":
			dialog.text = "А вы не знаете? Ну тогда я вам скажу, в чём дело.";
		...
		case "HorseCheck_3":
			...
			link.l1 = "Чёрт!! А кто ей сказал? Меня оговорили!";
