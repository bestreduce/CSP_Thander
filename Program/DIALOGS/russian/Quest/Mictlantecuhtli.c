...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "InGreateTemple_1":
			dialog.text = "Это так\nЯ давно наблюдаю за тобой, твоё рысканье по Теночтитлану занимало меня. Но сейчас ты взял"+ GetSexPhrase("","а") +" предмет моего культа, и это уже не смешно...";
		...
		case "InGreateTemple_3":
			dialog.text = "Сразиться со мной. Начнём!";
		...
		break;
		case "WinInTemple_2":
			dialog.text = "Прежде чем ты уйдёшь, я хочу рассказать тебе, кто такой Монтесума.";
		...
		case "WinInTemple_4":
			dialog.text = "Боги живут только тогда, когда им поклоняются люди. Если богов забывают, то им приходится уйти в лимб, мир забвения. Я остался на Земле только потому, что теперь мне принадлежит весь народ ацтеков, ибо все ацтеки были истреблены испанцами, оставшись без нашей помощи.\n"+
				"Я обладаю властью заставлять мёртвые тела жить новой жизнью. Став хозяином Теночтитлана, я поднимаю нужных мне усопших для несения службы.\n"+
				"Монтесума же проклят, ему закрыт ход в царство мёртвых, и он принуждён вечно ходить по берегам озера Тескоко и скорбеть по участи своего народа.";
			link.l1 = "Так это призрак?!";
			link.l1.go = "WinInTemple_5";
		break;
		case "WinInTemple_5":
			dialog.text = "Можно и так сказать. Теперь ты знаешь, кто такой ацтек на берегу Тескоко. И знай, что нефритовый череп имеет власть над мёртвыми, а так же может помочь проклятым живым\nПрощай, воин.";
		...
		case "Uicilopochtli_F_1":
			dialog.text = "Что?! Да как ты смеешь! Я - Уицилопочтли, бог войны, самый могущественный воин среди людей и богов, и Миктлантекутли не сравниться со мной в силе и выносливости. Ты оскорбил" + GetSexPhrase("","a") + " меня, и за это тебя ждёт мучительная смерть. Готовься узреть каков Уицилопочтли в бою!";
			link.l1 = "А, чёрт...";
			link.l1.go = "Uicilopochtli_F_2";
		break;

		case "Uicilopochtli_F_2":
			dialog.text = "Ха-ха, да что ты задрожал" + GetSexPhrase("","a") + "-то так, пошутить нельзя что-ли? Ха-ха-ха! Успокойся, я не стану на тебя бросаться за то, что ты черепочек потрогал" + GetSexPhrase("","a") + ", ха-ха-ха!";
		...
		case "Uicilopochtli_F_4":
			dialog.text = "И не говори - ты бы " + GetSexPhrase("помер","померла") + " со скуки, ха-ха! А 'мёртвому богу' давно пора было нос утереть - таким уж напыщенным заделался после падения ацтеков... Пока все скучают в лимбе, он себе тут гуляет со своими игрушками и ни разу к нам не заглянул. Даже Миктлансиуатль не навещал, бедняжка совсем без мужского внимания осталась, представляешь? И ведь я ему предлагал: у тебя тут целая армия, говорю, давай между ними бойню устроим, повеселимся, кости разомнём? А он все нет и нет - видите ли, занят он, Теночтитлан охранять нужно. Ну вот и доохранялся, что ты " + GetSexPhrase("пришёл да всю его охрану порешил","пришла да всю его охрану порешила") + ", ха-ха!";
		...
		case "Uicilopochtli_F_6":
			...
			link.l1 = "Ага, значит ты можешь улучшить моё оружие?";
			link.l1.go = "Uicilopochtli_F_7";
		break;

		case "Uicilopochtli_F_7":
			dialog.text = "Да, могу, если совершишь ритуал. Ты же не думал"+ GetSexPhrase("","а") +", что это Миктлантекутли сделал макуауитли такими смертоносными? Но давай я сразу обозначу некоторые ограничения\nПервое - я не буду улучшать оружие сверх его инженерных возможностей. Я мог бы, но тогда оно бы превратилось в магическое оружие богов и... в общем, такой клинок в человеческих руках никогда до добра не доводил. Но я уверен, что ты всё равно сможешь почувствовать улучшение\nВторое - за один раз я могу улучшить лишь одну из характеристик - уменьшить вес или увеличить минимальный или максимальный урон. Выбирать характеристику и величину улучшения ты не сможешь - все таки, поклонение богу - это неточная наука. Но ты сможешь провести много ритуалов над одним и тем же клинком, и через некоторое их количество твоё оружие улучшится до идеального состояния.";
			link.l1 = "Звучит неплохо. А что на счёт жертв? Много пленных понадобится?";
			link.l1.go = "Uicilopochtli_F_8";
		break;

		case "Uicilopochtli_F_8":
			dialog.text = "Нет, не надо мне твоих пленных. Мне эти обычаи никогда не нравились. Вопли, визги - они хороши, если враг издаёт их в честной битве, а не когда привязан к алтарю. Я долго пытался объяснить ацтекам, что человеческие жертвы - это по части Миктлантекутли, но все без толку - уж очень любили они людей резать\nЖертва для ритуала должна состоять из двух частей. Первая - это оружие поверженных врагов. Для одного ритуала тебе понадобится три других клинка того же качества, что и твоё оружие. Вторая - это золото, в количестве, эквивалентном троекратной стоимости клинка. Оно мне и не нужно особо, это просто традиция такая, и без неё никак. Вот в твоём народе есть шаманы? Они небось без золота с тобой и разговаривать не станут, так?";
			link.l1 = "Хе-хе, да, тут не поспоришь.";
			link.l1.go = "Uicilopochtli_F_9";
		break;

		case "Uicilopochtli_F_9":
			dialog.text = "Вот и я пытаюсь не казаться белой вороной... В общем, собираешь это добро, кладёшь на алтарь, обращаешься ко мне - и, если все хорошо, я заберу жертву и улучшу экипированный тобой клинок. И не волнуйся, если что-то пойдёт не так - например, жертвы на алтаре будет недостаточно или твой клинок уже некуда будет улучшать - я жульничать не буду, скажу все как есть, и все что на алтаре - останется при тебе.";
		...
		case "Uicilopochtli_improve":
			...
			{
				dialog.text = "За дары спасибо, но дело в том, что твой клинок уже достиг своих пределов совершенства, так что улучшить его ещё сильнее я не могу, извини.";
			...
			{
				dialog.text = "Твоей жертвы недостаточно. Напоминаю, нужно три клинка эквивалентного твоему качества и золото в количестве, эквивалентном троекратной стоимости твоего клинка.";
		...
		case "Uicilopochtli_fan_2":
			...
			link.l1 = "Кажется, ещё чуть-чуть и мои мозги таки расплавятся... Ты можешь что-то с ним сделать?";
