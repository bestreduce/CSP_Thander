...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Octavio_1_1":
			...
			if (pchar.name == "Анжелика" && pchar.lastname == "Тич")
			{
				link.l1 = "Моё имя "+GetFullName(pchar)+" - я дочь известного пирата, Чёрной Бороды. А имя 'Ламбрини' мне ничего не говорит.";
				link.l1.go = "Octavio_1_2";
			}
		...
		case "Octavio_1_2":
			...
			if (pchar.name == "Анжелика" && pchar.lastname == "Тич")
			{
				dialog.text = "Родная кровь Эдварда Тича? Неплохо! Твой отец - великий человек, и если ты хоть вполовину так же хорош"+ GetSexPhrase("","а") +" как он, то можно и побеседовать. ";
			}
		...
		case "Octavio_1_7":
				dialog.text = "Это не столь важно. Убей его, приколоти к своему бушприту, скорми акулам, скорми англичанам, или подкупи его - это неважно. Но мы не можем игнорировать такой вкусный кусочек, как Маракайбо. Просто как-нибудь разделайся с этим парнем.";
			if (pchar.name == "Питер" && pchar.lastname == "Блад")
			{
			...
			if (pchar.name == "Анжелика" && pchar.lastname == "Тич")
			{
				dialog.text = "Это не столь важно. Убей его, приколоти к своему бушприту, скорми акулам, сожги на костре, или подкупи его - это неважно. Но мы не можем игнорировать такой вкусный кусочек, как Маракайбо. Другие контрабандисты избегают Маракайбо. Они боятся испанцев - и не без оснований. В тебе льётся кровь Эдварда Тича, если ты хоть вполовину также "+ GetSexPhrase("хитёр","хитра") +" как и он, то с этим парнем ты тем более легко разделаешься.";
			}
		...
		case "Octavio_1_9":
			dialog.text = "Йо-хо, "+ GetSexPhrase("мальчик","девочка") +"! Мало слов, много дела. Теперь я не дам и сантима за жизнь этого де Гальвеса. Иди - и возвращайся, когда позаботишься о нём.";
			if (pchar.name == "Питер" && pchar.lastname == "Блад")
			{
			...
			if (pchar.name == "Анжелика" && pchar.lastname == "Тич")
			{
				dialog.text = "Йо-хо, девочка! Говоришь, как истинная Чёрная Борода. Мало слов, много дела. Теперь я не дам и сантима за жизнь этого де Гальвеса. Иди - и возвращайся, когда позаботишься о нём.";
			}
			if (sti(pchar.reputation) > 80 || sti(pchar.reputation) < 20)
			{
...
//			PChar.quest.PDM_CL_Antonio_Ubit.win_condition = "PDM_CL_Antonio_Ubit";
		...
		case "Octavio_2_2":
			dialog.text = "Ха, "+ GetSexPhrase("мальчик","девочка") +"! Тебе следовало бы принести его голову в доказательство. Вот был бы славный сувенир. Но я верю тебе и так. Вот твои " + Plata1 + ". И все мои проблемы позади.";
			if (sti(pchar.reputation) > 80)
			{
			...
			if (pchar.name == "Анжелика" && pchar.lastname == "Тич")
			{
				dialog.text = "Ха, девочка! Тебе следовало бы принести его голову в доказательство. Вот был бы славный сувенир. Но я верю тебе и так - разумеется, ведь в тебе течёт кровь Чёрной Бороды, великого пирата. Вот твои " + Plata1 + ". И все мои проблемы позади.";
			}
		...
		case "Antonio_2_1":
			dialog.text = ""+TimeGreeting()+", сеньор"+ GetSexPhrase("","ита") +" "+pchar.name+", как всё прошло?";
			link.l1 = "Октавио Ламбрини поверил в вашу смерть, скорее всего он уже направляется сюда, в Маракайбо.";
		...
		case "Pokupatel_2_2":
			dialog.text = "Хочу продать то, что не купит ни один торговец на этом острове. В моём трюме лежит товар мечты! Горы сандала, только подумай, а.";
			link.l1 = "";
		...
		case "Pokupatel_2_4":
			npchar.lifeday = 0;
			dialog.text = "Я знаю, с тобой можно иметь дело. Мы будем ждать тебя в месте, называющемся бухта Гуахира.";
			link.l1 = "";
		...
		case "Pokupatel_2_6":
			dialog.text = "Я обязательно приду, пупсик.";
			link.l1 = "";
		...
		case "Antonio_5_1":
			dialog.text = "Сеньор"+ GetSexPhrase("","ита") +" "+pchar.name+", вы вернулись. Видели что-нибудь интересное?";
		...
		case "Antonio_5_3":
			dialog.text = "Отлично! Мы устроим облаву со стороны джунглей и застанем их врасплох.";
			link.l1 = "В путь!";
		...
		case "Antonio_8_2":
			...
			dialog.text = "Да, конечно, сеньор губернатор выделил вам " + Plata2 + " золотых. "+addPlata+"Я даю эти деньги вам лично в руки. До свидания!";
