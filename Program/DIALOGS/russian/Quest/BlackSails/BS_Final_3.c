...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_F3_21":	//Максин. Вариант с секасом.
			dialog.text = "Знаешь, мы через столько прошли уже вместе, а так и не познакомились поближе. Может, отложим на вечер все дела и проведём его за бутылкой хорошего вина?";
			link.l1 = "Заманчивое предложение! Только от вина меня воротит, если понимаешь о чем я. Как насчёт рома";
			link.l1.go = "BS_F3_22";
		break;
		...
		case "BS_F3_41":	//Вейн.
			...
			link.l1 = "Какого чёрта Чарьз? У нас же был уговор!";
			link.l1.go = "BS_F3_42";
		break;
		...
		//Запись в СЖ: "Где то на этом пути я сделал(ла) неправильный выбор. Какой момент стал поворотным? Элеонора, Джек, Чарльз. Как бы сложились их судьбы, прими я другие решения? Стал(ла) бы я бездушной машиной под руководством Флинта? Чёрт, как голова болит! Нужно отдохнуть".
