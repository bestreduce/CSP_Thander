...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "BS_NU_26":	//Флинт
            dialog.text = "Вполне. Но попрошу вас составить компанию, мисс Гатри, здесь на острове. А нам нужно готовить корабли и не медля выходить в море! Западное побережье Кюрасао - опасное внезапными шквалами место и течения там непредсказуемые, могу легко вынести ас и наш приз под пушки Виллемстада. Нужно внимательнее расчитать маршрут.";
            link.l1 = "";
