...
//Запись в СЖ: «’Рейнджер’ на якоре! Шлюпку на воду!»		AddQuestRecord("BSSevereHangover", "42");
		...
		break;
		case "BS_F2_25":
			dialog.text = "Высадился вчера с абордажной ротой и в джунгли ушёл. В посёлке шума навёл, чуть до драки дело не дошло, наши опасаются на берег сходить";
...
//Высаживаемся на берег, идём в поселение. У главы или бармена диалог
		...
		break;
		case "BS_F2_30":
			dialog.text = "Был один, с Вейном ушёл";
//Запись в СЖ: «Возможность последовать за Вейном я упустил(), без опытных проводников, соваться в джунгли – самоубийство. Что же, подожду тут»
			...
			link.l1 = "Чёрт. Остаётся только ждать. Бывай";
			link.l1.go = "exit";
		break;
...
//Если брать на абордаж «Скарборо» - капитан Френсис Ньюм, моделька офицера английского. Файт в каюте. Диалог
		case "BS_F2_48":	//Ньюм
			...
			link.l1 = "«Ха. Вас взяли на абордаж, капитан. Сами сдавайтесь! И какого чёрта вы атаковали нас? У нас же договор с коммандером Блэкхемом!";
			link.l1.go = "BS_F2_49";
		break;
		case "BS_F2_49":	//Ньюм
...
//Сурьёзный замес. Нулим НР Флинту – он скриптово стреляет, нас корчит, Флинт убегает.
		...
		case "BS_F2_58":	//ГГ себе
			dialog.text = "Чёрт, ребро сломано! Вейн, ты как, дружище? Рана серьёзная, он может истечь кровью";
...
//Бермуды. Резиденция закрыта. Идём в таверну.
		...
		case "BS_F2_60":	//бармен
			dialog.text = "Тут недавно английские военные высадились. Человек пятьсот и в бухте линейник «Скарборо» встал. Устроили тут, чёрт знает что. Мисс Гатри и ещё несколько человек арестовали. Капитан Ньюм орал, что их настигло правосудие, и суд в Порт Рояле будет скорым.";
...
//Выходим в море. Идём на Бермуды. Причалив, сразу ТП в резиденцию. Внутри Вейн, Бонс, ГГ
		...
		case "BS_F2_81":
			...
			dialog.text = "Чёрта с два я дам её повесить. Я сам её придушу, когда-нибудь!";
