...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_PN_9":	//Вейн
			dialog.text = "Какого чёрта? Это же люди Джекмана!";
			link.l1 = "...";
		...
		case "BS_PN_18":	//Флинт
			dialog.text = "Зашифрованная страница с маршрутом у нас, и Сильвер с Рекхэмом сейчас заняты расшифровкой. Нам нужно решить текущие проблемы. Англичане настойчиво лезут в наши дела, также бунт Джекмана.";
			link.l1 = "...";
