...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_KS_7_2":	//Обращаемся к матросу
            dialog.text = "Не моё это, капитан. Много ответственности, да и обязанностей. Я простой матрос и не хочу этого менять.";
		...
		case "BS_KS_9":
            ...
            link.l1 = "Ха. А ты забавный. Служил у меня кок, тоже любил шутейки пошутить разные.";
			link.l1.go = "BS_KS_10";
		break;

		case "BS_KS_10":
            dialog.text = "В любой команде нужен такой человек! И лямка моряцкая не такой тяжкой кажется тогда!";
			link.l1 = "Возможно. Да вот дошутился, нашли его с линьком вокруг шеи обмотанным. В трюме. И никто ни слухом, ни духом. Чего побледнел? Шучу я. Ха–ха.";
			link.l1.go = "BS_KS_11"
		break;

		case "BS_KS_11":
            dialog.text = "Ха-ха. Ладно, к делу. Раздобыл я часть судового журнала одного каботажника испанского. Как раздобыл и что я делал на испанском судне - это отдельная история. Если коротко, то мельком взглянув на бумаги, я смекнул, что там зашифрован маршрут какого то очень важного корабля, а шифрами всякими и загадками я ещё в монастыре увлекался, но это тоже отдельная история. Решил отметить находку в борделе, а там есть девица одна, Максин звать. Креолка из Луизианы. Хороша собой чертовка. Что в койке вытворяет... Слов нет описать. Но не только на передок умелица, но и с головой всё в порядке. Во всех смыслах. Обвела меня пьяного и утомлённого утехами как мальчика и увела страницу с шифровкой.";
		...
		case "BS_KS_14":
            dialog.text = "Да птички напели, что Макс у себя в гнёздышке, а Вейн корабль покрупнее ищет и команду набирает. Видать про 'Урку' байки тоже слышал.";
		...
		case "BS_KS_16":
            dialog.text = "Про постельные утехи в соответствующих местах интересуйтесь, "+ GetSexPhrase("месье","мадемуазель") +". У меня заведение приличное.";
            link.l1 = "Понимаю. Пятьсот пиастров поможет развязать твой язык?";
			link.l1.go = "BS_KS_17";
		break;
		...
		case "BS_KS_19":
            ...
            dialog.text = "Смилуйтесь! Ну, ещё я слышал, что она клиентов не принимает, пираты её сильно за что-то там попользовали. Говорят команда самого Вейна... Ага, прям вся команда. Так что ищи другую, тут девок на любой вкус хватает. Только, пожалуйста, разносчицу не трогай. Племяшка моя.";
		...
		case "BS_KS_20":
            ...
            link.l1 = "Я хочу провести время с одной из твоих красоток. По архипелагу ходят слухи про вашу креолку, Максин кажется её зовут? Вот и любопытствую.";
			link.l1.go = "BS_KS_21";
		break;

		case "BS_KS_21":
            dialog.text = "Она сейчас не в той форме, чтобы принимать клиентов. Но за десять тысяч мы можем сделать исключение.";
		...
		case "BS_KS_23":
            ...
            dialog.text = "Кто-то решил вступиться за бедную шлюху? Как неожиданно! Как я могу устоять? В полночь вся шайка Чарльза Вейна будет в подземелье, здесь в городе. Прошу, когда всё будет кончено, отвези меня в Порт Рояль?";
		...
		case "BS_KS_25":
            ...
            link.l1 = "Я заметил"+ GetSexPhrase("","а") +". Сиди здесь и охраняй нашу девочку Максин, потом проводишь её до бухты Ле Марен.";
			link.l1.go = "BS_KS_26";
		break;
		...
		case "BS_KS_31":
            dialog.text = "У кого это, 'у нас'? Уж не с Флинтом ли ты вместе?";
