...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_CPNG_24":	//Флинт
            ...
            link.l1 = "Ммм... Признаюсь, я слышал"+ GetSexPhrase("","а") +" слухи об этой плавучей крепости. Даже не слухи, а домыслы и байки про то, что этот галеон чуть ли не казну Эскориала возит. Да вот только если 'Золотой Флот' многие вживую видели, то 'Урку' - ниразу!";
		...
		case "BS_CPNG_31":
            dialog.text = "Я серьёзен как никогда! У меня есть только часть кода от зашифрованного маршрута! Остальное у капитана Вейна.";
            link.l1 = "";
