...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "AztecFT_1":
			dialog.text = "Мешитли.";
			link.l1 = "Ты здесь живёшь, Мешитли? А кто ещё кроме тебя здесь есть?";
		...
		case "AztecFT_3":
			...
			link.l1 = "Микт... Миктла... Эх, не могу выговорить! В общем, не тот ли это ваш бог, что мёртвых воскрешает?";
		...
		break;
		case "AztecFT_5":
			dialog.text = "Как обычно - кровь пленённых тобой воинов. Приводи их сюда, а потом иди с ними в жертвенный храм. Ты долж"+ GetSexPhrase("ен","на") +" вырезать сердце война, пока он ещё жив, и кровью окропить жертвенный камень Миктлантекутли.";
			link.l1 = "Что-то как-то я не очень этого желаю...";
			link.l1.go = "AztecFT_6";
		break;
		case "AztecFT_6":
			dialog.text = "А-а, ну тогда тебе удачи не видеть здесь. Миктлантекутли будет смотреть за тобой, и возьмёт тебя к себе.";
			link.l1 = "Ну, это мы ещё посморим... Это сколько же вы воинов в жертвы приносите? Я слышал"+ GetSexPhrase("","а") +", что богов у вас много...";
			link.l1.go = "AztecFT_7";
		break;
		case "AztecFT_7":
			dialog.text = "Раньше было много, а сейчас только Миктлантекутли служим. Мы с братом воинов не пленим и жертву не приносим, потому что Миктлантекутли обещал нам своё покровительство и жизнь после смерти. Так что мы в городе работаем по-мелочи, даже оружия не держим.";
		...
		break;
		case "AztecFT_8":
			dialog.text = "Ничего особенного. Храм Великой Жизненной Силы - самое большое строение. В пирамидах по обеим сторонам от него находятся храмы 10 богов. Храм Белых Богов - это пирамида с круглой башней, прямо напротив Храма Великой Жизненной Силы. Купальни ещё есть...";
			link.l1 = "Слушай, как бы мне пробраться в этот Великий Храм?";
			link.l1.go = "AztecFT_9";
		break;
		case "AztecFT_9":
			dialog.text = "Этого делать тебе не стоит. Мы с братом мешать не будем, но Миктлантекутли может запросто отправить за тобой своих воинов. Не говоря уже о том, что храмы охраняют его слуги - великие воины прошлого.";
			link.l1 = "Понятно... Ну что же, будь здоров, Мешитли. Пообщаюсь ещё с твоим братом при случае.";
		...
		case "AztecFT_10":
			...
			link.l1 = ""+ GetSexPhrase("Хм, понятно.","Ого, да ты ещё и комплименты говорить умеешь!") +"";
		...
		break;
		case "Aztec1AF_1":
			dialog.text = "Нет. Мы с братом поспорили, когда тебя возьмёт Миктлантекутли. Никто не выиграл, ты остал"+ GetSexPhrase("ся жив","ась жива") +".";
		...
		case "Aztec1AF_2":
			...
			link.l1 = "Ещё и череп какой-то дал нефритовый.";
			link.l1.go = "Aztec1AF_3";
		break;
		case "Aztec1AF_3":
			dialog.text = "Этот череп имеет власть над мёртвыми, знай это! Тебе очень повезло, "+ GetSexPhrase("белый капитан","прекрасная скво") +".";
		...
		//------------------------ Ауисотль ------------------------
		case "AztecFT2":
			dialog.text = "О-о, белый человек в Теночтитлане! "+ GetSexPhrase("","Да ещё такая красивая скво! ") +"Очень интересно...";
		...
		case "AztecFT2_2":
			...
			link.l1 = "Ищу кое-что. Слушай, может ты мне подскажешь, как проникнуть в Храм Великой Жизненной Силы? А ещё мне надо в Храм Белых Богов...";
			link.l1.go = "AztecFT2_3";
		break;
		case "AztecFT2_3":
			dialog.text = "Ты в своём уме, "+ GetSexPhrase("белый капитан","прекрасная скво") +"? Миктлантекутли пожрёт твоё тело и душу!";
			link.l1 = "Я не боюсь. Если что-то знаешь, скажи.";
			link.l1.go = "AztecFT2_4";
		break;
		case "AztecFT2_4":
			dialog.text = "Ты "+ GetSexPhrase("глупый человек, белый капитан","очень красивая, белая скво, но и очень глупая") +". Надо пойти поспорить с братом на то, столько ты ещё проживешь...";
		...
		case "Aztec2":
			dialog.text = "Ты ещё "+ GetSexPhrase("живой, белый капитан","живая, прекрасная скво") +"?";
		...
		case "Aztec2AF_2":
			...
			link.l1 = "Отпустил, да ещё и череп нефритовый отдал!";
