...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tichingitu_11":
			...
			dialog.text = "Отлично! Вот это дело! Сейчас я напишу записку и приложу свою печать, подожди немного... вот, держи. Отдай это коменданту и можешь забирать своего индейца. Вот только зачем он тебе понадобился - ума не приложу. Разве что на ярмарках за деньги показывать, ха-ха!";
		...
		break;
 		...
 		case "No_Powder":
        	dialog.text = "Эй, "+ GetSexPhrase("брат","сестрёнка") +", шалишь! Нет у тебя порошка. Людей, которые пытаются меня обмануть, я не признаю больше.\n"+
		...
		break;
 		...
 		case "Step_8":
        	dialog.text = "Ну, это как сказать. Этот порошок и подобные предметы культа индейцев заказывает мне известный в Европе учёный Пьер де ла Фонтен.\n"+
                          "Я нахожусь здесь в качестве его доверенного лица. В принципе, доволен вполне. Де ла Фонтен оплачивает аренду дома и моё проживание.\n"+
		...
		break;
 		...
 		case "Step_9":
        	dialog.text = "Слушай, раз пошла такая песня и мы с тобой сработались, то предлагаю тебе ещё работу.\n"+
		...
		break;
 		...
 		case "Step_10":
        	dialog.text = "Хорошо. Слушай теперь, что мне нужно разыскать.\n"+
                          "Мне нужна статуэтка Тлалока, ацтекского бога дождя и грома, церемониальный сосуд племени пурепча и церемониальный нож Туми.";
		...
		case "Tichingitu_6":
			dialog.text = "Сходи-сходи, посмотри на местные ходячие диковины...";
		...
		break;
 		...
 		case "ResultOfSeek":
    		...
    		link.l1 = "Нет ещё, но я этим занимаюсь.";
    		link.l1.go = "exit";
    		NextDiag.TempNode = "ResultOfSeek";
		...
		break;
 		...
 		case "Step_12":
        	dialog.text = "Итак, вот твои 90000, а предметы теперь наши.";
        	link.l1 = "Забирай.";
    		link.l1.go = "Step_13";
		break;

 		case "Step_13":
        	dialog.text = "Слушай, ежели желаешь, заскочи ко мне через месяц-другой. Может, ещё работёнка подвернется.";
    		link.l1 = "Буду проходить рядом - непременно навещу тебя. Работёнку подкидываешь не пыльную, а прибыль приличная.";
    		link.l1.go = "exit";
		...
		break;
 		...
 		case "Step_14":
        	dialog.text = "Ты знаешь, на этот раз дело не в розыске, задача посерьёзней будет.";
		...
		break;
 		...
 		case "Step_15":
        	dialog.text = "Проблема следующая. Испанцы, вот уже сотню лет безжалостно истребляющие континентальных индейцев и уничтожающие их культурное наследие, вдруг озаботились сбором предметов этой самой индейской культуры.\n"+
                          ...
                          "И ещё, так, между прочим... Я хочу получить инвентарную опись собранного испанцами индейского добра. Де ла Фонтену будет очень интересно на неё взглянуть.";
		...
		break;
 		...
 		case "AfterManowarsBattle":
            ...
            if (pchar.questTemp.Ascold == "ILookedThisAss" && CheckAttribute(PChar, "questTemp.Ascold.List"))
            {
             	link.l1 = "Аскольд! Список у тебя, но там ещё остались непотопленные корабли.";
        		link.l1.go = "Step_25";
            }
    		...
    		{
            	link.l1 = "Да, чёрт меня побери! Я прош"+ GetSexPhrase("ел","ла") +" семь кругов ада, но добыл"+ GetSexPhrase("","а") +" для тебя этот список. Вот он.";
        		link.l1.go = "Step_26";
    		}
		...
		break;
 		...
 		case "Step_17":
        	dialog.text = "И что?";
        	link.l1 = "Мне нужна твоя помощь, дело в том, что столкнул"+ GetSexPhrase("ся","ась") +" с проблемой в Гаване. Никак не могу разузнать, куда ушёл мановар, на который погрузили индейские артефакты. Пусть твой друг поможет.";
    		link.l1.go = "Step_18";
		break;

 		case "Step_18":
        	dialog.text = "Нет, не пойдёт. Я не собираюсь трепаться по всем Карибам о своих связях.";
		...
		break;
 		...
 		case "Step_20":
        	dialog.text = "Как-нибудь обойдёмся в общении без твоего посредничества... И что, узнал"+ GetSexPhrase("","а") +" что-либо?";
        	link.l1 = "Да, испанцы нашли близ бухты Аматике, что южней Белиза, индейский храм и сейчас там работает целая экcпедиция. А к этому месту со всего Нового света стягиваются гружённые корабли.";
    		link.l1.go = "Step_21";
		break;
		...
		break;
 		...
 		case "Step_24":
        	dialog.text = "Очень хорошо, это должно тебя радовать. Ты корсар или тряпка? Уничтожь всех испанцев и доставь мне этот чёртов инвентарный список.";
		...
		case "ManowarNoGoodWork":
        	dialog.text = "И это надо же! А ещё капером называл"+ GetSexPhrase("ся","ась") +". С такими неумелыми людьми я дела не имею.\n"+
                      "Так что, пош"+ GetSexPhrase("ел","ла") +" вон отсюда!";
    		link.l1 = "Да уж, и это после всего, что мне довелось пережить из-за тебя...";
    		link.l1.go = "Step_4";
    		NextDiag.TempNode = "First time";
		...
		break;
 		...
 		case "Ascold_KilledTemple":
        	...
        	link.l1 = "Аскольд, испанская экспедиция к храму инков полностью уничтожена. Но мне нигде не удалось найти чёртов инвентарный список.";
    		link.l1.go = "NoFoundList";
		...
		break;
 		...
 		case "Step_30":
        	dialog.text = "Да, конечно... Послушай, мне нечем тебе заплатить, я ещё не получил деньги от патрона. Тебе нужно немного подождать.";
		...
		break;
 		...
 		case "Mummie_begin":
        	dialog.text = "Рад видеть тебя, "+ GetFullName(pchar) + ". Но новостей пока у меня нет. Деньги ещё не пришли...";
        ...
        case "Step_33":
    		...
    		link.l1.go = "Step_34";
            link.l2 = "Слушай, шёл бы ты со своим делом куда-нибудь подальше.";
    		link.l2.go = "No_Work";
		break;
		...
		break;
 		...
 		case "Seek_Grave":
            ...
            if (pchar.questTemp.Ascold == "Ascold_SeekGrave")
            {
            	...
            	link.l1 = "Чёрт возьми, Аскольд, я облазил"+ GetSexPhrase("","а") +" все в округе, но ничего не наш"+ GetSexPhrase("ел","ла") +". Абсолютно ничего.";
        		link.l1.go = "Step_36";
            }
            ...
            if (pchar.questTemp.Ascold == "Ascold_EnterGrave")
            {
            	...
            	link.l1 = "Нет ещё, но я над этим работаю.";
        		link.l1.go = "exit";
            }
		break;
 		...
 		case "Step_36":
        	dialog.text = "Хм, даже не знаю, что сказать.\n"+
                          "Может и никакой гробницы и нет, не знаю... Но все же, если тебе улыбнётся удача и ты что-либо найдёшь - буду рад тебя видеть.";
        	link.l1 = "Ну что же, попытаюсь ещё раз.";
    		link.l1.go = "exit";
		...
		break;
 		...
 		case "Step_38":
        	dialog.text = "Ага, кажется ты наш"+ GetSexPhrase("ел","ла") +" то, что ищет де ла Фонтен.\n"+
                          "Чёрт возьми, я уверен, что именно там и находится искомая гробница. Надо попытаться любой ценой проникнуть внутрь.";
		...
		break;
 		...
 		case "Step_41":
        	dialog.text = "Ну, этого я точно знать не могу. Хотя подожди.\n"+
                          "Де ла Фонтен в своём письме, в котором он даёт задание найти гробницу, пишет что есть упоминание о какой-то каменной табличке. Я этому значения не придал, но похоже, это важно.\n"+
		...
		break;
 		...
 		case "Step_43":
        	...
        	link.l1 = "Интересно. Что ж, пожалуй, займусь розыском этих скрижалей. Надеюсь, что этот вход действительно ведёт куда надо.";
    		link.l1.go = "Step_44";
		...
		break;
 		...
 		case "Step_45":
        	...
        	link.l1 = "Очень надеюсь, что все получится и мой труд не пропадёт зря.";
    		link.l1.go = "exit";
		...
		break;
 		...
 		case "Found_Grave":
            if (pchar.questTemp.Ascold == "Ascold_FoundMummy")
            {
            	...
            	link.l1 = "Я сумел"+ GetSexPhrase("","а") +" открыть вход в пещеру. В пещере, в одном из ответвлений был вход в гробницу. Я наш"+ GetSexPhrase("ел","ла") +" её.";
        		link.l1.go = "Step_46";
            }
		break;
		...
		break;
 		...
 		case "Step_50":
        	dialog.text = "Так берёшься или нет?";
		...
		break;
 		...
 		case "AfterAttackMummy":
            ...
            if (GetCharacterIndex("LeifEricson") == -1)
            {
            	...
            	link.l1 = "Да всё в порядке, мир спасён, люди могут спать спокойно.";
        		link.l1.go = "Step_60";
		...
		break;
 		...
 		case "Step_56":
        	dialog.text = "Чёрт возьми! Доигрались мы с тобой.\n"+
		...
		break;
 		...
 		case "Step_58":
        	dialog.text = "Посильней, не спорю. Я лихо с оглоблей управляюсь, а вот шпага - это не моё.\n"+
                          "Ты про пещеру говорил"+ GetSexPhrase("","а") +", там придётся идти. И как я буду в стеснённом пространстве оглоблей-то махать? Не выйдет у меня.";
        	link.l1 = "Да, точно, не выйдет с оглоблей... Ну что ж, пойду сам"+ GetSexPhrase("","а") +" спасать мир. Деваться некуда.";
    		link.l1.go = "Step_59";
		break;

 		case "Step_59":
        	dialog.text = "Ух, здорово, что ты согласил"+ GetSexPhrase("ся","ась") +". Удачи тебе в этом нелёгком деле, "+ GetSexPhrase("друг","подруга") +".";
		...
		break;
 		...
 		case "Step_60":
        	...
        	link.l1 = "Нет, ничего не находил"+ GetSexPhrase("","а")+".";
    		link.l1.go = "Step_61";
		...
		break;
 		...
 		case "Step_61":
        	dialog.text = "Эх, жаль... Послушай, а может ещё раз там посмотреть.\n"+
		...
		break;
 		...
 		case "Step_62":
        	dialog.text = "Эх, жаль. Но я вижу, что уговаривать тебя бесполезно. Что ж, разойдёмся друзьями.";
		...
		break;
 		...
 		case "Step_63":
        	dialog.text = "Ну так продай мне её. 50000 дам за это барахло.";
		...
		break;
 		...
 		case "BuyAzzy":
        	dialog.text = "Деньги ваши - вещичка наша. Может, поработаем ещё вместе? Такие дела нас ждут...";
		...
		break;
 		...
 		case "Step_68":
        	dialog.text = "Ещё нужен странный предмет, идол древнего божества. Собираешь все три предмета - и ищешь человека, кто сможет провести обряд. Какая-нибудь ведьма местная вполне подойдёт.";
        	link.l1 = "Ведьма может? Знаю одну такую даму...";
    		link.l1.go = "Step_69";
		break;

 		case "Step_69":
        	dialog.text = "Вот и здорово. Теперь добудь предметы - и вперёд. Полагаю, что с обрядом твоя ведьма знакома, раз она ведьма.";
		...
		break;
 		...
 		case "Step_71":
        	dialog.text = "С тебя я денег не возьму. Мы ведь с де ла Фонтеном должны тебе ещё, сколько ты сделал"+ GetSexPhrase("","а") +" для нас, ожидая награды. Будем считать, что мы в расчёте. А черепа забирай.";
		...
		break;
 		...
 		case "Step_72":
        	dialog.text = "Ну как же, находил. Забирай и её, какие проблемы?";
