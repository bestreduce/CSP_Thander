void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Andre_Abel_Quest_In_Prison_Wrong_Way_1":
			dialog.text = "Напрасно ты так... Но, это твоё право... Уже завтра днём наши безжизненные тела будут посмешищем публике...";
		...
		case "Node_1":
			...
			link.l1 = "Ах ты... А я и думаю, откуда на торговом пинасе солдаты, да ещё так много... Ловушка!!";
			link.l1.go = "Node_2";
		break;

 		case "Node_2":
			dialog.text = "Да, мерзав"+ GetSexPhrase("ец","ка") +", это ловушка. А я не торговец, а боевой офицер! И хотя бой ты выиграл"+ GetSexPhrase("","а") +", тебе всё равно не уйти от правосудия.";
			link.l1 = "Это почему же? Сейчас покончу с тобой, пущу твоё корыто на дно - и никто ничего не узнает.";
			link.l1.go = "Node_3";
		break;

 		case "Node_3":
			dialog.text = "Ошибаешься. Ваши тёмные делишки с местным ростовщиком раскрыты. Скоро об этом узнает генерал-губернатор, и вам не отвертеться от виселицы. Ну а я уж постараюсь, чтобы ты до неё не дожил"+ GetSexPhrase("","а") +".";
		...
		case "Node_rat_1":
			...
			link.l1 = "Сдаётся мне, что ты лжёшь. Сейчас мы обыщем дом и посмотрим...";
		...
		case "Rat_lover_1":
			dialog.text = "Нет, нет, я всё скажу! Он выпрыгнул в окно и убежал, видимо, на свой корабль.";
		...
		case "Rat_lover_2":
    		...
    		link.l1 = "Ладно, похоже ты не врёшь. Сиди тихо и не дёргайся. А вообще, знакомых надо с умом выбирать. Хотя, какой у тебя ум - по глазам вижу, дура-дурой.";
		...
		case "Slave_woman":
			dialog.text = "Пощадите! Пощадите! Мы сдаёмся!";
        ...
        break;
       	...
       	case "Carlos_3":
			Dialog.Text = "Нет, вы только гляньте! Смотри, не пожалей об этом, капитанишка, никто не назовёт Карлоса Кассира трусом безнаказанно! Встретимся за городскими воротами через час, и продолжим нашу беседу, чтобы не портить полы сего заведения твоими кишками\nНадеюсь, твоя храбрость тебя не оставит, а твои слова я запихну тебе в...";
			link.l1 = "Довольно, уважаемый. Прибереги пыл для подтверждения своих слов. Я буду на месте через час, а если не найду там тебя, то будь уверен - слава о трусости кондотьера Кассира найдёт тебя везде, в какую бы щель ты не забился.";
			link.l1.go = "Carlos_4";
		...
		case "talk_off_town_Carlos":
			...
			link.l1 = "Я гляжу, ты привёл с собой компанию, пёс? Тем лучше – вам не будет одиноко в аду. К делу!";
			link.l1.go = "Carlos_6";
		...
		case "Carlos_7":
			...
			link.l1 = "Я говорю с пьяной свиньёй, которая заняла заведение, где я собирал"+ GetSexPhrase("ся","ась") +" провести вечер. И теперь здесь все безнадёжно провоняло, словно в хлеву – какая досада, правда?";
			link.l1.go = "Carlos_8";
		break;

		case "Carlos_8":
			dialog.text = "Ты "+ GetSexPhrase("смелый щенок","смелая девка") +", как я погляжу... Я Карлос Кассир – моё имя знает каждый в этом городе и во многих других – и моя шпага сочла уже полсотни кичливых болтунов. Мой тебе совет – выметайся отсюда, пока я не подрезал тебе язык. Не хочу портить хороший вечер. ";
		...
		//ОЗГ, Ганнибал Хоум
		case "Houm":
            dialog.text = "Уйди, человек с моря. Ты стоишь на пути чёрного льва.";
		...
		case "Houm_2":
            dialog.text = "Храбрая маленькая мышь... Тебе ведь заплатили голландские шакалы так? Они хотят чужими руками добыть льва, нанёсшего им рану\nИ сулят золото тому, кто не струсит. Я знаю - только золото заставляет вас, белых людей, забывать страх. Вспомни его, пока лев не рассердился всерьез.";
        	link.l1 = "Довольно рассуждений, чёрная образина. Давай оставим эту дипломатию и поговорим открыто.";
            link.l1.go = "Houm_3";
        break;

		case "Houm_3":
            dialog.text = "Чёрный лев выслушает, но будь "+ GetSexPhrase("краток, голландский наёмник","кратка, голландская наёмница") +".";
        	link.l1 = "Я не работаю на власти, чёрный пёс. На голландском корабле, который ты утопил, был мой брат. И я хочу, чтобы ты ответил за его смерть.";
            link.l1.go = "Houm_4";
        break;

		case "Houm_4":
            dialog.text = "Ха, лев удивлён. Перед ним не мышь, за голландские монеты возомнившая себя охотником, но "+ GetSexPhrase("волк","волчица") +", желающ"+ GetSexPhrase("ий","ая") +" отомстить за собрата? Достойно\nЛев принимает твой вызов. Не стоит тревожить покой этого города – лев будет ждать вол"+ GetSexPhrase("ка","чицу") +" в море. Сражайся, как подобает, и умри как воин, а лев съест твоё сердце, и храбрость вол"+ GetSexPhrase("ка","чицы") +" продолжит жить после е"+ GetSexPhrase("го","е") +" смерти.";
		...
		case "RatOfficer_4":
			...
			link.l1 = "Да уж не бедный. Жадный только сильно. Говорил"+ GetSexPhrase("","а") +" я ему - снаряди эскорт, найми судно охранения, ну, поищи попутчика, в крайнем случае... так нет же - денег ему жалко! Придётся до самого Белиза в одиночку идти.";
		...
		case "RatOfficer_5":
			...
			link.l1 = "Да, ты прав, чёрт возьми! Все из-за них, богоотступников. Эх, и как это одно"+ GetSexPhrase("му","й") +" от Тортуги до Белиза добраться? А ведь ещё по пути в залив Гибели зайти надо - хозяин велел с индейцами тамошними сделку провести - камушков драгоценных у них за бесценок прикупить, да и запасы воды пресной пополнить... Слушай, а ты часом не в том направлении курс держишь? Может...";
		...
		case "RatOfficer_8":
			...
			link.l1 = "Ну, давай ещё по одной, и я тоже отчаливаю... Все семде-е-сят пять не вернулись до-о-мой, они потону-у-ли в пучине морской... Прощай, дружище...";
		...
		case "Rat_talk":
			...
			link.l1 = "Нет, Крыса. На этот раз ты оплошал. Вместо ценного дерева тебя ждёт холодная сталь и горячий свинец. Твои похождения закончатся здесь, в этой бухте.";
			link.l1.go = "Rat_talk_1";
		break;

		case "Rat_talk_1":
			dialog.text = "Так просто я не сдамся, хотя абордаж уже проигран. Ты ещё узнаешь, что значит связаться с Крысой! Джа Престон отомстит за меня!";
		...
		case "RatHunters":
			//dialog.text = "...";
			link.l1 = "А?! Что? Что вы здесь делаете, чёрт побери? Кто вас сюда впустил?";
			link.l1.go = "RatHunters_1";
		break;

		case "RatHunters_1":
			dialog.text = "Джа Престон передаёт тебе привет...";
		...
		case "Halen_1":
			dialog.text = "Да, это моё имя, но вы так и не назвали мне своё? Потрудитесь объяснить, что вам угодно, или проваливайте прочь. Не стоит испытывать моё терпение - у меня нет ни малейшего желания тратить своё время на болтовню с чернью.";
			link.l1 = "Да уж... И впрямь - банальный, обласканный властями хлыщ. От избытка вежливости вы не умрёте. А вот от избытка спеси - вполне возможно. Вам не говорили, что высокомерные тупицы не задерживаются на этом свете, даже если их привечают высокопоставленные особы?";
			link.l1.go = "Halen_2";
		...
		case "Halen_2":
			dialog.text = "Аргх! Подобной дерзости я ещё ни от кого не слышал! Не трудись отвечать – вижу, речь даётся тебе с трудом. Оскорбить тебя, полагаю, мне не удастся – все эпитеты будут лишь лестью в твой адрес! Обнажи свою шпагу, "+ GetSexPhrase("червяк","шлюха") +", если знаешь, с какого конца её держать! Я хочу получить удовлетворение немедленно. Иначе я просто заколю тебя, как свинью!";
		...
		case "Halen_3":
			dialog.text = "Удовлетвор"+ GetSexPhrase("ён","ена") +" знакомством? А теперь – убирайся к дьяволу и прекрати мозолить глаза, деревенщина!";
			link.l1 = "Гхм...";
		...
		case "Miko_2":
			dialog.text = "Ага... Ясно. Вот и свиделись. Так ты и есть "+ GetSexPhrase("тот парень","та девка") +", котор"+ GetSexPhrase("ого","ую") +" мы разыскиваем... "+ GetSexPhrase("Сам пришёл","Сама пришла") +"... Ну что же, это значительно облегчает мою задачу. Не думаю, что ты так просто отсюда уйдешь.";
			link.l1 = "Да, это я. Говори, где Престон, и будешь жить.";
			link.l1.go = "Miko_3";
		break;

		case "Miko_3":
			dialog.text = "Ты угрожаешь мне, "+ GetSexPhrase("приятель","деваха") +"? Напрасно. Ты здесь чуж"+ GetSexPhrase("ой","ая") +", и мы всем посёлком разорвём тебя в клочья\nЧто касается моего патрона, то он сейчас совсем недалеко. Гораздо ближе, чем ты думаешь. Но тебе никогда не найти Джа - потому что ты наш"+ GetSexPhrase("ел","ла") +" меня, ха-ха-ха!!";
		...
		case "Ja_talk_3":
			dialog.text = "Какого чёрта ты охотишься на меня? Зачем убил"+ GetSexPhrase("","а") +" всех моих людей?";
		...
		case "Ja_talk_5":
			dialog.text = "Подожди... Послушай, я предложу тебе другое. Ты "+ GetSexPhrase("отчаянный и толковый корсар","отчаянная и толковая девушка") +", а я... я проиграл свою игру. У меня нет больше людей, и уже нет корабля - ты выиграл"+ GetSexPhrase("","а") +" абордаж. Даже если мне удасться тебя сейчас убить, конец всё равно один\nМожет, лучше объединим силы? Я предлагаю сменить вражду на мир и готов работать с тобой, под твоим началом.";
			link.l1 = "Нет, Джа. Я тебе не верю. Сегодня - ты мой офицер, а завтра - воткнёшь кинжал в спину? Пора завершить наше противостояние!";
			link.l1.go = "Ja_talk_1";
