...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Begin_PoorKill_2":
			dialog.text = "Ха-ха, мне нравится ваша хватка!\nНу что же, для начала предлагаю познакомиться. Меня зовут " + GetFullName(npchar) + ". Простите, но я навёл справки о вас и знаю, что вы - капитан " + GetFullName(pchar) + ". Также мне известно, что вы капер. Это так?";
		...
		case "Begin_PoorKill_4":
			dialog.text = "Да, собственно, пустяк для "+ GetSexPhrase("такого храброго человека","такой храброй девушки") +", как вы. Дело в том, что мой работодатель всерьёз озаботился состоянием морали и нравственности на островах Карибского моря. Да-да, именно так!";
		...
		case "Begin_PoorKill_5":
			...
			link.l1 = "О чём это вы? Повторюсь: ближе к делу, милейший...";
			link.l1.go = "Begin_PoorKill_6";
		break;
		case "Begin_PoorKill_6":
			dialog.text = "Ну, хорошо. Мне нужно, чтобы вы избавили нас от нищих и попрошаек в городах. Причём везде, в каждом городе, независимо от национальной принадлежности. За эту работу мы готовы вам заплатить миллион пиастров!";
			link.l1 = "Хех, заманчиво. Миллион на дороге не валяется...";
			link.l1.go = "Begin_PoorKill_7";
			link.l2 = "Ты за кого меня принимаешь? За наёмн"+ GetSexPhrase("ого","ую") +" убийцу?! Вали-ка отсюда, приятель, пока цел...";
		...
		case "Begin_PoorKill_10":
			...
			link.l1 = "Хм, тогда за дело. Где и когда я могу удостовериться в наличии депозита на моё имя?";
		...
		break;
		case "GiveKeyMan_3":
			dialog.text = "Тот, что с замком, делал я. И могу сказать без преувеличений, что ты обратил"+ GetSexPhrase("ся","ась") +" по адресу. Я самый известный Мастер Ключей! Есть, правда, тёзка у меня - узкоглазая падла, но он мне и в подмётки не годится. Так что именно я и есть настоящий Мастер Ключей!";
		...
		case "GiveKeyMan_NoMoney":
			...
			else
			{
				...
				link.l1 = "Хм, подсоберу ещё деньжат.";
				link.l1.go = "exit";
			}
		break;
		case "GiveKeyMan_10":
		...
		case "GiveKeyManInside_3":
			dialog.text = "За работу. Ключ-то я сделал, как и обещал. Я слово своё держу!";
			link.l1 = "Ну-ну...";
			link.l1.go = "exit";
			npchar.lifeDay = 0;
		...
		case "MK_HollOfficer":
			dialog.text = "Пройдёмте со мной, капитан!";
			link.l1 = "Куда это?";
		...
		case "PKInMarigo":
			dialog.text = "Хм, я не планировал встречаться с вами ещё раз! Вы уже выполнили задание? Проблемы с депозитом?";
			link.l1 = "Да нет, с депозитом всё в порядке. Вы знаете, дело в том, что я никак не могу найти одного бродягу - Тизера Дэна.";
			link.l1.go = "PKInMarigo_1";
		break;
		case "PKInMarigo_1":
			dialog.text = "О нем можете не переживать, вы его уже не найдёте. Позаботьтесь об остальных.";
			link.l1 = "Понятно... Ну а всё-таки, где Тизер?";
			link.l1.go = "PKInMarigo_2";
		break;
		case "PKInMarigo_2":
			dialog.text = "Я что, неясно говорю? Тизер Дэн в заявочный список не входит. Вы понимаете меня?";
			link.l1 = "Понимаю, конечно. Но всё-таки, очень хотелось бы узнать, где он.";
		...
		case "PKInMarigo_4":
			...
			link.l1 = "Хорошо. Я знаю, что вы являетесь представителем Голландской Вест-Индской компании в Карибском море. Знаю также, что вы ведёте дела с генерал-губернатором Стэвезантом. И ещё я хочу знать, какого чёрта вам не угодили местные бродяги.";
			link.l1.go = "PKInMarigo_5";
		break;
		case "PKInMarigo_5":
			dialog.text = "А не слишком ли много вы хотите?";
			link.l1 = "Это ещё не все мои вопросы к вам. Я хочу знать об Острове!";
		...
		case "PKInMarigo_6":
			dialog.text = "Вы хоть понимаете, во что лезете, капитан? Плавайте себе на здоровье, щипайте отдельных торговцев - это не страшно. Но вот лезть в дела компании, которой принадлежит целый Индийский океан - это безумие.\n"+
				"Выполняйте взятые на себя обязательства, снимайте депозит - и продолжайте куролесить на здоровье, никто вас пальцем не тронет. А вот ваше любопытство очень быстро сведёт вас в могилу. Я даю вам последний шанс, капитан, уйти отсюда с миром.";
			link.l1 = "Полагаю, что этим шансом я пользоваться не буду. Я хочу знать всё ещё и о предметах роскоши, падения цен на которые вы так опасаетесь...";
		...
		break;
		case "PKInMarigo_8":
			dialog.text = "Убью. Причём прямо сейчас! Охрана!!!";
		...
		case "PKInMarigo_9":
			...
			for (int i = 1; i <= 2; i++)
			{
				...
				FantomMakeCoolFighter(sld, sti(Pchar.rank), 25+drand(50), 25+drand(50), "blade39", "pistol2", 20/*  + 10 * MOD_SKILL_ENEMY_RATE*3 */);
		...
		break;
		case "LSCQuestMent_1":
			dialog.text = "Хватит прикидываться! Андре мне всё рассказал о твоих намеках.";
			link.l1 = "Вот идиот!..";
			link.l1.go = "LSCQuestMent_2";
		break;
		case "LSCQuestMent_2":
			dialog.text = "Андре Лабор – законопослушный гражданин города. А вот тебе придётся всё мне рассказать о Тизере Дэне, иначе завтра тобой будет заниматься адмирал.";
			link.l1 = "Так он ещё не знает? Да ведь это же прекрасно!.. Хм, боюсь, тебе придётся умереть.";
			link.l1.go = "LSCQuestMent_3";
		break;
		case "LSCQuestMent_3":
			dialog.text = "Что?!! Андре, ко мне!";
			link.l1 = "Ха, так плотник на стрёме? И это тоже превосходно!";
		...
		case "LSCQuestNarval_1":
			dialog.text = "Ты что, "+ GetSexPhrase("придурок","дурёха") +", не знаешь, что это - территория 'нарвалов'?";
			link.l1 = "Да знаю...";
			link.l1.go = "LSCQuestNarval_2";
		break;
		case "LSCQuestNarval_2":
			dialog.text = "Ты что, "+ GetSexPhrase("безумный","безумная") +", смерти ищешь?";
			link.l1 = "Ну, да... Только твоей смерти. Извини, приятель, но мне придётся тебя убить.";
		...
		case "SharpCapitain_2":
			dialog.text = "В моём текущем положении глупо было бы отказываться... Богатства, говоришь? Что же, я к вашим услугам, капитан!";
		...
		case "PGG_cabin":
			...
			link.l2 = "Самоуверенность заведёт тебя в могилу. Защищайся!";
		...
		case "PGG_cabin_1":
			...
			dialog.text = "Плавать с тобой? Да я лучше сдохну\nХотя, для такого время всегда найдётся. Пожалуй, я пойду с тобой, если ты в состоянии удовлетворить мой аппетит. Для начала я хочу "+npchar.hirePrice+" пиастров, здесь и сейчас. ";
			...
			link.l2 = "Самоуверенность, да ещё и жадность. Нет, мы с тобой не найдём общего языка. Защищайся!";
			link.l2.go = "PGG_cabin_fight";
		break;
		case "PGG_cabin_2":
		...
		case "zpqCapitain":
			...
			{
				link.l1 = "Твой корабль захвачен, а вся команда перебита. Но дерёшься ты весьма неплохо. Я подумываю сохранить тебе жизнь и даже отдать деньги за порох, если пойдёшь плавать под моим началом. Либо...";
				link.l1.go = "zpqCapitain_1";
			}

			link.l2 = "И не таких грозных видали! От меня ты только клинок меж рёбер получишь!";
		...
		case "BlueBirdCapitain_3":
			dialog.text = "Не твоё дело, каррамба! За небольшую передышку тебе спасибо, а теперь продолжим!";
			link.l1 = "Ну, хорошо...";
		...
		break;
			...
			/*link.l2 = "Ха! Вот это интересно! А ты знаешь, Джа - я соглас"+ GetSexPhrase("ен","на") +". Такого офицера, как ты, ещё поискать надо. Но смотри - надумашь шутки шутить - мигом за борт отправлю!";
		...
		case "BlueBirdTrader":
			dialog.text = "Чёрт возьми, почему вы напали на нас?!!";
		...
		case "BlueBirdTrader_1":
			...
			link.l1 = "Сейчас берёшь шлюпку, и с остатками команды можешь возвращаться к хозяину. Скажи, что " + GetFullName(pchar) + " передаёт ему привет.";
			link.l1.go = "BlueBirdTrader_2";
		break;
		case "BlueBirdTrader_2":
			dialog.text = "Привет передам обязательно.";
			link.l1 = "Тогда на этом всё. Живи пока...";
		...
		case "DeckSharp":	//на палубе
			dialog.text = ""+ GetSexPhrase("Здравствуй, приятель. Чему обязан за удовольствие видеть тебя на моём бриге","Хо-о, какие у нас гости! Чему обязан за удовольствие видеть тебя на моём бриге, прекрасная амазонка") +"?";
		...
		break;
		case "DeckSharp_8":
			dialog.text = RandPhraseSimple(""+ GetSexPhrase("Да не за что, приятель, ежели что - обращайся...","Обращайся ещё, моя красавица. А может, как-нибудь встретимся, так сказать, в неофициальной обстановке?") +"",""+ GetSexPhrase("Помогать коллегам - священный долг, так сказать... Заходи ещё, чем смогу - помогу!","Заходи ещё, чем смогу - помогу. " + pchar.name + ", а может, продолжим наше общение...в другом, более уютном месте?") +"");
			link.l1 = ""+ GetSexPhrase("Всенепременно, капитан Шарп!!","Ты неисправимый ловелас, Барти. Ещё увидимся!") +"";
		...
		break;
		case "NewDeckSharp_1":
			dialog.text = "Да всё путём, "+ GetSexPhrase("приятель","дорогуша") +", жаловаться грех\nНу, рассказывай, зачем пожаловал"+ GetSexPhrase("","а") +" на этот раз?";
			link.l1 = "Да всё за тем же, приятель, за наводкой на промыслы...";
		...
		case "NewDeckSharp_noMoney":
			if ((sti(pchar.questTemp.Sharp.price)*10) < sti(pchar.money))
			{
				if (pchar.location == "Deck_Near_Ship")
				{
					dialog.text = ""+ GetSexPhrase("Алле Хагель! Ты чего, " + pchar.name + ", лоха нашёл?! Я те не сявка лямой, а КАПИТАН ШАРП!! Звучит гордо, понял?! Думаешь, я не знаю, что денег у тебя прилично имеется? Знаю, приятель, это мне прекрасно известно. Так что, давай, раскошеливайся или вали с моей палубы на все четыре стороны относительно зюйд-веста!","Алле Хагель! " + pchar.name + ", ты, конечно, деваха красивая и боевая, однако и я не сявка лямой, а КАПИТАН ШАРП! Звучит гордо! Думаешь, я не знаю, что денег у тебя прилично имеется? Знаю, дорогуша, это мне прекрасно известно. У нас с тобой деловые отношения...кхм, жаль, однако, что только деловые. В общем, или раскошеливайся, или ищи ныряльщиков самостоятельно") +"..";
					link.l1 = ""+ GetSexPhrase("Бартоломью, ты чего завёлся?! Скрипишь, как рангоут... Я к тебе не клотик пришёл швабрить и не якорь точить. Так что ты аккуратней в выражениях. Помни, с кем разговариваешь","Бартоломью, ты чего раздухарился? Ты это, аккуратнее в выражениях, я тебе не какая-нибудь там девка бордельная, не забывай этого") +"...";
				}
				else
				{
			...
			else
			{
				...
				{	//Шарп не в настроении
					dialog.text = "Нет, "+ GetSexPhrase("приятель","дорогуша") +", только не сегодня! У меня самого дела идут неважно, а тут ещё ты со своими просьбами. В меценаты я не записывался. Деньги на бочку, в общем...";
		...
		case "DeckSharp_over":
			dialog.text = "Мы всё обсудили, "+ GetSexPhrase("приятель","подруга") +". На твоём месте я бы не стал терять времени.";
		...
		case "DeckSharp_noWork":
			dialog.text = "Ничем не могу помочь, "+ GetSexPhrase("дружище","дорогуша") +". Сам страдаю без дела. Теперь придётся опять за галеонами гоняться...";
		...
		break;
		case "CitySharp_2":
			dialog.text = ""+ GetSexPhrase("Эх, дружище, рад тебя видеть! Ну что, начнём, пожалуй... Сначала в кабак, потом по девкам. Ты каких предпочитаешь, мулаток или белых? У меня тут такие связи - закачаешься","Э-э-х, " + pchar.name + ", когда я вижу тебя, у меня сердце аж замирает") +"!";
		...
		case "BrothelSharp":
			dialog.text = ""+ GetSexPhrase("О-о-о, " + pchar.lastname + ", дружище!! Пойдём со мной наверх, там так весело!!!","О-о-о, " + pchar.name + ", это ты, красавица? Ну вот, теперь я опять буду целую неделю думать только о тебе...") +"";
		...
		case "WaitressBerglar_take":
			dialog.text = "Конечно, не сойдёт, кто же спорит? Ну, прощай дружище. И помни - не такой ты красавец, чтобы на тебя официантки с ходу вешались. Впредь будешь умней!";
			link.l1 = "Это точно!..";
			link.l1.go = "exit";
		...
		case "PortmansCap_2":
			...
			link.l1 = "Ну, всё хорошо, что хорошо кончается. Забирай свой журнал и давай поговорим о моём гонораре за труды.";
			link.l1.go = "PortmansCap_3";
		break;
		case "PortmansCap_3":
			if (sti(npchar.quest.stepsQty) == 1)
			{
				dialog.text = "Новый журнал я ещё не завёл, как раз собирался, поэтому заплачу максимум из того, что могу себе позволить. " + FindRussianMoneyString(sti(npchar.quest.money)) + " и немного моих личных драгоценностей.";
			...
			else
			{
				if (sti(npchar.quest.stepsQty) < 5)
				{
					...
					dialog.text = "Хм, ты знаешь, я уже завёл новый журнал. Тем не менее, старый журнал мне нужен ещё, необходимо всё перенести в новый. Так что я могу забрать его за " + FindRussianMoneyString(sti(npchar.quest.money)) + ". и немного моих личных драгоценностей.";
					link.l1 = "Ну что же, договорились. Забирай свой журнал!";
					link.l1.go = "PortmansCap_4";
				}
				else
				{
					dialog.text = "Так я завёл новый журнал уже. И все записи старого по памяти перенёс туда, два дня сидел и писал. Так что мне старый журнал теперь попросту не нужен. И ничего заплатить за него я не могу.";
		...
		case "PortmansCap_inDeck_2":
			if (sti(npchar.quest.stepsQty) == 1)
			{
				dialog.text = "Чёрт, так, значит, вот где я его потерял!.. Это ценная услуга, "+ GetSexPhrase("дружище, ","") +"нет слов. А то я чуть капитанского статуса не лишился... Большое тебе спасибо.";
				link.l1 = "Как насчёт вознаграждения?";
			...
			else
			{
				...
				{
					npchar.quest.money = makeint(sti(npchar.quest.money) / sti(npchar.quest.stepsQty)); //уменьшаем вознаграждение
					dialog.text = "Чёрт, так, значит, вот где я его потерял!.. Спасибо тебе, конечно, но дело в том, что ты долго меня искал"+ GetSexPhrase("","а") +", и я уже завёл новый. Однако, перенести кое-что мне оттуда нужно, поэтому я заберу журнал у тебя. Но много заплатить не могу...";
					link.l1 = "А сколько можешь?";
					link.l1.go = "PortmansCap_inDeck_3";
				}
				else
				{
					dialog.text = "Чёрт, так, значит, вот где я его потерял!.. Спасибо тебе, конечно, но дело в том, что ты долго меня искал"+ GetSexPhrase("","а") +", и я уже завёл новый. Старые записи перенёс по памяти, так что мне он не нужен.";
		...
		case "PortmansCap_inDeck_3":
			dialog.text = "Я готов выплатить тебе " + FindRussianMoneyString(sti(npchar.quest.money)) + " и дать впридачу немного своих личных драгоценностей. Это всё, что я могу себе позволить.";
			link.l1 = "Ну, хорошо. Вот твой журнал.";
			link.l1.go = "PortmansCap_inDeck_4";
		break;
		case "PortmansCap_inDeck_4":
			dialog.text = "Спасибо ещё раз. Прощай, "+ GetSexPhrase("дружище, ","") +"и будь здоров"+ GetSexPhrase("","а") +".";
		...
		case "PortmansCap_inDeck_over":
			dialog.text = "Вроде, всё решили уже.";
		...
		case "SeekCap_inDeck":
			...
			link.l1 = "Да так, новостями обменяться хотел"+ GetSexPhrase("","а") +". Может, что продаётся у тебя...";
			link.l1.go = "SeekCap_inDeck_1";
		break;
		case "SeekCap_inDeck_1":
			dialog.text = "Ничего не продаётся, и новостей у меня нет. И вообще, честно говоря, твоё присутствие у меня на палубе нежелательно. Надеюсь, ясно выразился?";
		...
		case "SeekCap_1":
			...
			link.l1 = "Нет, это не так. Кто владеет кораблём - и я сам"+ GetSexPhrase("","а") +" не знаю, но я знаю, что корабль украден со стоянки одного из портов. Я долж"+ GetSexPhrase("ен","на") +" его вернуть на место.";
			link.l1.go = "SeekCap_2";
		break;
		case "SeekCap_2":
			dialog.text = "Дьявол! Ну, для меня ещё не всё потеряно. Я всё-таки попытаюсь отправить тебя на тот свет...";
		...
		case "SCQ_ProverkaZnaniy_2":
			dialog.text = "Я назову вам фразу на латыни, а вы должны без ошибок повторить за мной. На это я дам вам 16 секунд. Готовы?";
		...
		case "SCQ_RapeWife":
			dialog.text = "Моё относительное бездействие привело к печальным результатам. Этот мерзавец похитил мою жену и увёз её на своём корабле в море. Я прошу вас найти этого негодяя!";
		...
		case "SCQ_RapeWife_1":
			...
			dialog.text = "Я небогат, но с радостью отдам всё, что у меня есть! Если вы освободите мою жену и доставите её ко мне, то я заплачу вам " + FindRussianMoneyString(sti(npchar.quest.money)) + " и отдам все свои личные драгоценности.";
		...
		break;
		case "SCQ_RapeWife_2":
			dialog.text = "Её зовут " + npchar.quest.SeekCap.name + ". Мерзавца-капитана зовут " + npchar.quest.SeekCap.capName + ", плавает он на " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName + "Dat")) + " с именем '" + npchar.quest.SeekCap.shipName + "'.";
		...
		case "SCQ_RapeWife_3":
			...
			link.l1 = "Да всё нормально, не переживайте. В общем, теперь ожидайте меня с результатами поисков.";
		...
		case "SCQ_RapeWife_4":
			...
			link.l1 = "Сделаю всё, что смогу. Ждите.";
			link.l1.go = "exit";
			//==> ставим квестодателя в церковь
			pchar.quest.SeekShip_Stay.win_condition.l1 = "ExitFromLocation";
			npchar.location = npchar.city + "_church";
		...
		//поиски земляка
		case "SCQ_Friend":
			dialog.text = "Дело в том, что мой земляк так и не обзавёлся здесь недвижимостью. Его дом - это его корабль. Поэтому мне очень сложно его отловить, он постоянно в движении. А я не могу позволить себе тратить время на бесполезные путешествия, я вынужден зарабатывать себе на жизнь.";
		...
		case "SCQ_Friend_1":
			...
			dialog.text = "Я могу заплатить вам за работу " + FindRussianMoneyString(sti(npchar.quest.money)) + " и отдам все свои личные драгоценности. Это всё, что я могу себе позволить на данный момент.";
			link.l1 = "Сумма меня устраивает, я готов"+ GetSexPhrase("","а") +" взяться за это дело. Вы, кстати, можете пойти ко мне пассажиром, тогда вам не придётся ездить к земляку, когда он будет найден.";
		...
		case "SCQ_manResult":
			...
			{
				case "manSlaveover":
					dialog.text = "По вашему виду догадываюсь, что я наконец-то отомщён. Это так?";
					link.l1 = "Именно. " + npchar.quest.SeekCap.capName + " мёртв, а его " + GetStrSmallRegister(XI_ConvertString(npchar.quest.SeekCap.shipTapeName)) + " на дне.";
					link.l1.go = "SCQR_manSlave";
				break;
				case "manRapeWifeover":
					dialog.text = "Вы разыскали мою жену! Это правда?!";
					link.l1 = "Правда. Она у меня на корабле в качестве пассажира. Можете её забирать, если " + npchar.quest.SeekCap.name + " " + npchar.quest.SeekCap.lastname + " и есть ваша жена...";
					link.l1.go = "SCQR_manRapeWife";
				break;
				case "manFriendover":
					dialog.text = "Здравствуйте, капитан. Вы нашли моего земляка?";
					link.l1 = "Наш"+ GetSexPhrase("ел","ла") +" и рассказал"+ GetSexPhrase("","а") +", что вы его ждёте здесь. Так что всё вышло удачно.";
		...
		case "SCQ_manResult_exit":
			...
			{
				case "manSlave":
					dialog.text = "Как, вы забыли, что я нанял вас отомстить капитану по имени " + npchar.quest.SeekCap.capName + " за год, проведённый мной в рабстве?!";
					link.l1 = "Да ничего я не забыл"+ GetSexPhrase("","а") +". Занимаюсь этим, жди.";
					link.l1.go = "exit";
				break;
				case "manRapeWife":
					dialog.text = "Ушам не верю! Вы забыли, что обещали мне разыскать и освободить мою жену? Её похитил пират по имени " + npchar.quest.SeekCap.capName + "!";
					link.l1 = "Не забыл"+ GetSexPhrase("","а") +" я о твоей жене. Просто розыски пока не принесли результата. Всё это не так просто, жди...";
					link.l1.go = "exit";
				break;
				case "manFriend":
					dialog.text = "Подождите... Вы что, забыли о своём обещании найти моего земляка, торгового капитана по имени " + npchar.quest.SeekCap.capName + "?";
		...
		case "SCQ_woman_1":
			/*switch (npchar.quest.SeekCap.numQuest)
			{
				...
				break;
				case "1":
					dialog.text = ""+ GetSexPhrase("Капитан, вот смотрю я на вас и вижу бравого капитана, отменного головореза","Капитан, я вижу вы сильная и отважная женщина, любого мужика за пояс заткнёте") +"...";
		...
		case "SCQ_Prytki_Trah_3":
			dialog.text = "Ах, капитан, мне так не терпится оказаться в ваших горячих объятиях...";
		...
		case "SCQ_Revenge":
			dialog.text = ""+ GetSexPhrase("Это я к тому, любезный, что я хочу нанять вас по прямому назначению, так сказать... ","Я хочу, чтобы вы помогли мне. Надеюсь, что вы меня поймёте, как женщина. ") +"Мне порядком досадил один капитан, я желаю, чтобы он умер.";
		...
		case "SCQ_Revenge_3":
			...
			link.l1 = "Хм... "+ GetSexPhrase("а","да, мужчины на это способны. Но,") +" может, вы остынете? Ну, пройдёт день-другой, и всё изменится...";
		...
		break;
		case "SCQ_Revenge_5":
			dialog.text = "Чёрт возьми, "+ GetSexPhrase("вы просто не знаете, что такое месть отвергнутой женщины","вы же женщина, и должны понимать, каково это - быть отвергнутой! Я хочу отомстить") +"!..";
			link.l1 = ""+ GetSexPhrase("Это верно, как-то не довелось","Ну, знаете, некоторые просто поплачут и всё") +"...";
			link.l1.go = "SCQ_Revenge_6";
		break;
		case "SCQ_Revenge_6":
			dialog.text = ""+ GetSexPhrase("Считайте, что вам повезло. Отвергнутая и обманутая в своих ожиданиях женщина - это фурия, дьявол в юбке! Нет ничего, способного смягчить её гнев","А вот я не такая. И нет ничего, что может смягчить мой гнев") +"!\nТак что я хочу, чтобы вы убили его лично. А перед смертью он должен узнать, кто всё это организовал...";
		...
		case "SCQ_Revenge_7":
			...
			SetSeekCapCitizenParam(npchar, PIRATE);
			dialog.text = "Всё, что у меня есть. Я отдам вам мои драгоценности и " + FindRussianMoneyString(sti(npchar.quest.money)) + "! Устроит?";
		...
		case "SCQ_Pirates_6":
			...
			link.l1 = "Если всё получится, тогда и будете благодарить, а пока не стоит. Расскажите-ка лучше, как зовут вашего мужа и все, что вы знаете об этих пиратах.";
		...
		case "SCQ_Pirates_7":
			...
			link.l1 = "Ясно. Ну что же, теперь ожидайте и надейтесь, что мне повезёт с поисками. Постарайтесь находиться в церкви, чтобы я мог"+ GetSexPhrase("","ла") +" вас там быстро найти.";
			link.l1.go = "exit";
			//==> ставим квестодателя в церковь
			pchar.quest.SeekShip_Stay.win_condition.l1 = "ExitFromLocation";
			npchar.location = npchar.city + "_church";
		...
		case "SCQ_womanResult":
			...
			switch (npchar.quest.SeekCap)
			{
				case "womanHasbandover":
					...
					link.l1 = "Да, всё верно, " + GetAddress_FormToNPC(NPChar) + ". Ваш муж, " + npchar.quest.SeekCap.capName + ", жив и здоров. Он просто заработался, так сказать...";
		...
		case "SCQR_womanHasband":
			dialog.text = "Боже мой, как я вам благодарна! Да, кстати, вот ваши " + FindRussianMoneyString(sti(npchar.quest.money)) + ". И ещё раз спасибо!";
			link.l1 = "Хм, да не за что...";
			link.l1.go = "SCQ_exit";
			sTemp = "SCQ_" + npchar.index;
			pchar.quest.(sTemp).over = "yes"; //снимаем прерывание смерть горожанина-квестодателя
		...
		case "CCmanSlave_3":
			...
			link.l1 = "Ну, не тебе места распределять. Так что придётся ответить за содеянное!";
		...
		break;
		case "RapeWifeCap_2":
			dialog.text = "Ну и что с того? Она мне нравится, и дело с концом. И я не позволю какому-то оборванцу вмешиваться в наши отношения только потому, что он её муж, видите ли!..";
		...
		case "RapeWifeCap_Board": //абордаж
			...
			link.l1 = "Я приш"+ GetSexPhrase("ел","ла") +" за женщиной, что ты украл у мужа. Вспомни " + XI_ConvertString("Colony"+npchar.quest.cribCity) + "! Её зовут " + sld.quest.SeekCap.name + " " + sld.quest.SeekCap.lastname + ".";
			link.l1.go = "RapeWifeCap_Board_1";
		break;
		case "RapeWifeCap_Board_1":
			dialog.text = "Дьявол!! Тебе не видать её как своих ушей!";
		...
		case "manRapeWife_Board_2":
			dialog.text = "Слава Господу Всемогущему!!! Я готова, давайте быстрей уйдём отсюда!";
		...
		break;
		case "FriendCap_2":
			dialog.text = "Ха, ещё бы! А где он живёт?";
		...
		break;
		case "FriendCap_exit":
			dialog.text = "Всё нормально, без проблем? Извините, я немного переживаю...";
			link.l1 = "Всё в порядке, приятель.";
			link.l1.go = "exit";
			NextDiag.TempNode = "FriendCap_exit";
		break;
		...
		case "FriendCap_inDeck_2":
			dialog.text = "О-о-о, нашёлся всё-таки! Очень хорошо... Вы меня извините за грубый приём, я, знаете ли, грешным делом подумал, что вы пират.";
			link.l1 = "Так и есть. Но тебе пока ничего не угрожает. Меня просили передать тебе сообщение, что я и сделал"+ GetSexPhrase("","а") +". Твой земляк, кстати, живёт и работает в " + XI_ConvertString("Colony"+npchar.quest.cribCity+"Dat") + ".";
		...
		break;
		case "HasbandCap_2":
			dialog.text = "Ха! Ну, это понятно... Вообще-то я настолько закрутился с работой, что мне не до неё сейчас. Выгодные предложения следуют одни за другими, я не могу упускать возможную выгоду только потому, что моя жена волнуется.";
		...
		case "RevengeCap_3":
			...
			link.l1 = ""+ GetSexPhrase("Если бы не было так грустно... Сожалею, но за вашу","Ничего смешного в этом нет. За вашу") +" голову назначена награда. И я намерен"+ GetSexPhrase("","а") +" её получить.";
		...
		break;
		case "RevengeCap_5":
			dialog.text = ""+ GetSexPhrase("Да какой ты мне друг, идиот?! Ты и капитаном-то назваться не можешь. Так, прихвостень на побегушках у вздорной фурии","Чёрт возьми! Одна вздорная фурия наняла другую! Что же это за дела такие творятся?") +"!";
			link.l1 = ""+ GetSexPhrase("Вот как?!","Ты использовал её в своих корыстных целях, так что нечего удивляться тому, что она решила отомстить.") +"";
		...
		case "RevengeCap_6":
			...
			link.l2 = "А знаешь... Живи пока. Не хочу прямо здесь замарать твоей кровью улицы этого городка. Мы ещё встретимся!";
			link.l2.go = "exit";
			NextDiag.TempNode = "RevengeCap_6lf";
		break;
		case "RevengeCap_6lf":
			dialog.text = GetSexPhrase("А-а!.. Защитник угнетённых девиц! Как же, помню тебя. Что надо?", "А-а!.. Нанимательница вздорной фурии? Что надобно?");
			link.l1 = GetSexPhrase("Я пришёл, чтобы убить тебя, негодяй.", "Злобная фурия желает твоей смерти, мерзавец. Умри!");
			link.l1.go = "RevengeCap_7";
			link.l2 = "Ничего. Ступай по своим делам.";
			link.l2.go = "exit";
			NextDiag.TempNode = "RevengeCap_6lf";
		break;
		case "RevengeCap_7":
		...
		case "RevengeCapCap_exit":
			dialog.text = "С тобой у меня уже был разговор. "+ GetSexPhrase("Пошёл вон, прохвост","Убирайся, злыдня") +"...";
		...
		case "RevengeCap_board": //абордаж
			dialog.text = "Что происходит, чёрт возьми?! Зачем вы напали на мой корабль?!";
		...
		case "RevengeCap_board_1":
			...
			link.l1 = ""+ GetSexPhrase("А придётся.","Пришло тебе время ответить за свои подлые делишки!") +"";
		...
		case "RevengeCap_board_2":
			...
			link.l1 = "Попробуйте, что я ещё могу сказать?..";
		...
		case "PiratesCap_inDeck_2":
			dialog.text = "Сожалею, но это невозможно. Если это всё, то я прошу вас покинуть мой корабль.";
		...
		case "PiratesCapCap_exit":
			dialog.text = "Мы уже говорили о моём пленнике. Ничего не изменилось.";
			link.l1 = "Понятно...";
			link.l1.go = "exit";
		break;
		...
		//несчастный мушкетёр
		case "OffMushketer":
			dialog.text = "Приветствую "+ GetSexPhrase("гостя","прекрасную гостью") +" в моём доме. Что вы хотели здесь?";
			link.l1 = "Познакомиться. Меня зовут капитан " + GetFullName(pchar) + ".";
			link.l1.go = "OffM_1";
		break;
		case "OffM_1":
			dialog.text = "Рад знакомству, капитан. Чем я могу вам помочь?";
			link.l1 = "Да так, ничем особенным... А вы по виду человек военный. Ещё на службе состоите?";
			link.l1.go = "OffM_2";
		break;
		case "OffM_2":
		...
		break;
		case "OffM_4":
			dialog.text = "Мушкетёром. Я был лучшим стрелком в полку!";
		...
		break;
		case "OffM_6":
			dialog.text = "Всё дело в психической травме. Не могу брать в руки оружие!";
			link.l1 = "Странно всё это. А как же вы воевали в армии?";
			link.l1.go = "OffM_7";
		break;
		case "OffM_7":
			dialog.text = "Понимаете, мне в своё время достался английский мушкет, каких мало. Два ствола, усовершенствованная казённая часть, позволяющая заряжать быстрее. В общем, настоящее произведение искусства, работа мастера.\n"+
		...
		case "OffM_9":
			...
			link.l1 = "Ну, может другой найдётся, подобный...";
			link.l1.go = "OffM_10";
		break;
		case "OffM_10":
			dialog.text = "Найдётся?.. Хм, послушайте, если вы найдёте мой двуствольный мушкет, то я пойду к вам в офицеры. Обещаю.";
		...
		case "OffM_11":
			...
			link.l1 = "М-да, ситуация... Ну что же, как говорится, будем искать. Если мне ваш мушкет попадётся, то обязательно принесу его сюда.";
			link.l1.go = "OffM_12";
		break;
		case "OffM_12":
		...
		case "OffM_result":
			...
			{
				link.l1 = "Нет ещё. Но я занимаюсь этим.";
				link.l1.go = "exit";
			}
		break;
		case "OffM_result_1":
		...
		break;
		case "OffM_result_2":
			dialog.text = "Моё слово железное. Я готов. Только давайте обсудим размер моего гонорара. За свою верную службу я хочу получать " + FindRussianMoneyString(sti(Npchar.quest.OfficerPrice)) + " в месяц.";
		...
		case "OffM_Ok":
			...
			dialog.text = "Хорошо. Но это ещё не всё. Я требую единовременного пособия, так сказать. Поиздержался без работы, вот и надо оплатить долги. Думаю, что " + FindRussianMoneyString(sti(Npchar.quest.OfficerPrice.add)) + " меня устроят.";
			link.l1 = "Чего?!!";
