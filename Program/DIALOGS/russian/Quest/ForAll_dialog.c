...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PKInMarigo_4":
			...
			link.l1 = "Хорошо. Я знаю, что вы являетесь представителем Голландской Вест-Индской компании в Карибском море. Знаю также, что вы ведёте дела с генерал-губернатором Стэвезантом. И ещё я хочу знать, какого черта вам не угодили местные бродяги.";
