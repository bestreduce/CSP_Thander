...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "Это вы "+ GetSexPhrase("тот человек, который получил","та девушка, которая получила") +" задание от Антониу де Соуза?";
            ...
            {
    			dialog.text = "Я сдаюсь, ты победил"+ GetSexPhrase("","а") +"!";
			...
			{
                dialog.text = ""+ GetSexPhrase("Месье","Мадемуазель") +", меня послал к вам начальник порта.";
			...
			{
                dialog.text = "Дьявол!!! Все так хорошо начиналось - мы отловили Пардаля... И тут появил"+ GetSexPhrase("ся","ась") +" ты...";
    			link.l1 = "Хм, для того и появил"+ GetSexPhrase("ся","ась") +", чтобы ваши хорошие начинания закончились не так славно...";
    			link.l1.go = "Step_S7_1";
            }  //квест №8, капитан Ансель.
 			if (pchar.questTemp.State == "Sp8SaveCumana_toCumana")
			{
                dialog.text = "Аргх, проклятая испанская собака!";
...
//*************************** Квест №2, диалоги с Франциско на выходе из Инквизиии ***************************
 		case "Step_S2_1":
			dialog.text = "Я знаю, в чём заключается ваше задание, и знаю, чем оно может закончиться. Ордену выгодно поправлять свои финансовые дела за счёт негоциантов, тем более чужими руками.";
		...
		break;
 		case "Step_S2_3":
			...
			link.l1 = "Я принял"+ GetSexPhrase("","а") +" ваши слова к сведению. Но с кем я имею честь общаться?";
		...
		break;
 		case "Step_S2_7":
			dialog.text = "Вот чёрт возьми! И на что только эти девки не идут, чтобы замуж выскочить! Это же надо - головорезов нанять!";
			link.l1 = "Она меня не нанимала, наши интересы просто совпали в данный момент...";
			link.l1.go = "Step_S2_8";
		break;
 		case "Step_S2_8":
			dialog.text = "Уф, уже лучше... Знаешь, как-то рано мне ещё семью заводить... А тебе что нужно от меня?";
		...
		break;
 		case "Step_S2_9":
			dialog.text = "Не худший вариант в моём нынешнем положении. Спасибо, что не убил"+ GetSexPhrase("","а") +" меня.";
			link.l1 = "Таннекен благодари, просила не трогать тебя, мерзавца... Ну и всё на этом.";
		...
		break;
 		case "Step_S2_12":
			dialog.text = "Та-а-ак... Тебе пора на тот свет, говорун"+ GetSexPhrase("","ья") +"...";
		...
		break;
 		case "Step_S2_14":
			...
			link.l1 = "Зовут " + GetFullName(pchar) + ", к вашим услугам. Ну вот... мой корабль ждёт в Порто Белло, мы можем отправляться.";
			link.l1.go = "Step_S2_15";
		break;
 		case "Step_S2_15":
			dialog.text = "Не хочу показаться назойливым, но, видя, как вы держались и разделались с этими людьми, я понял, что вы человек военный"+ GetSexPhrase("",", хоть и девушка") +". Хочу попросить вас об одном одолжении.\n"+
		...
		break;
 		case "Step_S2_16":
			dialog.text = "Она пропала у нас где-то 20 лет назад вместе с её хранителем - Самуэлем Кохэно.";
			link.l1 = "Где-то я уже слышал"+ GetSexPhrase("","а") +" это имя...";
			link.l1.go = "Step_S2_17";
		break;
 		case "Step_S2_17":
			dialog.text = "Это вряд ли. Так вот, недавно мы вышли на след похитителя, он объявился на Бермудах. Попытки выкупить у него реликвию не принесли результата, тогда мы наняли матросов из таверны. Вор оказался на удивление силён и даже ранил нескольких человек, после чего бросился бежать. Матросы следовали за ним по пятам и нагнали у верфи. Но там он как сквозь землю провалился.";
			link.l1 = "Как это?";
			link.l1.go = "Step_S2_18";
		break;
 		case "Step_S2_18":
			dialog.text = "Он зашёл в контору верфи - и все. Куда он делся - совершенно непонятно. Хозяин верфи нам так ничего и не сказал. Я прошу вас помочь мне вернуть книгу. Вы поможете мне?";
		...
		break;
 		case "Step_S2_19":
			...
			link.l1 = "Защита христианских реликвий - святой долг каждого истинного католика... Но я ещё ничего не решил"+ GetSexPhrase("","а") +", посмотрим по обстоятельствам.";
