    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (pchar.questTemp.State == "Sp10Maracaibo_toMaracaibo")
			{
				...
				link.l1 = "Сеньор, я прибыл"+ GetSexPhrase("","а") +" к вам для выполнения ответственного поручения по защите Маракайбо от внешней угрозы. Я командирован"+ GetSexPhrase("","а") +" в ваше распоряжение губернатором Гаваны Франсиско Орегон-и-Гасконом.";
			...
			{
				dialog.text = "Отличная работа, "+ GetSexPhrase("друг мой","сеньорита") +". Дон Франсиско прислал мне очень храброго и толкового капитана!";
        ...
        case "Step_S10_2":
			...
			link.l1 = "Понятно. Что я долж"+ GetSexPhrase("ен","на") +" делать сейчас?";
			link.l1.go = "Step_S10_3";
        break;
        case "Step_S10_3":
			dialog.text = "Собственно, ничего. Просто находитесь в состоянии боевой готовности.";
			link.l1 = "Я и моя команда всегда находятся в таком состоянии... Ну что же, если я вам не нуж"+ GetSexPhrase("ен","на") +", то я, пожалуй, пройдусь по городу по своим делам.";
			link.l1.go = "exit";
