...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_H2_1":
			dialog.text = "Так, давайте прочтем... Ну что же, с бумагами всё в порядке. Всю партию товара вы можете получить в местном магазине, я немедленно распоряжусь выдать её вам.\n"+
                          "Партия состоит из кофе, чёрного, красного и сандалового дерева. Общий вес партии товара, приготовленного к отправке - 5600 центнеров. Рассчитайтесь в магазине - и можете приступать к погрузке.";
        ...
        case "Step_H4_1":
			dialog.text = "Чёрт возьми, вы не просто успели, вы просто спасли нас! Форт Оранж благодарит вас от всей души! Моё почтение Питеру Стэвезанту.";
