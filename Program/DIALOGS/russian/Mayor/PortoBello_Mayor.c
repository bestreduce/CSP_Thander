    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if (pchar.questTemp.State == "Sp9SaveCumana_toPortoBello")//квест №9 испанки.
			{
				...
				link.l1 = "Меня зовут " + GetFullName(pchar) + ", прошу ознакомиться с данным документом. Это верительное письмо на моё имя за подписью генерал-губернатора Франсиско Орегон-и-Гаскона.";
			...
			if (pchar.questTemp.State == "Sp9SaveCumana_toCompOut")//квест №9 испанки, после того, как 0 компаньонов.
			{
				...
				link.l1 = "Я по поводу задания. Вы готовы передать в моё распоряжение названные галеоны?";
        ...
        case "Step_S10_1":
			...
			link.l1 = "В общих чертах, я вроде бы долж"+ GetSexPhrase("ен","на") +" сопроводить куда-то некие корабли...";
			link.l1.go = "Step_S10_2";
  			TakeItemFromCharacter(pchar, "letter_1");
            BackItemDescribe("letter_1");
        break;
        case "Step_S10_2":
			dialog.text = "Хм, правильно. Я даю вам в распоряжение четыре галеона, гружёные золотом. Вам необходимо доставить их в целости и сохранности до необитаемого острова Кайман. Вам все ясно?";
			link.l1 = "Не совсем... Если позволите, я выскажу своё мнение по данному поводу.";
			link.l1.go = "Step_S10_3";
        break;
        case "Step_S10_3":
			dialog.text = "Да, конечно.";
			link.l1 = "Я понимаю, когда речь идёт о доставке золотых галеонов в укреплённый город, под защиту мощного форта. Но везти их к необитаемому острову...";
