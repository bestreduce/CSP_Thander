    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            if (pchar.questTemp.State == "Sp5LaVegaAttack_toSantiago")
            {
    			...
    			link.l1 = "Я командирован"+ GetSexPhrase("","а") +" в ваше распоряжение генерал-губернатором Гаваны.";
        ...
        case "Step_S5_1":
			...
			link.l1 = "Всегда готов"+ GetSexPhrase("","а") +".";
        ...
        case "Step_S5_6":
			...
			link.l1 = "Буканьеры - достойный противник, я рад"+ GetSexPhrase("","а") +", что сумел"+ GetSexPhrase("","а") +" выполнить поставленную задачу... Сеньор, а вознаграждение?";
