...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "pirateStartQuest_3":
			dialog.text = "Если бы у меня был хоть намёк, я обошёлся бы и без твоих услуг. Они бы уже к ночи ловили кальмаров на живца. Но меня больше интересует другое - как они узнали о грузе 'Сентблу' и о моём заказчике? Уж очень все быстро у них срослось. Смекаешь?";
		...
		//********************* Английская линейка *********************
 		...
 		case "Step_1":
			...
			link.l1 = "Сэр Томас Мэдифорд просит вас собрать каперскую эскадру, возглавить её и атаковать голландский форпост в Карибском море - город Кюрасао.";
			link.l1.go = "Step_2";
  		break;
 		case "Step_2":
			dialog.text = "Хм... А в чём причина такого решения? Признаюсь, оно выглядит странным. Англичане не нападают на голландцев. Да, у государств есть противоречия в торговой экспансии, но они распространяются на Индийский океан. Здесь же - Новый свет.";
        ...
        break;
 		...
 		case "Step_H3_3":
  		...
  		break;
 		case "Step_H3_4":
			dialog.text = "Всё дело в том, что я не знаю ничего о планах Мэдифорда по этой войне. У меня с ним дела другого порядка, политика здесь ни при чем.";
 		...
 		case "Step_H3_5":
			dialog.text = "Не надо пафосных выражений, "+ GetSexPhrase("молодой человек","девушка") +", я знаю, кто я такой. Но я действительно ничего не ведаю о планах Мэдифорда. Однако, вот что я тебе расскажу.\n"+
                          ...
                          "Итого получается, что известный пройдоха Томас Мэдифорд пытался открыть боевые действия против Нидерландов с помощью пиратов. Хитёр, что тут ещё скажешь...";
 		...
 		case "Step_H3_6":
			dialog.text = "Планировать нападение на Кюрасао он может, а вот выполнить данное мероприятие - вряд ли. У него недостаточно сил для такой операции, не от хорошей жизни он пытался привлечь корсарство.\n"+
                          "Да и вообще, самой надёжной охраной Порт Рояля от тех же испанцев является постоянное присутствие некоторого количества пиратов на рейде Ямайки. Так что нет, Кюрасао сейчас ему не по зубам.";
			link.l1 = "Ну что же, все ясно, нападения можно не опасаться...";
			link.l1.go = "Step_H3_7";
  		break;
 		case "Step_H3_7":
			dialog.text = "Я бы так категорично не мыслил. Дело в том, что раз попытка привлечения корсаров к нападению была, значит Мэдифорд всё-таки имеет приказ открыть боевые действия. Так что мира здесь между Англией и Голландией не будет точно.\n"+
 		...
 		case "Step_H3_9":
  		...
  		break;
 		case "Step_H3_10":
			dialog.text = "Нет, это не обязательно. Вряд ли кто-то в своём уме будет вводить в заблуждение Моргана, такой человек долго не проживёт. Он тебе поверит.";
