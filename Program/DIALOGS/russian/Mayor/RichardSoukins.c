...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PL_Q8_deck_2":
			dialog.text = "Ну и что ты опять делаешь у меня на палубе? Думаешь, если ты удачно пров"+ GetSexPhrase("ёл","ела") +" штурм Порто Белло, то теперь можно пав"+ GetSexPhrase("лином","ой") +" тут разгуливать?";
		...
		break;
		case "PL_Q8_deck_4":
			dialog.text = "Я тебе отчёта давать не намерен, ты мне другом не являешься. Так что убирайся отсюда к чертям собачьим.";
		...
		break;
		case "Shore48_over":
			dialog.text = "Чего мы ждём? Давай, двигай свою задницу к Панаме!!";
		...
		break;
		case "PQ8_exitTown_2":
			dialog.text = "Ты не раз лез"+ GetSexPhrase("","ла") +" в мои дела, портил"+ GetSexPhrase("","а") +" мои замыслы. Ты - "+ GetSexPhrase("шестёрка","подстилка") +" Моргана. И теперь хочешь пошестерить на меня, что ли?";
			link.l1 = "Да пошёл ты, Ричард... Идиот!";
			link.l1.go = "PQ8_exitTown_3";
		break;
		case "PQ8_exitTown_3":
			dialog.text = "Я-то, конечно, пойду... в Панаму. А вот ты в город не войдёшь. Так что вали отсюда, пока цел"+ GetSexPhrase("","а") +"...";
			link.l1 = "Дьявол!..";
			link.l1.go = "exit";
