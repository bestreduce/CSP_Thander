...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		//ОЗГ, Крыса
		case "Rat_portmanC":
			dialog.text = "А что там рассказывать. Загрузился в нашем магазине флейт 'Счастливая невеста' сандалом под завязку, вышел в море - а в порт назначения не пришёл. Я таких историй за свою службу насмотрелся немало, и меня это не удивляет.";
