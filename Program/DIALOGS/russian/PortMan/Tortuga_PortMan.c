...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Я уполномочен"+ GetSexPhrase("","а") +" засвидетельствовать вам своё почтение и ознакомить с моими документами. Извольте прочесть мою торговую доверенность Французской Ост-Индской компании.";
                link.l1.go = "Step_S6_1";
            }
            if (pchar.questTemp.State == "Sp6TakeMess_waitMessanger")
            {
                link.l1 = "Послушайте, не было ещё ожидаемого мной голландского корабля?";
                link.l1.go = "Step_S6_6";
            }
            if (pchar.questTemp.State == "Fr4SoleiRoyal_toPortMan")
            {
                link.l1 = "Согласно предписанию д'Ожерона вам нужно передать в моё распоряжение линейный корабль первого класса 'Солей Руаяль'.";
...
//************************************* Голл. линейка, квест №7, доставка депеши *******************************
		case "Step_H7_1":
            dialog.text = "Только одно - бриг 'Ла Рошель'. Он ушёл на Пуэрто-Рико по направлению к Сан-Хуану. С ним ушёл и торговый представитель Французской Ост-Индской компании.";
		...
		case "Step_H7_2":
            dialog.text = "Я же говорю: представитель Французской Ост-Индской компании. Он прибыл сюда несколько дней назад и сразу предъявил доверенность компании. Дела свои он сделал и хотел отправиться отсюда сразу к вам, на Кюрасао, для чего искал попутное судно. Я и направил его к вам.\n"+
                          "Но в последний момент планы у него, видимо, изменились, и он ушёл с бригом, на котором и пришёл на Тортугу, собственно.";
			link.l1 = "Чёрт возьми, похоже, что это и есть Антонио...";
			link.l1.go = "Step_H7_3";
		break;
		case "Step_H7_3":
            dialog.text = "Совершенно правильно, Анотио де... де... Не вспомню уже.";
			link.l1 = "Я долж"+ GetSexPhrase("ен","на") +" немедленно догнать этот проклятый бриг. Это вопрос жизни и смерти.";
...
//************************************* Испанская линейка, квест №6, перехват вестового *******************************
		case "Step_S6_1":
			...
			link.l1 = HeroStringReactionRepeat("Я это знаю. У меня к вам просьба другого свойства... Дело в том, что я практически закончил"+ GetSexPhrase("","а") +" здесь дела, по которым прибыл"+ GetSexPhrase("","а") +". Далее я долж"+ GetSexPhrase("ен","на") +" прибыть в Виллемстад, что на острове Кюрасао. Так вот, я бы хотел"+ GetSexPhrase("","а") +" сделать это на попутном судне. Может вы подскажете мне, нет ли у вас в порту достаточно быстроходных судов, идущих на Кюрасао?",
		...
		break;
 		case "Step_S6_3":
			...
			link.l1 = "О, это прекрасно, идеальный вариант для меня. Не будете ли вы так любезны сообщить мне, когда такой корабль войдёт в порт Тортуги?";
			link.l1.go = "Step_S6_4";
		break;
 		case "Step_S6_4":
            dialog.text = "Хорошо. Где вы остановились, "+ GetSexPhrase("месье","мадемуазель") +"?";
			link.l1 = "Я снял"+ GetSexPhrase("","а") +" комнату в таверне.";
		...
		break;
 		case "Step_S6_6":
            dialog.text = "Нет, ещё не было. Я же сказал вам, что отправлю посыльного. Не беспокойтесь, я помню о вас.";
...
//************************************* Французская линейка, квест №4, Солей Руаяль *******************************
 		case "Step_F4_1":
            ...
            {
                dialog.text = "Да, я уже уведомлен, "+ GetSexPhrase("месье","мадемуазель") +". Принимайте командование. По чести сказать, командовать таким кораблём - счастье даже для адмирала...";
    			link.l1 = "Полностью соглас"+ GetSexPhrase("ен","на") +" с этим утверждением, сударь... А теперь позвольте откланяться - дела.";
