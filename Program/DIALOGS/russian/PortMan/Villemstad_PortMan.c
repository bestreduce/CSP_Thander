...
//************************************* Диалоги по голл.линейке *******************************
		...
		//ОЗГ, Крыса
		case "Rat_portmanV":
			dialog.text = "Да, пару недель назад, или около того, тяжёлый галеон 'Санта Анна' вышел из гавани, и, как говорят, не пришёл в указанный пункт. Больше его никто не видел, а почему вам это интересно?";
			link.l1 = "Это, скажем так, частный интерес. Никаких подробностей не припомните?";
			link.l1.go = "Rat_portmanV_1";
		break;

		case "Rat_portmanV_1":
			dialog.text = "Что я могу припомнить, погодите минутку... Да, вот здесь запись – тяжёлый галеон 'Санта Анна' отплыл с грузом чёрного дерева на борту, более шестисот единиц. Так... в порт назначения не явился. Вроде бы и все.";
			link.l1 = "Скажите, а какие корабли вышли из гавани в тот же день, или днём позже этого галеона?";
