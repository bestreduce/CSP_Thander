...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		//ОЗГ, Крыса
		case "Rat_portmanP":
			dialog.text = "Да, премерзкая история вышла – как сейчас помню: целый пинас, гружённый красным деревом чуть не под завязку. Его капитан так радовался тогда удачной сделке – целый вечер накануне отплытия кутил в таверне и хвастался. А потом пришла весть, что он так и не добрался до порта, куда держал курс. Говорят – его перехватили какие-то пираты.";
