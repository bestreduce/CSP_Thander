void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "OnceAgain":
			...
			link.l1 = "Вы правы, герр офицер, определённо правы. Напомните, во сколько вы оценили свою службу на моём корабле?";
			link.l1.go = "Saxon_4";
        ...
        case "OnceAgainLP":
			...
			link.l1.go = "Lostpirate_check";
            link.l2 = "Очень может статься, что именно по этой причине на моём корабле команда до сих пор не перестреляла друг друга. Возможно, кто-то и поверит в твои россказни, но я сегодня слишком трезв"+ GetSexPhrase("","а") +" для этого.";
			link.l2.go = "exit";
		break;
