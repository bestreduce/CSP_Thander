...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Spanch_Bob_3":
			dialog.text = "И правильно решил" + GetSexPhrase("","а") +"! Помниться я тоже в эту игру играл, славные были деньки. Давненько это было. Да только всё время не везло нашей команде. То мачта сломается, то на мель сядем, то ещё какая-нибудь пакость приключится.";
		...
		case "Justin_Butt_12":
			dialog.text = "Да, а зачем оставлять его в живых? Я оставлял в живых только тех, кого опасно было убивать. Рыбака с пляжа Фахардо я прикончил, пьяного с Ламантена – тоже. Про агента залива Гибели ты уже знаешь – его постигла та же участь. Всех остальных агентов я оставил в живых.";
		...
		// НЕЗНАКОМЕЦ В ДОМЕ -->
		case "NoName_1":
			dialog.text = "Ты перв" + GetSexPhrase("ый","ая") +", кто добрался до сокровища, дозорн" + GetSexPhrase("ый","ая") +". Поздравляю!";
