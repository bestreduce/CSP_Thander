...
//*************************** Квест №2 испанки, задание Инквизиции ***************************
 		...
 		break;
 		case "Step_S2_2":
    		dialog.text = "Если бы в моём распоряжении была такая сумма, я бы заплатил.";
		...
		case "Dozor_2":
			...
			link.l1 = "Я бы предпоч"+GetSexPhrase("ёл","ла")+" поскорее получить Мекахром, чем выслушивать подобные истории.";
			link.l1.go = "Dozor_3";
		break;
