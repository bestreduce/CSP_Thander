...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "HeadMan":
			...
			{
				link.l2 = "Я прибыл"+ GetSexPhrase("","а") +" за наградой, сеньор.";
		...
		case "SharpSeekSpy_2":
			...
			link.l1 = "Только то, что я уже сказал"+ GetSexPhrase("","а") +". В Карибском море всем известен капитан Шарп...";
		...
		break;
		case "SharpSeekSpy_4":
			dialog.text = "Нет, это слишком просто. К тому же неэффективно. Ведь тот мерзавец, что сливает информацию о месте наших работ, просто найдёт себе другого 'шарпа', и наши тартаны опять будут грабить.";
			link.l1 = "Логично.";
		...
		break;
		case "SharpSeekSpy_6":
			dialog.text = "Хм, ну давайте обсудим. Итак, я мог бы предложить вам жемчуг и деньги, но я предложу нечто, на мой взгляд, более интересное для вас.\nЭто комплект вооружения. В него входит бретёрский пистолет, испанская рапира, рейтарский чекан и офицерская кираса! Поверьте мне, одна кираса дорогого стоит!";
		...
		case "SharpSeekSpy_8":
			dialog.text = "Тогда я жду от вас хороших вестей, капитан! Отчитаться и получить обещанную награду вы сможете у любого из старшин двух поселений ловцов жемчуга, они будут в курсе нашего договора.";
			link.l1 = "Я понял"+ GetSexPhrase("","а") +". Приступаю к поискам немедленно.";
		...
		case "SharpSeekSpy_10":
			dialog.text = "Та-а-ак, мне известно, кто вы. Ну, рассказывайте, что вы сумели раскопать.";
			link.l1 = "Я наш"+ GetSexPhrase("ел","ла") +" человека из ваших, кто сливал Шарпу информацию о ваших тартанах. Это Эмилио Гарсиа.";
			link.l1.go = "SharpSeekSpy_11";
		break;
		case "SharpSeekSpy_11":
			dialog.text = "Вы можете это доказать?";
			link.l1 = "Да. Мне удалось выследить его и настигнуть в пещере залива Сан-Хуан дель Норте как раз в момент разговора с доверенным лицом Шарпа. Я убил"+ GetSexPhrase("","а") +" их обоих.";
			link.l1.go = "SharpSeekSpy_12";
		break;
		case "SharpSeekSpy_12":
			dialog.text = "Понятно... Ну что же, я верю вам. Ваша награда за проделанную работу - комплект боевой амуниции. Верно?";
		...
		case "SharpSeekSpy_13":
			...
			link.l1 = "Очень рад"+ GetSexPhrase("","а") +", что смог"+ GetSexPhrase("","ла") +" оказаться вам "+ GetSexPhrase("полезен","полезна") +". Прощайте, сеньор.";
			link.l1.go = "exit";
		...
		case "PearlMan_2":
			...
			{
				dialog.text = "У нас с этим делом жёстко, можно запросто лишиться головы. Я этим не занимаюсь, но могу посоветовать тебе обратиться к местным индейцам, что работают вместе с нами. Им есть куда бежать в случае чего, они посмелее нас будут...";
		...
		case "PearlMan_Sharp_1":
			dialog.text = LinkRandPhrase("Ты чего, на голову "+ GetSexPhrase("больной? Иди отсюда, придурок","больная? Иди отсюда, дура") +"!",
				""+ GetSexPhrase("Чего?!! Ты, часом, белены не объелся, идиот","Чего?!! Ты, часом, белены не объелась, дурёха") +"?! Вали отсюда со своими вопросами...",
				""+ GetSexPhrase("Ты в своём уме, родной? Какие пираты?! У нас?!! Шёл бы ты отсюда, малахольный","Ты в своём уме, родная? Какие пираты?! У нас?!! Шла бы ты отсюда, милочка") +"...");
		...
		case "IndPearlMan_Sharp_2":
			dialog.text = "Я знаю, что хочет "+ GetSexPhrase("бледнолицый","белая скво") +"...";
			link.l1 = "Чего?";
			link.l1.go = "IndPearlMan_Sharp_3";
		break;
		case "IndPearlMan_Sharp_3":
			dialog.text = "Слушай меня, "+ GetSexPhrase("бледнолицый брат","белая скво") +", я много говорить не буду. Есть здесь человек, звать Эмилио Гарсиа. Его видели в пещере одной бухты.";
			link.l1 = "Какой бухты?";
