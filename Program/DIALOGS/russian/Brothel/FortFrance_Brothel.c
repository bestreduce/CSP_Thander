...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
        ...
        case "Step_H8_1":
            dialog.text = ""+ GetSexPhrase("Молодой человек","Юная леди") +", они отдыхают у нас в компании девушек, а не друг друга! Следите за тем, что произносите...";
        ...
        break;
        case "Step_H8_3":
            dialog.text = "Да потому, что всё моё заведение работало на них в эту ночь. Ужас был какой-то!";
            link.l1 = "Понятно... Слушай, ты не слышала вот о чём: кто-то пытался продать одну книгу, вроде Библию...";
        ...
        break;
        case "Step_H8_5":
            dialog.text = "Может и подскажут. Только мне до этого дела нет, спрашивай "+ GetSexPhrase("сам","сама") +".";
