...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Apteka":
			dialog.text = "Аптека находится рядом с набережной по соседству с таверной и церковью. Здание окрашено в сине-белые цвета. Парадный вход закрыт, поэтому лучше заходить с правой стороны. Подойдя к арке, сразу заходите внутрь двора, и поворачиваете налево, к синей двери. Надеюсь, эта информация была вам полезна.";
		...
		case "GVIK":
			dialog.text = "Голландская Вест-Индская компания расположена в большом административном здании, которое окрашено в жёлтый цвет. На одной из башен висят огромные красивые часы. При входе имеется хорошо вооружённая охрана. Надеюсь, эта информация была вам полезна.";
            link.l1 = "Как же ты меня выручил"+ NPCharSexPhrase(NPChar,"","а") +", благодарю!";
			link.l1.go = "exit";
			link.l2 = "Я ещё вот что хотел спросить.";
			link.l2.go = "new question";
