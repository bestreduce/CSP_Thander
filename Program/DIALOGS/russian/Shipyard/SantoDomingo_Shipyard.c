...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Мне сказали, что у тебя продаётся шхуна 'Ласточка', это так?";
				link.l1.go = "PL_Q7_1";
			}
		break;
		//пиратка, квест №7
		case "PL_Q7_1":
			dialog.text = "Нет, не так. Не продаётся, а уже продана. Пришёл покупатель и так он мне понравился, что отдал я ему эту шхуну буквально за гроши...";
