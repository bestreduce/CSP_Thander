...
int LocationInitPanama(int n)
{
	...
	locations[n].image = "loading\jonny_load\city\Town_Panama.tga";
	...
	locations[n].reload.l5.go = "Panama_shipyard";
	...
	locations[n].reload.l11.go = "Panama_houseSp1";
	...
	locations[n].image = "loading\jonny_load\inside\residence02.tga";
	//Town sack
	locations[n].townsack = "Panama";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	locations[n].image = "loading\jonny_load\inside\BigHouse01_(BigHouse01_2Door).tga";
	//Town sack
	locations[n].townsack = "Panama";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Дом, где держат взаперти Якова по испанке
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Panama_houseSp1_Room";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	n = n + 1;
	...
	locations[n].id.label = "Room";
	locations[n].image = "loading\jonny_load\inside\largehouse02.tga";
	//Town sack
	locations[n].townsack = "Panama";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Panama_houseSp1";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
