...
int LocationInitGuadeloupe(int n)
{
	...
	locations[n].image = "loading\jonny_load\city\Town_Guadeloupe.tga";
	...
	locations[n].image = "loading\jonny_load\inside\residence04.tga";
	//Town sack
	locations[n].townsack = "BasTer";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	locations[n].id = "BasTer_Graveyard";
	...
	locations[n].reload.l1.go = "Shore29";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Shore29";
	locations[n].locators_radius.reload.reload2_back = 2.0;

	locations[n].reload.l2.name = "reload1_back";
	locations[n].reload.l2.go = "BasTer_ExitTown";
	...
	locations[n].reload.l3.go = "BasTer_KeepersHouse";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "0";
	locations[n].reload.l3.label = "";

	locations[n].reload.l4.name = "reload4";
	locations[n].reload.l4.go = "BasTer_CryptBig1";
	locations[n].reload.l4.emerge = "reload1";
	locations[n].reload.l4.autoreload = "0";
	...
	locations[n].reload.l6.go = "BasTer_Chapel";
	locations[n].reload.l6.emerge = "reload1";
	locations[n].reload.l6.autoreload = "0";
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// домик смотрителя
	/////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "BasTer_KeepersHouse";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "BasTer_Graveyard";
	locations[n].reload.l1.emerge = "reload3";
	locations[n].reload.l1.autoreload = "0";
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// крипта большая - 1
	/////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "BasTer_CryptBig1";
	...
	locations[n].reload.l3.go = "BasTer_Graveyard";
	locations[n].reload.l3.emerge = "reload1";
	...
	locations[n].image = "loading\jonny_load\inside\cavernBig1.tga";
	...
	locations[n].image = "loading\jonny_load\shores\Passage.tga";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "Guadeloupe";
	//Models
