...
int LocationInitTortuga(int n)
{
	...
	locations[n].image = "loading\jonny_load\city\Tortuga_town.tga";
	...
	locations[n].models.day.locators = "BigHouse02_Blocators";
	//Night
	locations[n].models.night.charactersPatch = "BigHouse02_patch";
	locations[n].models.night.locators = "BigHouse02_BNlocators";
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "false";
	//Reload map
	...
	locations[n].id.label = "DEstre House";
