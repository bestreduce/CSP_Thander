...
{	
	...
	locations[n].image = "loading\jonny_load\city\Town_Martinique.tga";
	...
	locations[n].reload.l12.disable = 1; // закрыто (можно выйти, но не зайти)
	...
	locations[n].image = "Loading\jonny_load\inside\mediumhouse10.tga";
	//Town sack
	locations[n].townsack = "FortFrance";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	Locations[n].reload.l18.go = "LeFransua_Hut2";
	...
	locations[n].id.label = "Room";
	locations[n].image = "loading\jonny_load\inside\barrack.tga";
	//Town sack
	locations[n].townsack = "LeFransua";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	//Always
	locations[n].models.always.house = "Hut2";
	locations[n].models.always.locators = "Hut2_locators";
	locations[n].models.always.house.level = 65538;
	locations[n].models.always.window = "Hut2_window";
	locations[n].models.always.window.tech = "LocationWindows";
	locations[n].models.always.window.level = 65539;
	locations[n].models.always.back = "..\inside_back";
	locations[n].models.always.back.level = 65529;
	...
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	locations[n].reload.l1.disable = 1; // заглушка

	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "LeFransua_town";
	locations[n].reload.l2.emerge = "houseH5";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Street";	
	n = n + 1;
