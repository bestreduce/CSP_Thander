...
//==================PATENTS
	...
	// boal 19.01.2004 -->
	itm.piercing = 20;
	itm.special.valueBB = 6; //Пролом блока
	itm.special.valueB = 6; //Кровоток
	itm.minlevel = 1;
	itm.rare = 0.1;
	itm.block = 15;
	...
	itm.special.valueSS = 6; //Резкий удар
	itm.special.valueB = 12; 	//Кровоток
	itm.minlevel = 1;
	itm.rare = 0.0001;
	itm.block = 92.0;
	itm.param.time = 0.1;
	...
	// boal 19.01.2004 -->
	itm.piercing = 99.0;
	itm.special.valueStS = 10; //Оглушение
	...
	itm.id = "slave_02";
	itm.groupID = BLADE_ITEM_TYPE;
	itm.name = "itmname_slave_02";
	itm.describe = "itmdescr_slave_02";
	itm.folder = "items";
	itm.model = "slave_02";
	itm.picIndex = 15;
	...
	// boal 19.01.2004 -->
	itm.piercing = 90.0;
	itm.special.valueCB = 7; //Пролом кирасы
	...
	// Noctus: Персидский меч
	makeref(itm,Items[n]);
	itm.id = "blade47";
	itm.groupID = BLADE_ITEM_TYPE;
	itm.name = "itmname_blade47";
	itm.describe = "itmdescr_blade47";
	itm.folder = "items";
	itm.model = "blade47";
	itm.picIndex = 14;
	itm.picTexture = "ITEMS_20";
	...
	// LEO: Меч Тритона
	makeref(itm,Items[n]);
	itm.id = "blackbeard_sword";
	itm.groupID = BLADE_ITEM_TYPE;
	itm.name = "itmname_blackbeard_sword";
	itm.describe = "itmdescr_blackbeard_sword";
	itm.model = "blackbeard_sword";
	itm.folder = "items";
	itm.picIndex = 4;
	itm.picTexture = "ITEMS_20";
	itm.price = 3300;
	...
	itm.id = "blade48";
	itm.groupID = BLADE_ITEM_TYPE;
	itm.name = "itmname_blade48";
	itm.describe = "itmdescr_blade48";
	itm.folder = "items";
	itm.model = "blade48";
	itm.picIndex = 2;
	...
	itm.id = "blade29";
	itm.groupID = BLADE_ITEM_TYPE;
	itm.name = "itmname_blade29";
	itm.describe = "itmdescr_blade29";
	itm.folder = "items";
	itm.model = "blade29";
	itm.picIndex = 3;
	itm.picTexture = "ITEMS_19";
	...
	// boal 19.01.2004 -->
	itm.piercing = 70.0;
	itm.special.valueSS = 10; //Резский удар
	itm.special.valueCB = 15; //Пролом кирасы
	itm.special.valueBB = 10; //Пролом блока
	itm.minlevel = 1;
	itm.rare = 0.001;
	...
	itm.piercing = 85.0;
	itm.special.valueT = 8; //Травмы
	itm.special.valueSS = 12; //Резский удар
	itm.special.valueCrB = 10; //Буст крита
	itm.minlevel = 1;
	itm.rare = 0.0001;
	itm.block = 75.0;
...
//	itm.shown = 0;
	...
	makeref(itm,Items[n]); //Карта жемчужных промыслов
	itm.id = "map_Pearl";
	itm.groupID = MAPS_ITEM_TYPE;
	...
	makeref(itm,Items[n]); //Карта запад Мэйна
	itm.id = "map_maine_1";
	itm.groupID = MAPS_ITEM_TYPE;
	...
	makeref(itm,Items[n]);
    itm.id = "map_SentLuchia";
    itm.groupID = MAPS_ITEM_TYPE;
    itm.name = "itmname_map_SentLuchia";
    itm.describe = "itmdescr_map_SentLuchia";
    itm.model = "";
    itm.picIndex = 13;
    itm.picTexture = "ITEMS_20";
    itm.price = (rand(8)+7)*1400;
    itm.Weight = 0.2;
    itm.imageTga = "SentLuchia";
    itm.imageType = "";
    itm.MapIsland = "";
    itm.ItemType = "MAP";
    n++;
	...
	makeref(itm,Items[n]); //Карта центр Мэйна
	...
	makeref(itm,Items[n]); //Карта юг Мэйна
	itm.id = "map_maine_2";
	itm.groupID = MAPS_ITEM_TYPE;
...
//	itm.shown = false;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman5"; // Готнер
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman5";
	itm.describe = "itmdescr_talisman5";
	itm.picIndex = 6;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman10"; // Упырь
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman10";
	itm.describe = "itmdescr_talisman10";
	itm.picIndex = 11;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman11"; // Менестрель
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman11";
	itm.describe = "itmdescr_talisman11";
	itm.picIndex = 14;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman12"; // Аргузин
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman12";
	itm.describe = "itmdescr_talisman12";
	itm.picIndex = 5;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	itm.rare = 0.001;
	itm.kind = "boatswain";
	//itm.kind = "companionship";
	n++;

	makeref(itm,Items[n]);
	itm.id = "talisman13"; // Повелитель огня
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman13";
	itm.describe = "itmdescr_talisman13";
	itm.picIndex = 13;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman14"; // Творец вдов
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman14";
	itm.describe = "itmdescr_talisman14";
	itm.picIndex = 10;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman15"; // Сын Ягуара
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman15";
	itm.describe = "itmdescr_talisman15";
	itm.picIndex = 12;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman16"; // Спиногрыз
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman16";
	itm.describe = "itmdescr_talisman16";
	itm.picIndex = 8;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
	...
	makeref(itm,Items[n]);
	itm.id = "talisman17"; // Клеврет
	itm.groupID = TALISMAN_ITEM_TYPE;
	itm.name = "itmname_talisman17";
	itm.describe = "itmdescr_talisman17";
	itm.picIndex = 2;
	itm.picTexture = "ITEMS_21";
	itm.price = 25000;
	itm.Weight = 0.5;
