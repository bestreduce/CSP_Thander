...
void InitInterface_gm(string iniName)
{
	...
	string text7 = "Стрельба только в противников: "+bShootOnlyEnemy+"\nИсследование кораблей: "+bFillEncyShips+"\nТребование ранга к навигации: "+bRankRequirement+"\nОтключение влияния сложности на вес: "+bDifficultyWeight+"\nПолучаемый ГГ урон: x"+FloatToString(makefloat((4.0+MOD_SKILL_ENEMY_RATE)*3/10.0)*bModDamage,2)+"\nПауза живого мира: "+bWorldAlivePause;
