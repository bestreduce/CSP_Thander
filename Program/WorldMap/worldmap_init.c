...
void wdmInitWorldMap()
{
	...
	worldMap.labeltype.Island.heightView = 1500.0;		//Default camera height when hide this labels
	...
	worldMap.labeltype.Town.heightView = 1500.0;
	...
	worldMap.labeltype.Shore.heightView = 1500.0;
